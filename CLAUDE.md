...
**ridichiara** `HEAD` e albero: parte da ciò che c'è quando il motore si libera, non da ciò che c'era mezz'ora
prima. Non termina mai nessun processo — se è di un altro checkout è lavoro di qualcun altro.
