...
> - **415 test automatici** unici (`Source/RefactorTactics/Tests/`, 63 file), misurati il 2026-08-08.
...
5. Test: **Tools → Session Frontend → Automation** → `RefactorTactics` → *Start Tests* (415 test).
