...
[Scarica il PRD Markdown](sandbox:/mnt/data/PRD_E49_Damage_Model_Hex_Cover_v1.0.md)
...
[Scarica le issue proposte in JSON](sandbox:/mnt/data/E49_issues_proposte.json)
...
[Scarica il PR template](sandbox:/mnt/data/PULL_REQUEST_TEMPLATE_E49.md)

**Bundle unico** con tutti e tre gli artefatti:

[Scarica il bundle E49](sandbox:/mnt/data/E49_PRD_handoff_bundle.zip)
