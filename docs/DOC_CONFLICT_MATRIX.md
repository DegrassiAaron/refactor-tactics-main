...
| 55 | **Visibilità del tempo di decisione** | proposta del 2026-08-09: bank residuo **pubblico** agli avversari, per abilitare tattiche di pressione | **owner-only**. Un bank pubblico trasforma l'istante del lock in un valore persistente e archiviato: è il canale che [D-021](decisions/adr-0004-finestre-di-reazione.md) §7-bis e [D-048](gameplay/spec-reaction-clash-e14.md) §7.1 chiudono | invariante #6 · D-021 · D-048 | `CONFIRMED` | Proposta **registrata e scartata**, non ignorata: né `public live` né `public bucketed` decorrelano il delta. Verifica: canary di privacy, come per l'invariante #6 |
