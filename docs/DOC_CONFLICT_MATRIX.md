...
> `CURRENT` · **Stato**: vivo · **Ultimo aggiornamento**: 2026-08-12 · **Owner**: questo file
...
| 27 | **Azioni generiche** | catalogo E4: `Wait · Move · BasicAttack · Guard · Activate · Interact` | **sette** voci: `Wait · Move · BasicAttack · Guard · Brace · Interact · Overwatch`; `Activate`→`Interact`; `Guard` **universale** | [D-025](decisions/RT_PDR_00_Decision_Log.md) *(emenda [D-014](decisions/RT_PDR_00_Decision_Log.md))* | `SUPERSEDED` | ✅ semantica decisa · ✅ **migrazione Stable ID chiusa il 2026-08-10** (`#199`): `Activate` fuori dal catalogo con redirect in lettura verso `Interact`; `Guard` **non si migra** (D-025 la riporta universale); `Sprint` **resta** `Action.Sprint` in fase rapida, con la motivazione scritta in [D-068](decisions/RT_PDR_00_Decision_Log.md). Owner: [`technical/piano-migrazione-stable-id.md`](technical/piano-migrazione-stable-id.md) · *questa riga elencava ancora le **sei** voci di D-014: corretta il 2026-08-08, vedi riga 42* |
