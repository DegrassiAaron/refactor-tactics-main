...
> **Attenzione:** soltanto **Steel, Aurora, Murdock e Kwang** sono attualmente assegnati alla **v0.2**. Gli altri **34** sono candidati `SIGNATURE_DEFINED` con release `UNASSIGNED`. Le quattro pagine v0.1 di Flux, Riva, Bastion e Vektor sono personaggi RefactorTactics separati e non fanno parte di questo elenco Paragon.
...
| [Riktor](candidates/riktor.md) | Controller | Tether | 4/5 | Candidate |
...
| [Wraith](candidates/wraith.md) | Recon / Predicter | Insight | 5/5 | Candidate |
...
| [Gadget](candidates/gadget.md) | Engineer | Device Network | 5/5 | Candidate |
...
| [Phase](candidates/phase.md) | Support / Mobility | Phase Link | 5/5 | Candidate |
