...
| Risorsa firma | Riserva Idrica ⛔ *(disegno — vedi §«Risorsa firma»)* |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| RES_RIVA_WATER | Riserva Idrica | 4 | — | 1 | Interazione con acqua | Abilità firma | Cap 4; start non specificato | Team-visible | NOT_IMPLEMENTED (D-265) |
...
- **Dataset:** [`RefactorTactics_Characters_Wiki_Data_v0.4.xlsx`](../data/RefactorTactics_Characters_Wiki_Data_v0.4.xlsx).
- **Release dati:** `v0.1`.
