...
**27 sedute** — ✅ **2** · 🟡 **12** · ⏳ **7** · **6** senza stato derivabile (non dichiarano ne' voci ne' artefatti: il codice sotto non esiste ancora).
