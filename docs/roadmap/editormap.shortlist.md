...
6. **Scala del componente skeletal: `1,1,1`, relativa.** Con il passo 3 fatto — skeletal sotto
   ...
   > ⚠️ La misura statica dice solo meta': `bAbsoluteScale` **non compare** nella name table di
   > nessuno dei quattro `.uasset`, quindi l'icona non e' stata commutata. Cosa ci sia al suo
   > posto lo dice solo l'editor.
