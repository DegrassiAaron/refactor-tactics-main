...
**26 sedute** — ✅ **2** · 🟡 **12** · ⏳ **6** · **6** senza stato derivabile (non dichiarano ne' voci ne' artefatti: il codice sotto non esiste ancora).
