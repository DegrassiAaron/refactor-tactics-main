...
| **E13** | 🟡 | 4 | 11/36 | La vista **decide**: da CP 13.2 un'azione offensiva non parte contro un bersaglio ignoto alla squadra, e un contatto solo `Incerto` si colpisce per cella. ⏳ il **rumore** (secondo canale) e ⏳ **bot e HUD**, che ancora non la consumano |
