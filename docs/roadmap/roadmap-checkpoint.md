...
documentale → **432** col merge di **CP 9.3** (porte). Al merge di CP 9.3 le due parti dichiaravano **425 in
64** e **419 in 64**: entrambe corrette alla propria base, nessuna valida dopo l'unione. È la **terza** volta.
