...
**95 feature** · v0.1 **71** · v0.2 **12** · future **12**.
...
|---|:--:|:--:|--:|:--:|---|
| `RT-FEAT-ACTION-BASIC-ATTACK-PROFILES` — Profili di attacco base per eroe | v0.1 | RELEASE_READY | 7/8 | E4 | Un eroe resta riconoscibile **anche senza usare le sue speciali**; e un attacco base debole non è un pulsante finto |
...
| `RT-FEAT-BOT-FAIRNESS` — Il bot pianifica sulla conoscenza della sua squadra | v0.1 | SPECIFIED | 1/7 | E13 | — |
