...
**78 scenari versionati** — misurati su `Scenarios/`: **67** eseguibili · **11** `BLOCKED` per una capability assente · **63** dichiarati `planned` nel registry e non ancora scritti.
