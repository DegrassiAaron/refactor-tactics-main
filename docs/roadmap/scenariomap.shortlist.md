...
**71 scenari versionati** — misurati su `Scenarios/`: **59** eseguibili · **12** `BLOCKED` per una capability assente · **51** dichiarati `planned` nel registry e non ancora scritti.
