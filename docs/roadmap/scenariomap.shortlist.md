...
**76 scenari versionati** — misurati su `Scenarios/`: **65** eseguibili · **11** `BLOCKED` per una capability assente · **63** dichiarati `planned` nel registry e non ancora scritti.
