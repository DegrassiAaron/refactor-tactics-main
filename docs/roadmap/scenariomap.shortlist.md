...
**70 scenari versionati** — misurati su `Scenarios/`: **58** eseguibili · **12** `BLOCKED` per una capability assente · **52** dichiarati `planned` nel registry e non ancora scritti.
