...
**77 scenari versionati** — misurati su `Scenarios/`: **66** eseguibili · **11** `BLOCKED` per una capability assente · **63** dichiarati `planned` nel registry e non ancora scritti.
