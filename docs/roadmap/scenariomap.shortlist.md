...
**73 scenari versionati** — misurati su `Scenarios/`: **61** eseguibili · **12** `BLOCKED` per una capability assente · **56** dichiarati `planned` nel registry e non ancora scritti.
