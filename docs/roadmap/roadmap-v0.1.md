...
**Suite automatica**: **432 test unici** in **65 file** (rimisurati 2026-08-08 **dopo** il merge
di CP 9.3 con `main`). CP 9.3 porta **+13** test — 10 `Structures.Door.*` e 3 `HexMap.Door*`, nel file nuovo
