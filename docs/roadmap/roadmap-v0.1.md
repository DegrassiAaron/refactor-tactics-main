...
| **E23** Muri, porte e interaction graph | 🟡 **E23.3 chiuso ([#832](https://github.com/DegrassiAaron/refactor-tactics-main/issues/832)) · E23.4 aperto ([#833](https://github.com/DegrassiAaron/refactor-tactics-main/issues/833)) · E23.6 ed E23.7 aperti il 2026-08-30 ([#1827](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1827), [#1828](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1828)) da `D-285`, con altre cinque sub-issue** | 23 test `InteractionGraph.*` + 27 `Structure.*` + 1 `Door.*`, misurati il 2026-08-27. Anticipata dalla v0.2 da [D-160](../decisions/RT_PDR_00_Decision_Log.md): non è scope nuovo, è una presa d'atto |
...
> [`D-285`](../decisions/RT_PDR_00_Decision_Log.md). Il testo dei due checkpoint **non è cambiato**: diceva
