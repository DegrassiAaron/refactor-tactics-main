...
| A7 — «same seed → same output» | `ScenarioHarness/RTTestScenario.h:509` — «Seed dichiarato ma **non consumato**: oggi il progetto non ha alcun RNG»; idem `RTTestResult.h:74`. [`test-automatico-unreal.md`](../../technical/test-automatico-unreal.md) §4.1: «Il `seed` non fa niente, e va bene così» | ❌ vacuo per costruzione |
| A2 — «se manca una convenzione chiara» | [`test-automatico-unreal.md`](../../technical/test-automatico-unreal.md) (328 righe, spec del RT Scenario Test Harness), [`test-e-diagnosi.md`](../../technical/test-e-diagnosi.md), [`RT_TestMatrix_v0.1.md`](../../balance/RT_TestMatrix_v0.1.md) | ❌ la convenzione ha già owner |
