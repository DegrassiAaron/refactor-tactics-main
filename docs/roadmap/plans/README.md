...
|---|---|---|--:|
| `CURRENT` | canonico | Vive: quello che dice vale, salvo verifica sull'owner | 40 |
...
**77 documenti**, `README.md` escluso — ⚠️ **rimisurati dopo il merge**, non incrementati: questa cella e' andata fuori sincrono **tre volte in un giorno** perche' quattro rami hanno toccato la cartella senza vedersi. `40 + 12 + 14 + 7 + 3 + 1 = 77`, e la somma delle categorie e' il controllo che il totale da solo non offre.
