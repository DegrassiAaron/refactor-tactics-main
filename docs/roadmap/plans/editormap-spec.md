...
> **Non è approvata**: §8 elenca le decisioni che restano dell'autore.
...
|---|---|---|
| `test-manuali-pie.md` | *cosa devo verificare, e com'è andata* | è un **registro**: 117 voci in ordine tematico, senza sequenza né prerequisiti |
