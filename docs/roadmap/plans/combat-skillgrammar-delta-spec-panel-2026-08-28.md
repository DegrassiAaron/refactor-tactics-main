...
> referto li produce. Le decisioni che ne escono sono **D-234** (card) e **D-235** (combat).
...
| Ultimo `D-nnn` assegnato | Decision Log + scansione dei **11** ref | **D-233** ovunque. Nessuna collisione: `D-234`/`D-235` sono liberi |
...
|---|---|---|---|
| 1 | Sei gruppi semantici sui vertici | ✅ **come vista di lettura**, non come seconda grammatica | **D-234** + owner §5.1 |
| 2 | ♦ / ■ / ▲ distinti | ✅ **già deciso da D-231**, si registra l'equivalenza | owner §5.1 |
| 3 | Posizione fissa e imparabile per gruppo | ✅ **accolta, corregge un difetto dell'owner** | **D-234** |
| 4 | Settore COUNTER | ⛔ **rifiutato ora**: sei termini a zero occorrenze | **D-234** |
| 5 | Raggruppare in UI ≠ fondere nel data model | ✅ **accolta e resa vincolo** | **D-234** |
...
| 10 | Formula additiva §4 | ⛔ **non si congela**: nessun ingresso esiste | **D-235** |
| 11 | Conflitto `Armor` / `BaseShield` | 🔴 **registrato come blocco** al §4 | **D-235** + PRD |
| 12 | Due zeri non distinti | 🔴 **registrato** | **D-235** + PRD |
| 13 | Vulnerability = famiglia, non stat | ✅ **accolta**, è nuova | **D-235** + PRD |
...
| **F** | Il sesto vertice resta riservato e vuoto? | **D-234** dice sì: riservato, non riassegnato |
| **G** | Tetto del ring: 8 (kit) o 9 (owner) | **D-234** sceglie **9**, il numero dell'owner spedito |
...
| Decisioni prodotte da questo referto | **D-234** · **D-235** |
