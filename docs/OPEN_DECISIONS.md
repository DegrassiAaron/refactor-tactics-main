...
>   aggiunte.
> - `COV-11` — **aperta, e senza owner**. 🔴 Questa nota diceva che l'owner è
>   [`#1833`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1833) mentre la riga stessa dice
>   il contrario: la correzione di perimetro era stata scritta nella riga e **non qui**, ed è il difetto che
>   [`D-282`](decisions/RT_PDR_00_Decision_Log.md) chiama *«due sedi che dicono l'opposto sullo stesso
>   oggetto»*. Le `COV-*` aprono la copertura **selezionabile in posa**; questa voce sta sulla geometria del
>   bordo **ambientale**, quindi `#1833` non la possiede e nessuna issue la aspetta.
