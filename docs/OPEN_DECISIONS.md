...
> ([#1696](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1696)).
>
...
> documento si è già corretto una volta, dodici righe più in alto.
>
> ⛔ **Non si riassume e non si taglia**: lo scorporo **sposta**. Chi lo esegue verifica che l'insieme delle
> parole sia lo stesso prima e dopo, non che il numero sia simile.
...
| `BAL-1` | `Guard` e `Brace` devono separarsi in **danno contro spinta**? | 🔄 **Riaperta** il 2026-08-27 da [D-205](decisions/RT_PDR_00_Decision_Log.md), che scambia i mestieri delle due difese: la mitigazione sostenuta passa alla `Guard`, il `Brace` smette di radicare. ⏳ **Resta la parte che richiede l'autore**: la seduta editor `U20` (voce `PIE-BAL1`) e la scelta fra le due opzioni superstiti — decisione su [#403](https://github.com/DegrassiAaron/refactor-tactics-main/issues/403). 📄 **Istruttoria**: [`decisions/open/bal-1.md`](decisions/open/bal-1.md) | <!-- rename-exempt: misura datata: riscriverla la renderebbe falsa -->
