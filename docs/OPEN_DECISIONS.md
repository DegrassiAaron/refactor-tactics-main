...
Origine: l'handoff `RefactorTactics_BaseActions_Facing_Consolidation_Claude_2026-08-08.md`, che chiudeva con
...
Righe **45–47** di [`DOC_CONFLICT_MATRIX.md`](DOC_CONFLICT_MATRIX.md). Oggi prevale l'ADR; queste voci
