...
> `OPEN` · **Stato**: vivo · **Ultimo aggiornamento**: 2026-09-12 (`GOV-7` aperta da #2392 e ✅ **chiusa lo stesso giorno** da [`D-400`](decisions/RT_PDR_00_Decision_Log.md): si termina un orfano, ma il criterio si legge sulla `CommandLine` dei motori vivi)
