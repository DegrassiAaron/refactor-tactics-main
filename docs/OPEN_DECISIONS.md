...
Misurato su `origin/main` `197a135b`; la sonda che produce i numeri e' `RefactorTactics.BlindActions.*`
(`Source/RefactorTactics/Tests/RTBlindActionsLeakMeasureTests.cpp`, entrata con [#2803](https://github.com/DegrassiAaron/refactor-tactics-main/pull/2803)).
