...
> 🔁 **Aggiornato il 2026-09-01 — la tabella ha sette righe, e la settima non è di questo mandato.** `COV-11`
> viene dal kit d'autore *Cover · Melee · AoE · Facing v0.1*
> ([referto](roadmap/plans/cover-melee-aoe-facing-consolidamento-spec-panel-2026-09-01.md)), consumato il
> giorno dopo `D-305`. Sta qui perché è la stessa materia e lo stesso owner — [`#1833`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1833) —
> ma **non** è una delle ventuno clausole misurate sopra, e i conteggi «queste sei» di questa sezione
> restano veri per il mandato che nominano.
