...
> **Aggiornamento 2026-08-16 — `FAC-15` aperta e chiusa in giornata; ne restano tre.** `FAC-15` si apre da uno spec panel su
...
> destra/sinistra — sono **incompatibili**, misurate. ✅ **Ma la seconda non era un requisito**, e [D-147](decisions/RT_PDR_00_Decision_Log.md) l'ha registrato: `FAC-15` si chiude e **#726 si sblocca**. Restano `FAC-12`, `FAC-13` e `FAC-14`, nessuna delle quali
> ferma lavoro costruibile.
