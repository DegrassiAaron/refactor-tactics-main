...
asset, e non cambiano quella forma. **`GBX-6` era l'eccezione** — decideva in quale scala si modella,
quindi quanto grande viene costruita ogni mesh — ed è ✅ **chiusa**: vince la scala d'arte, lato `1,5 m`,
`HexSize = 150`.
