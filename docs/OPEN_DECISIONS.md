...
> `OPEN` · **Stato**: vivo · **Ultimo aggiornamento**: 2026-09-22 (`ICON-TAX-1..7` aperte dall'istruttoria di [#637](https://github.com/DegrassiAaron/refactor-tactics-main/issues/637); precedente: 2026-09-20 (`BEAT-1` aperta e **scorporata alla nascita** in [`decisions/open/beat-1.md`](decisions/open/beat-1.md): §7-bis elenca tre meccanismi e non ne sceglie uno, la tolleranza non è un numero da nessuna parte, e il canale che quel meccanismo dovrà neutralizzare — il playback che **si ferma** mentre la finestra è aperta — è **già prescritto** da [`D-355`](decisions/RT_PDR_00_Decision_Log.md)/[`D-350`](decisions/RT_PDR_00_Decision_Log.md), da [#759](https://github.com/DegrassiAaron/refactor-tactics-main/issues/759)) · *precedente*: 2026-09-20 (`BAL-1` **non chiusa ma riformulata**: [`D-408`](decisions/RT_PDR_00_Decision_Log.md) ritira il pool della `Guard` e le due difese prendono la stessa forma, quindi ciò che le separa non è più *primo colpo pesante contro colpi ripetuti* ma la **direzione** — istruttoria aggiornata in [`decisions/open/bal-1.md`](decisions/open/bal-1.md)) · *precedente*: 2026-09-20 (`SKB-2` ✅ **chiusa** da [`D-428`](decisions/RT_PDR_00_Decision_Log.md): il calendario dei sotto-passi, con la dimensione del tick derivata dai partecipanti e l'eleggibilità funzione pura di `(cadenza, indice)`; `ROSTER-1` aperta: le immagini col roster legacy nei pixel si rigenerano o si rimuovono, da [#1166](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1166)/[#853](https://github.com/DegrassiAaron/refactor-tactics-main/issues/853)) · *precedente*: 2026-09-20 (`CHAT-1` aperta: il perimetro delle chat da consolidare non è enumerabile da nessuna fonte accessibile, dal secondo giro di [#2606](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2606)) · *precedente*: 2026-09-20 (la soglia misurava la popolazione sbagliata e i due puntatori dicevano meno di quanto le voci dicono oggi: corretti in code review, [#1696](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1696)) · *precedente*: 2026-09-18 (soglia di scorporo dichiarata, e i corpi di `GBX-5` e `BAL-1` spostati in `decisions/open/` — nessuna voce aperta o chiusa, [#1696](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1696)) · *precedente*: 2026-09-14 (`SKB-1`, `SKB-4` e `SKB-5` ✅ **chiuse** da [`D-416`](decisions/RT_PDR_00_Decision_Log.md), [`D-417`](decisions/RT_PDR_00_Decision_Log.md) e [`D-418`](decisions/RT_PDR_00_Decision_Log.md); restano aperte `SKB-2`, `SKB-3`, `SKB-6`, `SKB-7`) · *precedente*: 2026-09-13 (`SKB-1`…`SKB-7` aperte e `AE-5` ✅ **chiusa** da [`D-412`](decisions/RT_PDR_00_Decision_Log.md), dallo spec panel sulla skill bar consolidata) · *precedente*: 2026-09-12 (`GOV-7` aperta da #2392 e ✅ **chiusa lo stesso giorno** da [`D-400`](decisions/RT_PDR_00_Decision_Log.md): si termina un orfano, ma il criterio si legge sulla `CommandLine` dei motori vivi) · *precedente*: 2026-09-20 (`REPCELL-1` aperta: una voce che il filtro per osservatore lascia passare nomina in un campo `Public` la cella di un'unità diversa dal proprio soggetto di verdetto — canale **misurato** dalla sonda `Replay.Privacy.PublicCellsLeakAThirdPartyPosition`, residuo che la voce `BLIND-1` di questo documento assegna a [#1805](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1805)) · *precedente*: 2026-09-20 (`BAL-1` **non chiusa ma riformulata**: [`D-408`](decisions/RT_PDR_00_Decision_Log.md) ritira il pool della `Guard` e le due difese prendono la stessa forma, quindi ciò che le separa non è più *primo colpo pesante contro colpi ripetuti* ma la **direzione** — istruttoria aggiornata in [`decisions/open/bal-1.md`](decisions/open/bal-1.md)) · *precedente*: 2026-09-20 (`SKB-2` ✅ **chiusa** da [`D-428`](decisions/RT_PDR_00_Decision_Log.md): il calendario dei sotto-passi, con la dimensione del tick derivata dai partecipanti e l'eleggibilità funzione pura di `(cadenza, indice)`; `ROSTER-1` aperta: le immagini col roster legacy nei pixel si rigenerano o si rimuovono, da [#1166](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1166)/[#853](https://github.com/DegrassiAaron/refactor-tactics-main/issues/853)) · *precedente*: 2026-09-20 (`CHAT-1` aperta: il perimetro delle chat da consolidare non è enumerabile da nessuna fonte accessibile, dal secondo giro di [#2606](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2606)) · *precedente*: 2026-09-20 (la soglia misurava la popolazione sbagliata e i due puntatori dicevano meno di quanto le voci dicono oggi: corretti in code review, [#1696](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1696)) · *precedente*: 2026-09-18 (soglia di scorporo dichiarata, e i corpi di `GBX-5` e `BAL-1` spostati in `decisions/open/` — nessuna voce aperta o chiusa, [#1696](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1696)) · *precedente*: 2026-09-14 (`SKB-1`, `SKB-4` e `SKB-5` ✅ **chiuse** da [`D-416`](decisions/RT_PDR_00_Decision_Log.md), [`D-417`](decisions/RT_PDR_00_Decision_Log.md) e [`D-418`](decisions/RT_PDR_00_Decision_Log.md); restano aperte `SKB-2`, `SKB-3`, `SKB-6`, `SKB-7`) · *precedente*: 2026-09-13 (`SKB-1`…`SKB-7` aperte e `AE-5` ✅ **chiusa** da [`D-412`](decisions/RT_PDR_00_Decision_Log.md), dallo spec panel sulla skill bar consolidata) · *precedente*: 2026-09-12 (`GOV-7` aperta da #2392 e ✅ **chiusa lo stesso giorno** da [`D-400`](decisions/RT_PDR_00_Decision_Log.md): si termina un orfano, ma il criterio si legge sulla `CommandLine` dei motori vivi)
...
> ✅ **Ventiquattro voci sono state chiuse insieme il 2026-08-30**, dalla decision session d'autore
> registrata nella Knowledge Base esterna e sincronizzata qui: `GEO-4`, `TD-COMP-2`, `BOT-REACT-1`, `RNK-1`,
> `PLC-3`, `PLC-4`, `GOV-1`, `GOV-2`, `GOV-3`, `CLEANSE-1`, `COOK-1`, `COOK-2`, `FX-1`, `FX-2`, `GEN-1`,
> `REL-1`, `REL-2`, `RNG-1`, `RNG-2`, `AE-3`, `AE-4`, `AE-8`, `REP-1`, `REP-2`. Ognuna porta in terza colonna
> l'esito, la `D-2xx` che la registra e l'`AUTHOR-*` da cui proviene, e **conserva la propria istruttoria**
> dietro la dicitura *«Istruttoria conservata»* — la domanda barrata con il suo perché vale quanto la
...
>
> Una voce di questo documento è una **riga di tabella**, e per la maggior parte va bene: la mediana delle
> voci **aperte** è **991** caratteri al 2026-09-20 — cambia insieme al documento, quindi si rimisura invece
> di citarla a memoria, e il comando misura **la popolazione che la regola governa**, non tutte le righe:
>
> ```bash
> LC_ALL=C.UTF-8 awk '/^## /{chiusa=($0~/Chius|Sciolt/)} /^\| `[A-Z][A-Z0-9]*(-[A-Z0-9]+)*-[0-9]+`/{if(!chiusa)print length($0)}' docs/OPEN_DECISIONS.md | sort -n | awk '{a[NR]=$1} END{print "n="NR, "mediana="((NR%2)?a[(NR+1)/2]:int((a[NR/2]+a[NR/2+1])/2)), "max="a[NR]}'
> ```
>
> ⚠️ **Il filtro non è cosmetico, e ha tre insidie — le prime due hanno fatto sbagliare questa misura.**
> *(1)* `/^\| /` da solo prende 301 righe (`awk '/^\| /{n++} END{print n}' docs/OPEN_DECISIONS.md`): quasi
> tutte sono intestazioni, righe di altre tabelle e voci **barrate**, e la mediana che ne esce è di un altro
> insieme. *(2)* ⛔ **Barrare l'ID non è l'unico modo in cui una voce è chiusa**: **19** voci hanno l'ID
> **non** barrato e vivono sotto un titolo `## ✅ Chiusa …` — per questo il comando segue le intestazioni
> invece di fidarsi della riga. *(3)* `length()` conta **caratteri** solo in locale UTF-8: in `LC_ALL=C`
> queste righe, dense di emoji, danno numeri più alti. Da qui il prefisso.
>
> 🔑 **Sopra i `4000` caratteri una voce APERTA scorpora il corpo** in `decisions/open/<id in minuscolo>.md`
> e qui lascia un puntatore breve: la domanda, **lo stato di oggi**, l'innesco, ciò che chi la prende rischia di non
> sapere, e il link. Il difetto che toglie è *«un'analisi che nessuno finisce di leggere ha lo stesso effetto
> pratico di un'analisi che non esiste»* ([#1696](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1696)).
>
> ⚠️ **Da dove viene `4000`, detto per intero: è la taglia delle due voci che lo scorporo ha mosso, non uno
> stacco nella distribuzione.** Ordinando tutte le righe si passa da `4151` a `3903` senza salti, e dopo
> questo scorporo **nessuna voce aperta arriva alla soglia**: la più lunga è `GKPROC-1` con **3341** caratteri,
> e la soglia è ~4× la mediana. Quindi oggi la regola **non morde**: è una guardia per la prossima voce
> che cresce, e `GKPROC-1` resta in cella.
>
> ⌫ **La guardia ha morso il 2026-09-20, ed è la prima volta: `BEAT-1` è nata sopra la soglia.** Non è cresciuta fin lì — la sua prima stesura misurava già oltre `4000` caratteri, quindi è stata scorporata **alla nascita** in [`decisions/open/beat-1.md`](decisions/open/beat-1.md) invece che dopo. 🔑 Il caso che il blocco qui sopra non aveva previsto non è la voce che cresce, è quella che **arriva già grande**: la regola regge identica, ma «una guardia per la prossima voce che cresce» descriveva metà della popolazione. ⚠️ E i due numeri di questo paragrafo sono ora **storici**, non correnti: si rimisurano col comando del §, non si leggono qui. ⛔ **Abbassarla è una scelta di scope, e questa issue non la
> prende**: il suo perimetro dichiarato è *«tre voci sopra 4000 come punto di partenza»* ([#1696](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1696)).
>
> ⛔ **Vale sulle voci APERTE, e la distinzione non è una scorciatoia.** Il costo che la soglia esiste per
> togliere è *«una decisione non viene presa perché il suo corpo è illeggibile»*: una voce **barrata** non
> aspetta nessuno, è archivio, e la sua istruttoria resta in cella dov'è già consultabile. Una regola che
> dicesse «tutte» nascerebbe violata dalle voci chiuse che la superano — `BOT-STALL-1`, `MOV-7`, `BLIND-1`,
> `MOV-9`, `GOV-7` — ed è esattamente il difetto che questo
> documento si è già corretto una volta, nella correzione del 2026-08-12 in testa al documento.
>
> ⛔ **Non si riassume e non si taglia**: lo scorporo **sposta**. Chi lo esegue verifica che l'insieme delle
> parole della cella di partenza si ritrovi nel file **più il puntatore che la sostituisce**, non che il
> numero sia simile.
>
> 🔚 **Quando la voce si chiude** il puntatore resta barrato qui con l'esito, e il file **lascia
> `decisions/open/`**: passa da `OPEN` a `HISTORICAL` col rimando alla `D-xxx` che l'ha chiusa e va dove
> vanno i documenti finiti, `docs/archive/`. ⛔ **La cartella è nominata su uno stato che scade**, quindi o
> il file esce o il nome mente: `open/` contiene ciò che aspetta ancora qualcuno, e un file che vi resta
> dopo la chiusura è un secondo posto dove la domanda sembra aperta.

---


## Aperta — quale meccanismo regge il ritmo osservato, da ADR-0004 §7-bis e #759 del 2026-09-20

Origine: la rimisurazione di [#759](https://github.com/DegrassiAaron/refactor-tactics-main/issues/759), il
cui corpo è fermo al 2026-08-25 e descrive un repository che nel frattempo è cambiato in quattro punti.
Misurata su `main` `5958dfbc`. Owner documentale:
[`decisions/adr-0004-finestre-di-reazione.md`](decisions/adr-0004-finestre-di-reazione.md) §7-bis
([`D-021`](decisions/RT_PDR_00_Decision_Log.md)). Decisioni in tensione:
[`D-350`](decisions/RT_PDR_00_Decision_Log.md) · [`D-355`](decisions/RT_PDR_00_Decision_Log.md) ·
[`D-021`](decisions/RT_PDR_00_Decision_Log.md).

| ID | Domanda | Perché non si deduce |
|---|---|---|
| `BEAT-1` | **Quale meccanismo tiene il ritmo osservato indipendente dal tempo di risposta altrui, e con quale tolleranza numerica — sapendo che la sospensione di finestra, già prescritta, è il canale che quel meccanismo deve neutralizzare?** | 🆕 **Aperta** il 2026-09-20 dalla rimisurazione di [#759](https://github.com/DegrassiAaron/refactor-tactics-main/issues/759). **Stato di oggi**: §7-bis elenca **tre** meccanismi e non ne sceglie uno; la tolleranza non è un numero da nessuna parte; e il canale che quel meccanismo dovrà neutralizzare **esiste già ed è prescritto** — durante una finestra aperta il playback **si ferma** (`bPlaybackHeldByWindow`), per esattamente il tempo che il difensore impiega a rispondere. ✅ Oggi non è un leak: niente è replicato (`grep -rn "DOREPLIFETIME" Source/ \| grep -v /Tests/` → nessuna riga), quindi il canale è **programmato, non aperto**. ⚠️ **Ciò che chi la prende rischia di non sapere**: la sospensione e la slow-motion sono **due** meccanismi distinti e vanno chiusi entrambi — rendere per-osservatore la sola velocità lascia intatta la pausa, che agisce prima; e nessuno dei due è un difetto sfuggito, li prescrivono [`D-355`](decisions/RT_PDR_00_Decision_Log.md), [`D-350`](decisions/RT_PDR_00_Decision_Log.md) e [#166]. ⛔ **Non autorizza a spostare #759 in v0.1**: [#2462](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2462) lo esclude. **Innesco**: la prima superficie di rete, o la prima modifica a `UpdateReactionSlowMotion` / `bPlaybackHeldByWindow`. 📄 **Istruttoria**: [`decisions/open/beat-1.md`](decisions/open/beat-1.md) |
## Aperta — di chi è la cella che una voce pubblica nomina, da `D-371` e #1805 del 2026-09-20

Origine: l'innesco dichiarato dall'ultimo commento di
[#1805](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1805) (2026-09-09) — *«quando
`BLIND-1` esce (b) o (c), questa issue eredita una domanda concreta invece di scoprirla a valle»* — scattato
il giorno dopo con [`D-371`](decisions/RT_PDR_00_Decision_Log.md), uscita *(c)*. La voce `BLIND-1` di questo
stesso documento assegna il residuo per nome: *«una domanda da porre — a #1805 e a
[`D-316`](decisions/RT_PDR_00_Decision_Log.md), non qui»*.
Misurata su `main` `5958dfbc` dalla sonda `RefactorTactics.Replay.Privacy.PublicCellsLeakAThirdPartyPosition`
([`Tests/RTReplayPrivacyTests.cpp`](../Source/RefactorTactics/Tests/RTReplayPrivacyTests.cpp)).
Decisioni toccate: [`D-276`](decisions/RT_PDR_00_Decision_Log.md) (i due prodotti) ·
[`D-316`](decisions/RT_PDR_00_Decision_Log.md) (il confine per le voci) ·
[`D-199`](decisions/RT_PDR_00_Decision_Log.md) (la voce ha due capi e un solo `UnitId`).

| ID | Domanda | Perché non si deduce |
|---|---|---|
| `REPCELL-1` | **Una voce che il filtro per osservatore lascia passare può nominare, in un campo `Public`, la cella di un'unità DIVERSA dal proprio soggetto di verdetto — e se no, chi paga la chiusura?** | 🔴 **I due confini di `#1805` rispondono a metà domanda ciascuno, e la metà che manca è la stessa.** `FilterEntriesForObserver` chiede *«posso vedere questo SOGGETTO?»*, e il verdetto è congelato contro **uno solo** (`FRTVerdictSubjectRef`); `ToPublicTrace` chiede *«questa COLONNA è pubblica?»*, e `SrcCell`/`TgtCell`/`SightBlockerCell` lo sono. Nessuno dei due chiede *«di chi è la cella che questa voce nomina»*, e su ogni voce che nomina due unità le due domande divergono. 🔑 **Misurato, non temuto**: la sonda costruisce due mondi identici in tutto ciò che la squadra 0 è autorizzata a sapere e diversi solo per dove stava un attaccante che non percepisce; la squadra 0 riceve **1 voce su 2** — il filtro per voci regge, e il controllo positivo lo dimostra — e quella voce porta `SrcCell=(3,0,L0)` contro `(-3,2,L0)`, su **entrambe** le uscite del prodotto pubblico (il file per osservatore e `ToPublicTrace`). ⚠️ **Il produttore esiste in produzione**: `ERTFacingOutcome::RearHitBypassedCover` scrive `SrcCell` = cella dell'attaccante e passa la **vittima** come soggetto, e la squadra della vittima riceve sempre il bit perché `ClassifyTarget` corto-circuita sugli alleati. 🔴 **E il repository conosce già la classe, per un produttore solo**: `URTFacingLibrary::MakeHitCameFromSideEntry` scrive il difensore in entrambe le celle dichiarando che altrimenti *«pubblicherebbe la cella esatta di un attaccante che il lettore potrebbe non percepire, su OGNI colpo risolto **invece che sui rari bypass**»* — l'ultima clausola è un'eccezione **accettata**, non una chiusura, e nessuna voce `D-` la registra. ✅ **Il canale gemello è stato chiuso nel verso opposto**, ed è il precedente da pesare: `FRTPlayerEvent` vieta per principio ogni cella dei soggetti (*«un campo «cella del primario» qui sarebbe una porta aperta per omissione, e non esiste»*), con l'unica eccezione di una cella di **terreno** già autorizzata a monte. Due canali derivati dalla stessa voce e dallo stesso verdetto hanno oggi politiche opposte. **Uscite**: *(a)* **generalizzare l'invariante** — nessuna voce nomina in un campo `Public` la cella di un'unità diversa dal proprio soggetto, come già fa `MakeHitCameFromSideEntry`; ⛔ costa un passaggio su ogni produttore multi-soggetto e riscrive `SrcCell` su voci già archiviate, quindi i golden `.rttl` si rigenerano — un costo da dichiarare prima, non da scoprire; *(b)* **autorizzare la cella, non solo il soggetto** — il precedente esiste ed è `FRTMoveRoute::CellVerdicts` + `ObservedPrefixLength`, che già decide per cella sul tracciato del Move; ⚠️ ma `FRTTurnLogEntry` non ha nessun campo analogo e aggiungerlo alza la versione del formato; *(c)* **dichiarare l'eccezione accettabile**, con la sua ragione — la frequenza («i rari bypass») è un argomento reale; ⛔ ma va scritto in una `D-` e non lasciato in un docstring di libreria, che è **la stessa forma** che `D-371` ha appena ritirato su `HexBotPlay.HiddenEnemyFairness`. ⛔ **Ciò che nessuna uscita autorizza**: marcare i tre campi `AuditOnly`. Svuoterebbe il prodotto pubblico — un replay senza celle non racconta niente — senza rispondere alla domanda, che non riguarda la **colonna** ma il **soggetto** di cui la colonna parla. ⚠️ E il gate che lo intercetta dipende da come lo si fa: toccando la sola `FieldVisibility()` cade `PublicFieldsKeepTheirValue` (i campi restano nella struct e nessuno li copia più); togliendo anche i campi dal tipo pubblico cade invece `PublicEntryMatchesTheClassification`. In entrambi i casi si passa da un rosso — che è il punto: la classificazione non si cambia in silenzio. **Innesco**: la prima issue che tocchi un produttore multi-soggetto, oppure la prima pubblicazione reale di un replay fuori dalla macchina che l'ha prodotto |

## Aperta — il perimetro delle chat da consolidare, dal secondo giro di #2606 del 2026-09-20

Origine: [`roadmap/plans/chat-knowledge-consolidation-2606-secondo-giro-2026-09-20.md`](roadmap/plans/chat-knowledge-consolidation-2606-secondo-giro-2026-09-20.md)
§2, che ne eredita la formulazione dal
[primo giro](roadmap/plans/chat-knowledge-consolidation-2606-primo-giro-2026-09-06.md) §7.
Misurata su `origin/main` `f7aa7b32`. Issue correlate: [#2606](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2606) · [#1165](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1165) · [#2325](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2325).

| ID | Domanda | Perché non si deduce |
|---|---|---|
| `CHAT-1` | **Quali chat compongono il perimetro di #2606, e da dove si legge quell'elenco?** | 🔴 **Nessuna delle tre fonti accessibili lo porta.** Repository, GitHub e il Google Sheet *RT — Knowledge Index & Consolidation Log* contengono le **tracce** delle chat — handoff, kit, prompt, referti — ma non la lista delle conversazioni: nella colonna `Source` del foglio non c'è una riga che *sia* una conversazione. ⛔ **Senza quell'elenco `SAFE_TO_DELETE` non ha denominatore**: la DoD di #2606 chiede che *«nessuna feature viva soltanto in chat»*, e una copertura senza popolazione è un'affermazione inventata, non una misura. 🔑 **E il perimetro non si deduce dalle tracce**, perché le tracce sono il sottoinsieme che *qualcuno ha già deciso di salvare*: usarle come popolazione fa concludere copertura `100 %` per costruzione — è la stessa forma del falso positivo che il primo giro ha registrato al §4, dove un selettore misurava sé stesso invece del repository. **Uscite**: *(a)* **l'autore enumera le chat vive**, e il perimetro diventa una lista con una data — ⚠️ è l'unica uscita che rende la DoD verificabile, e nessuno può produrla al posto suo; *(b)* **il perimetro si ridefinisce come *le tracce archiviate*** — enumerabile subito (`find docs/archive/src -name '*.md' ! -name README.md`), ⛔ ma risponde a una domanda diversa, e la DoD va riscritta di conseguenza invece di essere dichiarata soddisfatta; *(c)* **#2606 si chiude come capitolo** e il lavoro misurabile resta quello del §1 del referto — le righe di disposizione mancanti — sotto un owner documentale. ⚠️ **Il costo dell'attesa è misurato e cresce**: fra il 2026-09-06 e il 2026-09-20 i sorgenti archiviati senza riga d'indice sono passati da **16** a **17**, e **nessuno** dei sedici è stato chiuso — il meccanismo che li produce è attivo, quello che li consuma no. **Innesco**: la prima dichiarazione di `SAFE_TO_DELETE` su una chat, che non è emettibile prima di questa risposta |
...
## Aperta — i nomi legacy che vivono nei pixel, da #1166 e #853 del 2026-09-20

Origine: la rimisurazione di [#1166](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1166) e
[#853](https://github.com/DegrassiAaron/refactor-tactics-main/issues/853), registrata in
[`technical/piano-migrazione-roster.md`](technical/piano-migrazione-roster.md) §*Il precedente*.
Misurata su `origin/main` `f7aa7b32` e sul clone Wiki `7dbb666`. Regola violata: `D-130`.

| ID | Domanda | Perché non si deduce |
|---|---|---|
| `ROSTER-1` | **Le immagini che portano i nomi legacy nei pixel si rigenerano o si rimuovono — e la risposta è la stessa per le due superfici?** | 🔴 **L'autore ha già risposto una volta, e la risposta è *rimuovere***: il 2026-08-18 le due immagini di #853 sono uscite dal clone (`929b9f2`, *«Decisione dell'autore su #853: rimuovere, non rigenerare»*). ⚠️ **Ma il precedente non si estende da solo**, e la differenza è misurabile: quelle due erano illustrazioni accanto a testo che diceva la stessa cosa, e togliendole la pagina resta completa. Le **quattro card** `images/roster/26…29_*-card-v0.1.png` sono invece il **ritratto d'apertura** delle quattro schede personaggio — sotto resta il radar generato, quindi la pagina non resta muta, ma perde la propria immagine. 🔑 **E sono nel percorso Player**, contro quanto #1166 afferma: verificato sui pixel il 2026-09-20, stampano `FLUX`, `RIVA`, `BASTION`, `VEKTOR` a caratteri grandi su pagine il cui titolo e il cui `alt` dicono Gadget, Phase, Riktor, Wraith — cioè il difetto di #853, su quattro immagini invece di due. **Uscite**: *(a)* **rimuovere**, coerente col precedente — costo zero, ⛔ ma quattro schede personaggio perdono il ritratto; *(b)* **rigenerare e poi rinominare**, nell'ordine — ⛔ il rename da solo produce un file che si chiama col nome canonico e mostra quello vecchio, che è il difetto peggiorato; *(c)* **rimuovere ora e rigenerare quando esiste una pipeline**, che separa l'urgenza (il giocatore legge i nomi vecchi **oggi**) dal lavoro. ⚠️ **Per le 24 di [`research/wiki/v0.1/roster-legacy/`](research/wiki/v0.1/roster-legacy/) la domanda è diversa e può avere un'altra risposta**: non sono pubblicate, non lo saranno nella forma attuale, e stanno in un'area che dichiara *«Autorità: nessuna»*. 🔴 **Ciò che le rende comunque una decisione e non un rinvio** è che restano una riserva da cui il roster vecchio può rientrare per copia-incolla, ed è già successo: `Meta/factions-manifest-v0.8.json` del clone **mescola le due generazioni** — `flux` e `riva` accanto a `Gadget`, `Phase`, `Riktor`, `Wraith` — e non ha nessun consumatore. ⛔ **Nessun gate può chiudere questa classe**: un PNG non è un `.md`, e i due strumenti che la fetta 5 del piano prescriveva — `deploy --wiki-root` e `check-docs-naming.py` — sono usciti col repository con `D-181`/`D-182`. **Innesco**: nessuno automatico, ed è il punto — la prossima persona che apre una scheda personaggio della Wiki |
...
panel in [`roadmap/plans/skill-bar-consolidamento-spec-panel-2026-09-13.md`](roadmap/plans/skill-bar-consolidamento-spec-panel-2026-09-13.md).
Misurato su `origin/main` = `a2d23509`. Decisioni prodotte dalla stessa seduta: `D-407` … `D-415`.

✅ **Tre sono chiuse il 2026-09-14** — `SKB-1` da [`D-416`](decisions/RT_PDR_00_Decision_Log.md), `SKB-4` da
[`D-417`](decisions/RT_PDR_00_Decision_Log.md), `SKB-5` da [`D-418`](decisions/RT_PDR_00_Decision_Log.md) — e
**restano barrate con la loro istruttoria**, come la disciplina di questo file prescrive.

🔑 **Non erano le sole domande della sorgente: erano quelle che restavano senza owner.** La sezione
13 del documento ne pone di più, ma la maggior parte ha già una sede — la geometria dei 120° è
[`ADR-0005`](decisions/adr-0005-orientamento.md), l'ordine fra scudi è `D-309`, la durata della finestra è
la baseline di [`ADR-0004`](decisions/adr-0004-finestre-di-reazione.md). ⛔ **E le due code di `D-415` sono
qui e non nella voce**, perché una decisione che apre una domanda non la contiene: la registra.

| ID | Domanda | Perché non si deduce |
|---|---|---|
| ~~`SKB-1`~~ | ~~La v0.1 riapre lo `Stun`, oppure le regole della sorgente si riscrivono sugli stati di controllo che esistono?~~ | ✅ **`Status.Stunned` ENTRA NELLA v0.1 COME TERZO STATO DI CONTROLLO — chiusa il 2026-09-14 da [`D-416`](decisions/RT_PDR_00_Decision_Log.md)**, decisa dall'autore dopo che il costo gli è stato presentato. Toglie l'azione principale e la reazione, e disattiva cio' che l'unita' aveva armato; **non** tocca il movimento, che e' `Root`. 🔴 **È la piu' cara delle quattro uscite, e la misura e' un pavimento**: col metro di `Unbalanced`/`Prone` (gli unici stati entrati dopo `D-169`) sono **30 file e 1775 inserzioni** nel commit che introduce i due tag (`dda91286`, `#2253`), e **37 file distinti con 4148 inserzioni** sull'intera issue — misurato con `git show --stat dda91286` e con `git log --all --grep='(2253' --format=%H \| while read c; do git show --numstat --format='' $c; done`. ⛔ Fa cadere il pin **`RefactorTactics.Reaction.ControlStatusesAreTwo`** (`RTReactionTests.cpp:440`) — *«gli stati di controllo della v0.1 sono **due**»* — che era scritto apposta per diventare rosso qui. *Istruttoria conservata, con **due premesse di questa voce corrette dalla misura**:* 🔁 **(1) `SKB-1` NON bloccava le migrazioni che nominava.** Delle decisioni di #3129–#3133, **una sola** nomina lo stordimento: `grep -ciE 'stordi\|stun'` da' `D-408` 0 · `D-409` 0 · `D-410` 0 · `D-411` 0 · **`D-413` 1**. Il blocco era **documentale**, non testuale. 🔁 **(2) `D-169` non l'aveva «chiusa misurando»**, come questa voce sosteneva: misura un'**assenza** e nella colonna d'impatto **declina di autorizzare** uno stato nuovo — *«Cosa questa decisione NON autorizza: nessun nuovo stato»* — e la via di rientro e' scritta in [`adr-0004-finestre-di-reazione.md`](decisions/adr-0004-finestre-di-reazione.md):175. Declinare non e' rifiutare: `D-416` prende la decisione che `D-169` aveva lasciato scoperta, e non ne emenda il testo. ✅ **E meta' del lavoro esisteva gia'**: `Status.Prone` disarma l'Overwatch spendendone la carica (`RTTurnManager_Blast.cpp:2113-2119`), quindi la §9 della sorgente aveva gia' un soggetto parziale |
| ~~`SKB-2`~~ | **In quale sotto-momento del tick avanza il `Move`, e in quale tick comincia lo `Sneak`?** | ✅ **CHIUSA da [`D-428`](decisions/RT_PDR_00_Decision_Log.md)** (2026-09-20). **Un tick contiene tanti sotto-passi quanti ne chiede il profilo più veloce presente** (almeno uno, al massimo due); l'eleggibilità è `s < StepsPerTick && (t % TickPeriod) == 0` sull'indice del calendario — `Sprint` `{2,1}` · `Move` e `Withdraw` `{1,1}` · `Sneak` `{1,2}` · `Still` `{1,1}` — l'immobilità di `Still` viene dal non avere un percorso, non da una cadenza nulla. È una funzione **pura** di `(cadenza, indice)`, quindi nessun ordine di Actor entra nell'esito. ⛔ `MaxGraphTransitionsPerUnitPerMicroStep = 1` **non si muove**: due passi per tick sono due sotto-passi, mai due archi in uno. 🔑 I sotto-passi **inerti si emettono**, altrimenti la cadenza non sarebbe osservabile — uno `Sneak` da solo avanzerebbe come un `Move`. Il corpus resta fermo per un'altra ragione: con sole cadenze neutre il tick vale **un** sotto-passo e sotto-passi inerti non ne esistono. ✅ E `D-381` **resta**: il calendario dice *se* si può tentare un passo, `D-381` *quanto costa*. *Istruttoria conservata:* La sorgente §13.2 la marca **`CRITICO`** e la lascia aperta, ed è l'unica volta in cui lo fa. `D-412` dà i **rapporti** — `Sprint` fino a 2 passi per tick, `Sneak` 1 ogni 2 — e non il **calendario**: dire «due passi» non rende l'ordine deterministico. 🔑 **La scelta cambia esiti competitivi**, non solo estetica: decide chi entra per primo in una zona sorvegliata e chi vince una contesa di cella. ⛔ **Un vincolo NON è in discussione e va portato dentro qualunque uscita**: `MaxGraphTransitionsPerUnitPerMicroStep = 1` vale per **tutti** i profili di Move ([`gameplay/spec-tassonomia-movimento.md`](gameplay/spec-tassonomia-movimento.md):98-104), quindi «2 passi per tick» può significare solo **2 micro-step**, mai 2 archi in uno. ⚠️ **E c'è un secondo conflitto sotto, che questa domanda non risolve**: la sorgente dice *«il terreno non rallenta la cadenza»*, mentre [`D-381`](decisions/RT_PDR_00_Decision_Log.md) ha deciso il contrario — *«la durata di un attraversamento è un dato proprio del passo»* — ed è **implementata**. Chi risponde a `SKB-2` deve dire anche se `D-381` resta. **Innesco**: la prima implementazione che dia allo `Sprint` più di un passo per tick |
| `SKB-3` | **Come si chiama il fatto che un personaggio diventi noto ai nemici per aver agito?** | 🔴 **«Rivelare» ha già tre significati nel repository**, e la sorgente ne usa un quarto senza accorgersene: il colpo a segno promuove la **vittima** a contatto ([`D-380`](decisions/RT_PDR_00_Decision_Log.md)); `Status.Reveal` rende visibile l'**intento** (invariante #6); `Observe` aggiorna la **conoscenza di squadra** sulla linea visiva. Il quarto — l'**attaccante** diventa noto — regge §5, §7, §8, §9 e §11 della sorgente. ⚠️ **Quattro sensi sulla stessa parola sono il modo in cui una regola di privacy si rompe in silenzio**, e [`../CLAUDE.md`](../CLAUDE.md) §7 chiede una revisione esplicita del boundary per ogni modifica alla projection degli eventi. ⛔ **Non è una domanda di naming e basta**: il quarto senso richiede di decidere **chi** apprende (l'unità che vede? la squadra?), **per quanto** e **se sopravvive** all'uscita dalla linea visiva — cioè se sia un contatto come gli altri o uno stato nuovo. **Innesco**: la prima implementazione di una rivelazione da azione |
| ~~`SKB-4`~~ | ~~Su che cosa agiscono le varianti arma, se non piu' sull'attacco base?~~ | ✅ **IL PUNTO (2) DI `D-415` SI RITIRA: L'ATTACCO BASE CONTINUA A DIPENDERE DALL'ARMA — chiusa il 2026-09-14 da [`D-417`](decisions/RT_PDR_00_Decision_Log.md)**, decisa dall'autore. La catena `D-086`…`D-100` **non e' superata**, e la riga della matrice dei conflitti che la dichiarava tale e' stata corretta. 🔑 **La domanda ha ricevuto una risposta diversa da quella che si aspettava**: non *dove* spostarle, ma che **la ragione per cui esistono non e' esercitata da nessuno**. La loro giustificazione e' la **scelta orizzontale** ([`D-086`](decisions/RT_PDR_00_Decision_Log.md)), e nessuna UI la offre — `SelectLoadout`, `LoadoutWidget`, `EquipmentWidget`, `PreMatch` danno **zero**. ⛔ Spostarle avrebbe costruito un meccanismo per una scelta che il giocatore non compie. *Istruttoria conservata:* le altre tre uscite misurate erano *concedere un'azione come i gadget* (copre 4 varianti su 6, tocca un gate `Catalog.*`, tre asserzioni `Heroes.*` e il corpus golden su 9 scenari su 9), *ritirare la selezionabilita'* (tutte le unita' Muiren e Branth di `Scenarios/` che non dichiarano una variante la ereditano da `DefaultLoadoutFor`, e alcune sparano davvero l'attacco base modificato — il conteggio si rifa' col comando) e *fondere con le varianti d'abilita'* — **non praticabile**: il vincolo citato a sostegno e' un contract test scritto apposta per vietare la fusione. ⚠️ **Condizione di rinascita**: se un'UI di loadout offrira' la scelta orizzontale, la domanda torna in forma diversa — non «dove metterle» ma «quante e quali» |
| ~~`SKB-5`~~ | ~~Come si riprezza `Action.Mortar` se il tiro alla cieca diventa gratuito?~~ | ✅ **NON SI RIPREZZA: IL PREZZO COMPRA AREA, GITTATA E TRAIETTORIA — chiusa il 2026-09-14 da [`D-418`](decisions/RT_PDR_00_Decision_Log.md)**, decisa dall'autore. I numeri di [`D-380`](decisions/RT_PDR_00_Decision_Log.md) restano — 12 danni e ricarica 3 — e cambia la loro **motivazione**: e' una riqualificazione, non una conferma passiva. 🔑 **La misura che ha deciso**: a **18 / cd 2** il mortaio diventa numericamente **identico** ad `Action.CircularAoE` (`Attack` · 65 · raggio 4 · cd 2 · 18). Restituire i sei danni non ripristina un equilibrio: **produce un duplicato**. ⛔ **E non e' a costo zero**: **tre** test di `RTBlindFireOffensiveTests.cpp` identificano il mortaio dalla proprieta' che `D-415` (4) rende comune, quindi [#3135](https://github.com/DegrassiAaron/refactor-tactics-main/issues/3135) non atterra senza aprirli. *Istruttoria conservata:* le altre uscite erano *restituire 18/cd 2* (scartata al punto sopra), *una seconda capacita' o vincolo* (rende rosso `Cover.Destruction.HeavyAttackDeclaresStructureDamage`, che asserisce `Breachers == 1`), *ritirare l'azione* (tocca due registri PIE oltre ai previsti e fa uscire `1` due gate Python) e *far pagare la licenza sull'attacco base* — premessa falsa alla misura: `EffectiveAttackPower` non e' l'unico punto di modulazione, e il danno raggiunge gli HP per **due** catene |
| `SKB-6` | **Il proiettile esplosivo si riflette prima dell'impatto, e verso quale posizione dell'attaccante torna il colpo?** | Le due domande che [`D-410`](decisions/RT_PDR_00_Decision_Log.md) dichiara aperte, dalla sorgente §8.1 e §13.10. La prima la sorgente la marca *«da precisare»* con parole sue: `Reflect` esclude corpo a corpo ed esplosioni, ma un **proiettile** che esplode all'impatto è entrambe le cose in due momenti diversi. La seconda è un problema di **conoscenza**, non di geometria: se l'attaccante si è spostato prima del ritorno, usare la sua posizione reale significa che il colpo riflesso **legge un dato che il difensore non possiede**. ⛔ [`../CLAUDE.md`](../CLAUDE.md) §7: *«non usare informazioni nascoste solo perché il server le possiede»*. **Innesco**: il primo kit che dichiari un `Reflect` |
| `SKB-7` | **La finestra dell'Overwatch dura quanto, e il limite è per unità sorvegliante o per squadra?** | [`D-411`](decisions/RT_PDR_00_Decision_Log.md) decide che l'occasione è **per nemico e per turno** e non fissa né la durata né il perimetro del limite. ⚠️ **La sorgente §13.7 dichiara esplicitamente che il secondo punto non è stato deliberato**, quindi sceglierlo qui sarebbe dedurre. Sulla durata la baseline esiste — `FastReactionDuration = 3,0 s` di [`ADR-0004`](decisions/adr-0004-finestre-di-reazione.md) — ma è tarata su una finestra **per micro-step**, e una finestra **aggregata su più nemici** chiede al giocatore una scelta più grande nello stesso tempo. **Innesco**: la prima sessione PIE che misuri la finestra con più di un candidato |

---

## ✅ Chiusa il 2026-09-12 da `D-400` — terminare un `LiveCodingConsole` orfano, dallo spec panel dello stesso giorno
...
## Aperte — la semantica temporale del movimento, dall'audit del resolver del 2026-09-10

Origine: l'audit del movimento simultaneo registrato in
[#2902](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2902), che è anche l'owner di queste sei
domande e il posto dove vive il modello che le pone.
Misurato su `origin/main` `e27f9d0f`, sul sorgente e sui cataloghi — **non** in PIE.
Issue correlate: #2902 · #666 · #2411 · #2501 · #2516 · #2627 · #2856 · #1922 · #704 · #653.

🔑 **Perché queste sei stanno insieme, e perché non sono deducibili.** Il resolver misura il tempo in **archi
percorsi**, non in **costo pagato**: `StepHexMovement` avanza di al più un arco per micro-step
(`Source/RefactorTactics/Turn/RTHexSimLibrary.cpp:792`, `Target[i] = Paths[i][Prog[i] + 1]`) e
`ResolveHexPaths` **non riceve la mappa** — per garanzia esplicita, pinnata da
`Movement.BlockedPath_DoesNotAutoReroute`. Il costo d'ingresso entra solo a monte, in `BuildCompositeHexPath`
e `TruncatePathToBudget`, che decidono quanto **lungo** può essere un percorso e non quanto **dura**.

∴ due unità che spendono lo stesso budget arrivano in micro-step diversi, e **chi paga di più arriva prima**.
Non è un'ipotesi sul futuro: con il catalogo terreni corrente — `Rough`, `ShallowWater` e `Fire` a costo `2`,
più `+1` per cella da `Status.Slow` (`RTTurnManager.cpp:6815`) — due celle di `Rough` costano quanto quattro
di `Floor` e si attraversano nella **metà** dei micro-step.

⚠️ **Il micro-step non è un dettaglio di implementazione**: è l'istante in cui si risolvono le collisioni fra
chi si muove, si legge l'occupazione delle celle, si apre il decision boundary delle reazioni
([`ADR-0004`](decisions/adr-0004-finestre-di-reazione.md) §5) e si scrive `FRTTurnLogEntry::MicroStepIndex`,
**serializzato** in `ERTTurnLogFormatVersion::WithMicroStep`.

⛔ **Cosa NON è in discussione qui.** `MaxGraphTransitionsPerUnitPerMicroStep = 1`
([`D-305`](decisions/RT_PDR_00_Decision_Log.md)) resta: nessuna di queste sei propone che un'unità percorra
due archi in un micro-step. La domanda è se **un** arco possa durarne più di uno. Restano fuori anche
`MOV-3` (la cadenza per profilo, che è una domanda di sensazione e ha il suo innesco di playtest),
[`D-295`](decisions/RT_PDR_00_Decision_Log.md) (scambio e cicli chiusi bloccano) e
[`D-325`](decisions/RT_PDR_00_Decision_Log.md) (la contesa a parità di precedenza).

| ID | Domanda | Perché non si deduce |
|---|---|---|
| ~~`MOV-5`~~ | ~~**La durata di un attraversamento è una funzione del costo d'ingresso, o un dato proprio del passo?**~~ | ✅ **CAMPO PROPRIO DEL PASSO, DERIVATO DAL COSTO E NON LETTO DA ESSO — chiusa il 2026-09-10 da [`D-381`](decisions/RT_PDR_00_Decision_Log.md).** L'uscita *(a)* delle due. In v0.1 la durata vale **esattamente** `TotalMoveCost(cella) + max(0, MoveCostModifier)`, ma nasce **separata**, e la ragione non e' estetica: se la durata fosse *per contratto* il costo, l'unico modo di rendere un profilo piu' **rapido** sarebbe fargli costare **meno** per cella — e costare meno significa andare **piu' lontano**. Velocita' e portata sarebbero la stessa manopola per sempre, e `MOV-3` si chiuderebbe **per inerzia** invece che per playtest. ✅ **La preview e' gia' pagata finche' i due coincidono**: `FRTHexReachableCell::Cost` (`RTHexSim.h:86`) porta il costo cumulativo di ogni cella raggiungibile, e sotto la regola v0.1 quel numero **e'** il micro-step d'arrivo previsto. ⚠️ Il giorno in cui divergeranno, il ventaglio dovra' portarli entrambi — costo differito accettato. ⛔ **Non chiude `MOV-3`**, che resta aperta con il proprio innesco di playtest. *Istruttoria conservata:* La proposta di [#2902](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2902) §3 le fa **coincidere in valore** — `TraversalDurationTicks = TotalMoveCost(cella) + max(0, MoveCostModifier)` — senza farle diventare la stessa proprietà. 🔴 **E la formulazione naturale non regge**: *«un MP consumato è un micro-step»* muore contro [`D-117`](decisions/RT_PDR_00_Decision_Log.md), che #666 implementa e che porta il costo per cella a `max(0, MoveCost - 1 + MoveCostModifier)` — cioè **zero** sul terreno normale. Una durata letta dagli MP renderebbe l'attraversamento del `Floor` istantaneo. ✅ `FRTHexCellData::TotalMoveCost()` vale almeno `1` su ogni cella del catalogo **prima e dopo** `D-117`: la sottrazione della linea di base riguarda il **prezzo**, non il **tempo**. ⚠️ **Il punto della domanda non è il valore ma la sede**: decidere *«la durata si legge da `MoveCost`»* dentro i consumatori chiuderebbe `MOV-3` per inerzia, ed è precisamente ciò che `MOV-3` dichiara di non voler subire — il giorno in cui un profilo dichiarasse una cadenza propria, la durata smetterebbe di essere una funzione del solo costo. **Uscite**: *(a)* **campo proprio del passo**, derivato dal costo al congelamento dello snapshot e trasportato accanto a `Paths` come già fa `FRTPlannedMovement` per «quanto il giocatore aveva chiesto» ([#2314](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2314)) — non pregiudica `MOV-3`; *(b)* **lettura diretta del costo** nei consumatori — meno codice oggi, e un secondo owner della cadenza domani. **Innesco**: la prima PR che tocchi il resolver del movimento |
| ~~`MOV-6`~~ | ~~**Che cosa occupa un'unità durante un attraversamento che dura più di un micro-step?**~~ | ✅ **RESTA SULLA CELLA D'ORIGINE FINCHE' NON COMPLETA L'ARCO — chiusa il 2026-09-10 da [`D-382`](decisions/RT_PDR_00_Decision_Log.md).** L'uscita *(a)* delle quattro: il passo e' un **impegno**, non uno spostamento graduale, e non esiste un istante in cui un'unita' sia «fra due celle». 🔑 **La misura che ha deciso**: `State.Pos[i]` non e' solo l'occupancy — durante il ciclo e' il **soggetto autorevole** di Overwatch e della sua copertura, del facing d'impatto, del verdetto di visibilita', della conoscenza di squadra, della geometria della voce e del `MoveLog` ( — `RTTurnManager.cpp:7346-7538`, `RTTurnManager_Movement.cpp:385-457`, invariante di [#2142](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2142)), e ognuno riceve **una** `FRTCellId`. ∴ *(b)* farebbe colpire e coprire l'unita' dove non e' ancora arrivata; *(c)* renderebbe `Pos` una coppia e moltiplicherebbe una decisione per ogni consumatore; *(d)* non ha dove stare. ⚠️ **Le due conseguenze di gioco sono dichiarate**: un'unita' lenta **tappa il corridoio** per l'intera durata del passo, e incassa nella copertura **di partenza** fino all'ingresso. Sono il prezzo della lettura scelta, e chi le trovera' senza questa riga le chiamera' bug. ⛔ **Non decide la presentazione** ([#2411](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2411)) ne' il facing in transito. *Istruttoria conservata:* ⛔ **Oggi la domanda non ha una risposta scelta, ne ha una ereditata**: la durata è `1` per costruzione, quindi non esiste un istante in cui un'unità sia «fra due celle». Sotto durata variabile quell'istante esiste e il comportamento **non deve restare accidentale**. **Uscite**: *(a)* **resta sulla cella d'origine fino all'ingresso** — l'unica compatibile con `State.Pos` senza introdurre un terzo stato, ed è ciò che il codice farebbe già se la durata fosse semplicemente un contatore; *(b)* **libera l'origine e riserva la destinazione** — richiede un concetto di *reservation* che oggi non esiste in nessuna forma (vedi `MOV-7`); *(c)* **occupa entrambe** — protegge la coda e blocca il following, che è il comportamento opposto a quello voluto; *(d)* **occupa l'arco e nessuna delle due celle** — apre un buco di occupancy che `FRTHexSnapshot::Overlaps` non sa descrivere. 🔑 **La scelta è osservabile e va provata**: `Pos[i]` è la posizione autorevole durante il ciclo ([`spec-tassonomia-movimento.md`](gameplay/spec-tassonomia-movimento.md) §2.0-bis), quindi l'uscita scelta decide chi blocca chi, quale cella copre chi, e da dove parte il colpo di un tiratore che si sta muovendo. ⚠️ **Un test che distingua l'uscita scelta dalle altre tre è parte della decisione**, non un dopo: senza, *(a)* e *(c)* sono indistinguibili su ogni scenario in cui nessuno passa dalla cella d'origine. **Innesco**: la stessa PR di `MOV-5` — le due non sono separabili in implementazione |
| ~~`MOV-7`~~ | ~~**Serve una reservation degli archi, o occupancy discreta più rilevamento di ciclo bastano?**~~ | ✅ **BASTANO, E LA VOCE SI CHIUDE SENZA CODICE — chiusa il 2026-09-11 da [`D-394`](decisions/RT_PDR_00_Decision_Log.md).** 🔑 **È la firma che l'istruttoria qui sotto aspettava**: `Movement.NoArcConflictEscapesOccupancy` aveva condotto l'esibizione richiesta — nove combinazioni di durate sull'head-on, esito identico in tutte, col proprio controllo su corsie separate — e si era fermata prima del verdetto, perché la chiusura è una decisione d'autore. `D-394` la firma, e aggiunge la ragione **strutturale** che spiega perché quella ricerca doveva tornare a mani vuote: **nel modello non esiste uno stato d'arco da prenotare** — `Pos[i]` e `Target[i]` sono entrambi una `FRTCellId`, e nessun consumatore chiede *«chi sta su questo arco»*, quindi un conflitto d'arco non è osservabile per costruzione. È [`D-382`](decisions/RT_PDR_00_Decision_Log.md) a renderla superflua: tenendo l'origine occupata per tutta la traversata — e [`D-383`](decisions/RT_PDR_00_Decision_Log.md) conservando il target — entrambi gli estremi di ogni arco in volo stanno già in `Pos` e in `Target`. Tenere l'origine **è** la prenotazione della coda dell'arco, ottenuta senza uno stato nuovo e senza un campo da serializzare. Le due geometrie che altrove la impongono non esistono qui: l'incrocio diagonale non ha analogo sull'adiacenza **di bordo** esagonale (`Neighbors` dà i sei vicini planari), e gli archi additivi — un `Bridge` sopra un `Tunnel` — si incrociano solo nello spazio, che la simulazione non guarda: è **presentazione**, lo stesso rinvio che `D-382` §5 fa a [#2411](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2411). E `LinearLeap`, l'unica mobilità che *«ignora unita' e celle intermedie»* — la forma che altrove pretende una prenotazione — **non passa da questo ciclo**: risolve in `ResolveLinearMove` contro una fotografia statica dell'occupancy. 🔴 **Ciò che una reservation cambierebbe è però NOMINATO, o chi lo troverà lo chiamerà bug**: a chi sta pagando una traversata la destinazione **può essere presa** — si blocca sull'origine con `BlockedByUnit` e i micro-step già spesi sono persi, pinnato da `Movement.EarlyArrivalBlocksALaterPasser`. ⚠️ **Non è una lacuna di copertura**: l'esito è deterministico, simmetrico e coperto, e una reservation non lo riparerebbe — lo **cambierebbe**, verso la lettura *«il passo è un impegno anche verso il mondo»*. ⛔ Chi la vuole apra una voce di **gameplay**, con il proprio prezzo; non questa, e non come difetto. *Istruttoria conservata — inclusa la misura del 2026-09-11, che resta valida e la cui riga finale «porta l'evidenza, non la firma» è ora soddisfatta da `D-394`:* Il caso che di solito motiva una reservation temporale — `A→B` mentre `B→A`, con una regola che dica se lo swap è lecito — **è già bloccato e non da un reservation system**: [`D-295`](decisions/RT_PDR_00_Decision_Log.md) ← `AUTHOR-MOVE-001`, implementata da [#1922](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1922), con `ERTMoveOutcome::BlockedByCycle` e tre test propri — `HexSim.ResolveSwapBlocked`, `HexSim.ResolveClosedCycleBlocked`, `HexSim.ResolveSwapBlockedEvenWhenPassingThrough`. Fra due mobilità lineari blocca già `BlockedByImpact` (`HexSim.ResolveHeadOnBlocksLinearSwap`). ⚠️ **La domanda va quindi posta al contrario**: prima di introdurre le prenotazioni va **esibito** un caso che il rilevamento di ciclo non copre. Se non esiste, la voce si chiude **senza codice** e il modello resta a occupancy discreta ai micro-step. 🔎 Il candidato da esaminare per primo è la sovrapposizione **parziale** di due transiti sullo stesso arco in versi opposti con durate diverse — che sotto l'uscita *(a)* di `MOV-6` è ancora un ciclo, e sotto *(b)* o *(d)* potrebbe non esserlo. ⛔ [#2902](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2902) §11 esclude esplicitamente un reservation system generico dal perimetro v0.1. **Innesco**: la chiusura di `MOV-6`, che decide se il caso può esistere 🔄 **Aggiornata il 2026-09-10 da [`D-382`](decisions/RT_PDR_00_Decision_Log.md), e la voce NON si chiude.** Il candidato che questa voce nominava — la sovrapposizione **parziale** di due transiti sullo stesso arco in versi opposti — **e' caduto**: sotto l'uscita scelta per `MOV-6` entrambe le unita' restano sulla propria origine, ognuna punta alla cella dove sta l'altra, e il rilevamento di ciclo di [`D-295`](decisions/RT_PDR_00_Decision_Log.md) blocca con `ERTMoveOutcome::BlockedByCycle`. ∴ resta in piedi la domanda nella sua forma piu' stretta: **esiste un altro caso** che il rilevamento di ciclo non copre? Se non esiste, la voce si chiude **senza codice** e con la propria ragione. **Innesco** aggiornato: chiunque esibisca quel caso, oppure la decisione di dichiararne l'assenza. 🔄 **Aggiornata di nuovo il 2026-09-10, da [`D-383`](decisions/RT_PDR_00_Decision_Log.md).** La riga qui sopra diceva che il candidato *«cade»* per effetto di [`D-382`](decisions/RT_PDR_00_Decision_Log.md): **non era esatto**, e la rettifica sta nel punto (4) di quella voce. Cade perche' `MOV-8` ha deciso che le unita' **in transito** chiudono la catena — con l'uscita opposta l'head-on a durate diverse non avrebbe prodotto nessun ciclo. ✅ **Ora il candidato e' davvero coperto**, e la domanda resta viva solo nella sua forma piu' stretta: *esiste un ALTRO caso che il rilevamento di ciclo non copre?* Se non esiste, questa voce si chiude senza codice. 🔁 **Misurata il 2026-09-11 — la voce e' PRONTA a chiudersi, e manca solo la firma.** `Movement.NoArcConflictEscapesOccupancy` esercita l'head-on su **nove** combinazioni di durate — da `1/1` a `1/5` e `5/1` — e in tutte l'esito e' identico: nessuna cella percorsa, e `BlockedByCycle` su **entrambe** le unita'. Il test porta anche il proprio controllo: su corsie **separate** le stesse durate sbilanciate lasciano passare, quindi *«tutto blocca sempre»* non lo spiegherebbe. 🔑 **L'argomento che ne segue**: sotto [`D-382`](decisions/RT_PDR_00_Decision_Log.md) un'unita' e' **sempre su una cella**, mai a meta' arco — due unita' non possono quindi incrociarsi dentro un arco: o vanno verso la cella dell'altra, e allora e' un ciclo, o verso celle diverse, e allora non si toccano. **L'arco non e' una risorsa che qualcuno occupa**, ed e' per questo che non serve prenotarlo. ⚠️ **Nove combinazioni non sono una dimostrazione**, e non le presento come tale: sono l'esibizione richiesta dalla voce — *«prima di introdurre le prenotazioni va esibito un caso che il rilevamento di ciclo non copre»* — condotta e tornata a mani vuote. ⛔ **La chiusura resta una decisione d'autore**: questo commento porta l'evidenza, non la firma. |
| ~~`MOV-8`~~ | ~~**Il rilevamento di ciclo si valuta su quali unità, quando le durate divergono?**~~ | ✅ **LE UNITA' IN TRANSITO CHIUDONO LA CATENA — chiusa il 2026-09-10 da [`D-383`](decisions/RT_PDR_00_Decision_Log.md).** L'uscita *(a)* delle due: un'unita' che sta attraversando dichiara comunque il proprio target al rilevamento di ciclo. 🔑 **La misura che ha deciso**, tracciata passo per passo: con `A→B` di durata `4` e `B→A` di durata `1`, senza questa scelta B si blocca al micro-step `1` con `BlockedByUnit` (A non e' `Moving`, quindi la catena si apre su di lei) e A si blocca al micro-step `4` con `BlockedByCycle` — **due reason code per lo stesso conflitto**, e uno dei due dichiara ferma un'unita' che stava attraversando. ⚠️ Il difetto e' figlio di [`D-381`](decisions/RT_PDR_00_Decision_Log.md): con durate uguali il caso era gia' simmetrico. ✅ **Evita una migrazione**: l'alternativa era un valore nuovo di `ERTMoveOutcome`, che e' serializzato. ⛔ **Non tocca il convoy a coda libera**, dove l'ultima cella e' libera e la catena deve restare aperta. *Istruttoria conservata:* `D-295` distingue il convoy a coda libera (`A→B`, `B→C`, `C→libera`, **avanza**) dal ciclo chiuso (`C→A`, **blocca**) seguendo la catena `target → occupante`. 🔴 **Quella regola è stata scritta quando ogni arco durava un micro-step**, e la distinzione presuppone che le unità della catena si muovano **insieme**. Con durate diverse le finestre si sfalsano: se `A→B` dura `4` micro-step e `B→C` ne dura `1`, B esce da `B` al micro-step `1` e A vi entra al `4` — non è più un following, sono due movimenti indipendenti, e **nessun ciclo si forma**. **Uscite**: *(a)* la catena si valuta fra le sole unità che **completano** un arco nello stesso micro-step — conserva il senso di `D-295` e rende il ciclo un evento istantaneo; *(b)* si valuta anche fra unità con un arco **in corso** — blocca prima, ma dichiara illecita una catena che si scioglierebbe da sé. ⚠️ **Nessuna delle due riapre `AUTHOR-MOVE-001`**: il divieto resta, cambia l'insieme su cui si misura. ✅ Il banco esiste già e va esteso, non scritto: `HexSim.ResolveFreeTailConvoyStillAdvances` e `HexSim.ResolveClosedCycleBlocked`. **Innesco**: la chiusura di `MOV-6` 🔄 **Aggiornata il 2026-09-10 da [`D-382`](decisions/RT_PDR_00_Decision_Log.md), e la voce NON si chiude.** Sotto l'uscita scelta per `MOV-6` un'unita' che **non completa** un arco non sta chiedendo una cella in quel micro-step: resta sulla propria origine e non contende nulla. Questo rende l'uscita *(a)* — valutare la catena fra le sole unita' che **completano** — la lettura **naturale**, e non la rende decisa. ⛔ Sceglierla senza dirlo sarebbe esattamente l'inerzia che [`D-381`](decisions/RT_PDR_00_Decision_Log.md) e questa serie esistono per evitare. **Innesco** invariato: la prima implementazione che debba scrivere il predicato. |
| ~~`MOV-9`~~ | ~~**Path invalidation durante la Resolution: quale policy, dato che waypoint e destinazione oggi decadono in modo diverso?**~~ | ✅ **CHIUSA PER MISURA il 2026-09-10, senza decisione nuova — la premessa della domanda era STANTIA.** L'asimmetria che questa voce registrava non esiste più: il commit `eb28992a` — *«fix(2501): il Move decade dopo uno spostamento che precede il Move (D-045 Model A)»*, **su `main`** — l'ha rimossa introducendo `bPrimaDelMove` in `ARTTurnManager::ApplyForcedDisplacement` (`RTTurnManager.cpp:2776-2781`): `const bool bPrimaDelMove = InPhase < ERTMatchPhase::Move;` seguito da `PlannedPath.Reset()` · `PlannedWaypoints.Reset()` · la guardia **oppure** `bPrimaDelMove` / `PlannedCell == OldCell`, che scrive `PlannedCell = NewCell`. 🔑 `PlannedCell = NewCell` significa *«la destinazione è dove sono adesso»*, quindi in `ResolveMovement` il ramo `PlannedCell != Unit->Cell` è **falso** e non c'è nessun percorso da ricalcolare: `Model A` vale per **entrambi** i tipi di piano. ⚠️ **La condizione di fase non è un dettaglio**: la fuga da hazard risolve in `Cleanup`, a Move già avvenuto, e annullare lì la destinazione toglierebbe il movimento del **turno dopo** — *«senza questa distinzione l'arena generata si ferma per 11 turni su 12»*. ✅ Pinnato da `Actions.Push.DoesNotSpendTheVictimMove`, riscritto per asserire il decadimento di un piano a **destinazione**, e da `ForcedMovement.CancelsRemainingVoluntaryPath`. ⛔ **E le due alternative sono già morte, misurate.** `Model C` non è applicabile alla popolazione che si ferma — *«`C` rigioca DIREZIONI, e un piano che è un punto d'arrivo non ne ha»*, commit `c039515e`. `Model A'` — il piano sopravvive a uno spostamento breve — è stata misurata a **quattro bracci** su `exp/2556-a-primo`, e il verdetto è `9f180704`: *«e il verdetto è che muore»*. A tolleranza `1` non scatta mai (gli spostamenti reali che colpiscono un piano sono di **due** archi); a tolleranza `2` l'arena di `#2556` diventa verde **ma** `DoesNotSpendTheVictimMove` diventa rosso — *«i due vincoli si contraddicono alla STESSA distanza; nessuna soglia di tolleranza soddisfa entrambi»*. ⚠️ **Cosa resta, e non è una decisione**: [#2501](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2501) è `OPEN` con il DoD non consuntivato benché il codice lo soddisfi — due delle sue righe (corpus golden rigenerato, suite `VALIDA`) richiedono una run che nessuno ha dichiarato. ⛔ `D-045` **non si riapre**: il suo criterio di uscita è stato misurato su entrambe le popolazioni — il bot dalla distinzione di fase, il giocatore da `Meta.PlayerMoveDecayOnTheShowcase` (`0` annullamenti in `8` round, con **una sola** occasione nel campione). *Istruttoria conservata:* ✅ **Metà è già decisa e non si riapre**: *«auto-reroute: mai»* ([`spec-tassonomia-movimento.md`](gameplay/spec-tassonomia-movimento.md) §2, pinnata da `Movement.BlockedPath_DoesNotAutoReroute`) e [`D-045`](decisions/RT_PDR_00_Decision_Log.md), che sceglie `Model A` — un Move la cui origine effettiva è cambiata **decade** — respingendo esplicitamente `Model B`, il ricalcolo verso la stessa destinazione. ⚠️ **L'altra metà è misurata e contraddice `D-045`**: [#2501](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2501) mostra che `ApplyForcedDisplacement` fa decadere il percorso a **waypoint** (`Model A` ✅) mentre `ResolveMovement` **ricalcola** per chi ha dichiarato una **destinazione** (`Model B` ⛔), e nessuna regola dichiara quell'asimmetria. 🔴 **Sotto durate variabili l'asimmetria si allarga**: oggi la staleness di un piano ha una via sola per manifestarsi ([#1922](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1922) §3 la misura), e con attraversamenti multi-micro-step le finestre in cui una cella è libera o occupata si moltiplicano — un ricalcolo silenzioso produrrebbe percorsi che il giocatore non ha mai visto **più** spesso, non meno. **Uscite**: *(a)* allineare `ResolveMovement` a `Model A`, col costo che #2501 §D004 misura — il bot pianifica destinazioni, quindi **ogni bot spinto perderebbe il Move**; *(b)* una `D-nnn` nuova che **rivede** `D-045` dichiarando lecito il ricalcolo per il solo piano a destinazione. ⛔ **Nessun fallback nuovo va inventato altrove**: l'owner è #2501. **Innesco**: già scattato — la issue è aperta |
| ~~`MOV-10`~~ | ~~**In quale release entra l'implementazione della durata variabile?**~~ | ✅ **v0.1 — chiusa il 2026-09-10 da [`D-385`](decisions/RT_PDR_00_Decision_Log.md).** La v0.1 e' la release che **valida** la meccanica: rimandare l'adozione significa che il playtest misura un movimento destinato a cambiare, e i giudizi sul pacing andrebbero rifatti. 🔑 **E il prezzo cresce col tempo**: il costo principale e' la rigenerazione del corpus golden, e ogni epic che accende un turno di uno scenario lo fa crescere. ⚠️ Il perimetro si misura **al momento di pagarlo**, non si cita da qui. La sede del lavoro e' [#2914](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2914), che riceve la milestone. ⛔ Non e' un permesso ad allargarne lo scope. *Istruttoria conservata:* La **semantica** è materia v0.1 e la sua sede è [#2902](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2902). L'**adozione** non è gratuita e il prezzo è misurato: `FRTTurnLogEntry::MicroStepIndex` è serializzato (`ERTTurnLogFormatVersion::WithMicroStep`) e alimenta `FRTReactionOpportunityKey`, quindi ogni traccia golden esistente cambia boundary → **rigenerazione del corpus**, con il costo che [`D-245`](decisions/RT_PDR_00_Decision_Log.md) documenta; il numero di micro-step per turno cresce con il costo del terreno, e con esso la guardia a `256` ([#2856](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2856)) e le interrogazioni del decision boundary ([#2516](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2516)); l'allineamento fra le barriere di playback e il boundary canonico va rifatto ([#2411](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2411), [#2370](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2370)). ✅ **Un costo che la misura ha invece escluso**: il modello non moltiplica i **trigger** di reazione — `MovedUnitIds` è costruito sulla crescita di `Results[i].Entered` (`RTTurnManager_Movement.cpp:288`), quindi un'unità in transito non vi compare e non arma nulla. Moltiplica le **interrogazioni**, non gli scatti. **Uscite**: *(a)* v0.1, insieme alla semantica; *(b)* semantica decisa in v0.1 e implementazione in v0.2, con la divergenza fra modello e codice **dichiarata** nella spec owner invece che subita. ⛔ **Va deciso esplicitamente**, non per inerzia della prima PR che tocca il resolver. **Innesco**: la chiusura di `MOV-5` e `MOV-6` |
| ~~`MOV-11`~~ | ~~**La durata di un passo del `Forced` legge il costo del terreno, o vale un micro-step per cella?**~~ | ✅ **UN MICRO-STEP PER CELLA, SEMPRE — aperta e chiusa il 2026-09-10 da [`D-384`](decisions/RT_PDR_00_Decision_Log.md).** 🔑 **Perche' e' nata**: [`D-381`](decisions/RT_PDR_00_Decision_Log.md) ha aggiunto alla matrice di [`spec-tassonomia-movimento.md`](gameplay/spec-tassonomia-movimento.md) §2 la riga *durata del passo*, e la colonna `Forced` non aveva un valore — il §3 di quella pagina dichiara che lo spostamento forzato **ignora il costo volontario del terreno**, quindi una durata non era derivabile. La riga e' stata scritta ⏳ *non deciso* invece che assunta, ed e' cosi' che la domanda e' comparsa. **La risposta** applica al tempo la ragione che §3 da' per il prezzo: *«il costo e' cio' che si paga per SCEGLIERE di passare»*, e chi e' spinto non ha scelto. ⚠️ **Conseguenza dichiarata**: una spinta e' sempre piu' rapida di un movimento volontario sullo stesso terreno difficile. ⛔ Gli **hazard** restano applicati (`Actions.Push.CrossesHazardsOfEveryCell`): questa voce parla di tempo, non di effetti. ✅ Zero delta di comportamento. |

---

## Aperte — agire verso l'ignoto senza diventare un oracolo, dall'audit `Blind / Unseen Spatial Actions` del 2026-09-09

Origine: l'audit della capability [#2791](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2791),
il cui gate di decisione e' [#2792](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2792).
Misurato su `origin/main`: i numeri di `BLIND-1` su `197a135b`, quelli di `BLIND-4` su `47795187` piu' le correzioni di [#2815](https://github.com/DegrassiAaron/refactor-tactics-main/pull/2815). La sonda che li produce e' `RefactorTactics.BlindActions.*`
(`Source/RefactorTactics/Tests/RTBlindActionsLeakMeasureTests.cpp`, entrata con [#2803](https://github.com/DegrassiAaron/refactor-tactics-main/pull/2803) e ampliata da [#2815](https://github.com/DegrassiAaron/refactor-tactics-main/pull/2815)).
Issue correlate: #2791 · #2792 · #2793 · #2794 · #2795 · #151 · #1466 · #2596 · #2501 · #705 · #1836 · #1805 · #2629.

🔑 **Perche' queste cinque stanno insieme.** Non sono un elenco di dubbi: sono le domande che restano dopo che
la misura ha eliminato quelle deducibili. `BLIND-1` e `BLIND-2` erano **una sola** domanda nella prima
stesura di #2792, e separarle e' il risultato di una misura — hanno raggio d'esplosione diverso.
`BLIND-5` non era stata posta affatto: la matrice di #2791 prometteva una *«policy esplicita»* per hazard e
blocker ignoti, e nessuna decisione la possedeva.

| ID | Domanda | Perche' non si deduce |
|---|---|---|
| ~~`BLIND-1`~~ | ~~**L'occupazione autorevole e' informazione pubblica, e per chi?**~~ | ✅ **NO, E IL FILTRO VALE ANCHE PER IL BOT — chiusa il 2026-09-10 da [`D-371`](decisions/RT_PDR_00_Decision_Log.md), uscita (c).** Nasce la seconda classe di privacy — quella della **conoscenza** — accanto a quella dell'**intento** che l'invariante #6 gia' aveva. ⛔ Scartata la (b) per una **promessa pubblicata**: la Wiki `avversario-bot` dice *«il bot non vede piu' di te»*, e sotto la (b) sarebbe falsa nel verso opposto. 🔴 **Il canary che difendeva la posizione avversa era verde per COSTRUZIONE**: tiene il nemico nascosto *«lontano dal corridoio d'azione»*, cioe' esclude il caso in cui l'occupazione globale morde. Va riscritto. 🔴 **E `BLIND-2` eredita un vincolo misurato**: il filtro **non puo' essere incondizionato** dentro `BlockedCellsFor`, perche' `RTTurnManager_Movement.cpp:133` chiama `FindPathForUnit` nella **Resolution** — un filtro cieco li' rende cieco il resolver. L'osservatore dev'essere un **parametro**, e cio' aggancia `BLIND-2` a `OBS-1`. *Istruttoria conservata:* ⚠️ **La domanda aveva gia' una risposta scritta, e non era in un documento: era in un docstring di test.** `HexBotPlay.HiddenEnemyFairness` dichiarava — fino a `#2793`, che il 2026-09-21 ne ha ritirato il principio rimandando a [D-371] — *«l'OCCUPAZIONE resta legittimamente globale — `ReachableCells` e `DashHostiles` modellano cio' che il resolver fara', non cio' che la squadra sa, e il giocatore umano ha lo stesso vincolo. Rendere il bot piu' cieco dell'umano sarebbe sbagliato quanto renderlo onnisciente»*. E' coerente con se stessa e non e' mai stata registrata come voce `D-`. 🔴 **E la misura mostra cosa costa.** `URTHexSimLibrary::BlockedCellsFor` scorre `Snapshot.Occupancy` per intero, senza filtro, e alimenta l'anteprima del giocatore (`RTPlayerController.cpp:134` → `:139`). Misurato sulla sonda, arena piatta di raggio 4: il ventaglio passa da **61** celle a **60** con un nemico ignoto e a **59** con due, e **le celle perse sono esattamente quelle dei nascosti, una per nascosto** — non «il ventaglio e' diverso», ma una lettura di POSIZIONE. Il percorso `(0,0)→(4,0)` passa da **costo 4** in linea retta a **costo 5** con deviazione: 🔑 **anche il numero e' un canale**, ed e' il piu' stretto dei due — non serve guardare il disegno. ⚠️ Il caso e' vivo **senza toccare [D-249]**: una cella *ricordata* e' raggiungibile per [D-227], e basta un ignoto sopra. **Uscite**: *(a)* **resta pubblica per tutti** — costo **zero**, conferma il comportamento corrente e il docstring del canary diventa una `D-`; ⛔ ma chiude la capability #2791, e la matrice di privacy di quel tracker va ritirata invece di restare `NOT RUN` per sempre. *(b)* **filtrata nel Planning del giocatore, globale altrove** — apre la capability; ⚠️ introduce l'asimmetria che il docstring chiama sbagliata, e va detto perche' non lo e' (il bot non ha uno schermo: cio' che «vede» non e' un canale verso una persona). *(c)* **filtrata ovunque, bot compreso** — nessuna asimmetria; ⛔ ma cambia il comportamento del bot e le premesse dei suoi test, ed e' il costo piu' alto delle tre. ✅ **La conseguenza sul replay e' MISURATA, e non c'e'** — verificato il 2026-09-10 su `origin/main` `6c695731`. La prima stesura di questa voce diceva *«se (b) o (c), la domanda si propaga al replay — cosa mostra una traccia pubblica di un ventaglio filtrato»*, e trattava la cosa come un consumatore da avvisare. **La misura la rimuove**, per una ragione piu' semplice di quella temuta: 🔑 **il replay non registra il Planning.** `ERTLogCategory` ha undici valori — `Move`, `Combat`, `Fallback`, `Reaction`, `Environment`, `Facing`, `Predictive`, `ReactionDecision`, `ReactionClash`, `Status`, `Objective` — e sono tutti **fatti della Risoluzione**: cosa e' successo, mai cosa il giocatore **vedeva** mentre pianificava. ∴ un ventaglio filtrato non ha dove finire: `git grep` su `PreviewReachable\|ReachableCells\|SetPreviewPath\|PreviewPath` in `Source/RefactorTactics/Replay/` da' **zero** riscontri, e `TeamKnowledge` compare in quel modulo **solo** in `RTReplayAuditLibrary`, cioe' nella traccia **privata** — i cinque file del prodotto pubblico (`RTReplayRecorderLibrary`, `RTReplayStateLibrary`, `RTReplayPrivacyLibrary`, `RTReplayPlayerLibrary`, `RTMatchHistoryLibrary`) ne hanno **zero occorrenze**. ⚠️ **E la crepa che questa voce temeva non si apre**, ma va detta perche' e' vera in generale: `FreezeVerdict` produce una `FRTKnowledgeVerdict`, cioe' una maschera per squadra su un **soggetto** — un'unita' — mentre un ventaglio e' una vista derivata su un **insieme di celle**, e quel tipo non generalizza. Qui non morde solo perche' non c'e' niente da congelare. 🔴 **Ma il replay resta un consumatore da avvisare per un'altra ragione, ed e' quella giusta**: `URTReplayPrivacyLibrary::ToPublicTrace` toglie i **campi** leggendo `FieldVisibility()`, che classifica `FRTTurnLogEntry` campo per campo — `SrcCell`, `TgtCell` e `SightBlockerCell` sono `Public`. Se `BLIND-1` uscisse (b) o (c), quei campi continuerebbero a raccontare **posizioni autorevoli** in una traccia pubblica, e la coerenza fra *«cosa il Planning poteva mostrare»* e *«cosa il replay racconta»* diventa una domanda da porre — a `#1805` e a [D-316], non qui. ✅ **POSTA il 2026-09-20, ed e' `REPCELL-1`** in testa a questo documento: la domanda che questa riga rimandava esiste ora come voce propria, col canale **misurato** invece che previsto — due mondi con la stessa conoscenza autorizzata producono tracce pubbliche diverse, e la differenza e' la cella di un'unita' che l'osservatore non percepisce. 🔑 **E il residuo si e' spostato di un gradino rispetto a come questa riga lo immaginava**: non e' il *ventaglio* filtrato a finire nel replay — quella misura regge, il replay non registra il Planning — ma la cella che una voce di **Risoluzione** nomina per conto di un TERZO. **Innesco**: [#2793](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2793), che e' ferma su questa voce, oppure la prima issue che tocchi `BlockedCellsFor` |
| ~~`BLIND-2`~~ | ~~**Se il filtro si fa, DOVE vive — dentro la primitiva o in un ingresso che conosce l'osservatore?**~~ | ✅ **IN UN INGRESSO OBSERVER-AWARE SOPRA LA PRIMITIVA — chiusa il 2026-09-21 da [`D-432`](decisions/RT_PDR_00_Decision_Log.md), che la implementa in [#2793](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2793).** Osservatore e conoscenza sono INGRESSI di `URTHexSimLibrary::MakeSnapshot`: l'occupazione nasce già filtrata, e nessuna delle tre primitive che la leggono può riderivare una posizione che l'osservatore non ha. ⛔ **E la dipendenza da `OBS-1` si è sciolta senza deciderla**: il parametro porta la posizione nominata che già esisteva (`RTScenarioKnowledge::OmniscientTeamId`, promossa in `RTObserver::Omniscient`), quindi non nasce una seconda risposta alla stessa domanda e `OBS-1` resta libera in entrambe le direzioni. *Istruttoria conservata:* 🔑 **Era la stessa domanda di `BLIND-1` fino al 2026-09-09, e separarla e' il risultato di una misura, non di un gusto**: le due uscite hanno raggio d'esplosione diverso. Misurato: i consumatori di `ReachableCells` e `FindPathForUnit` **non sono solo il giocatore** — il **bot** li chiama a `Bot/RTHexBotLibrary.cpp:604`, `:743` e `:688`, e l'**harness** chiama `BuildCompositeHexPath` a `ScenarioHarness/RTScenarioSession.cpp:1381`. ∴ un filtro messo dentro `BlockedCellsFor` cambia **anche bot e harness**, cioe' decide `BLIND-1` uscita *(c)* **per effetto collaterale** invece che per scelta. **Uscite**: *(a)* **dentro `BlockedCellsFor`** — un posto solo, nessuna superficie nuova, e il filtro non si puo' dimenticare; ⛔ ma trascina bot e harness, e rende impossibile l'uscita *(b)* di `BLIND-1`. *(b)* **un ingresso observer-aware SOPRA la primitiva**, nella forma gia' provata di `URTDebugReportLibrary::DescribeIntents` e `URTKnowledgeViewLibrary::ViewForTeam` — non tocca bot ne' harness, e lascia `BLIND-1` libera di scegliere; ⚠️ ma aggiunge superficie, e un chiamante che sbaglia porta continua a vedere l'autorevole: serve che il vecchio ingresso diventi difficile da usare per sbaglio, non solo sconsigliato. *(c)* **filtro applicato a VALLE del risultato** — ⛔ **da escludere, ed e' la ragione per cui questa voce esiste**: e' costruire la vista non autorizzata e poi nasconderla, che [#1805](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1805) vieta con *«la privacy non e' non disegnare, e' non costruire la vista»*. 🔴 **AGGIORNATA il 2026-09-10, e l'innesco e' cambiato.** [`D-371`](decisions/RT_PDR_00_Decision_Log.md) ha scelto la *(c)*, quindi questa voce **non decade** — ed e' viva con **un'uscita in meno**: la *(a)* «dentro `BlockedCellsFor`» e' scartata da una misura, perche' `ARTTurnManager::ResolveMovement` chiama `FindPathForUnit` nella **Resolution** (`RTTurnManager_Movement.cpp:133`), dove *«la validazione e' AUTOREVOLE»*: un filtro cieco li' rende **cieco il resolver**. ∴ l'osservatore dev'essere un **parametro**. 🔑 **E cio' rende questa voce dipendente da `OBS-1`, aperta in testa a questo documento**: se l'osservatore e' una **posizione nominata** — `Omniscient` \| `Team N` \| `ReplayPOV` — il parametro **esiste gia'** come tipo (`RTScenarioKnowledge::OmniscientTeamId`, *«una posizione NOMINATA, non il filtro spento»*), la Resolution passa `Omniscient` e non nasce nessuna superficie nuova; se invece resta la squadra del `PlayerController`, questa voce dovrebbe inventarne **uno proprio** — la seconda risposta alla stessa domanda, cioe' il debito che [D-242] ha gia' chiuso una volta. ~~**Innesco**: la decisione su `OBS-1`~~ ⌫ **L'innesco non ha atteso `OBS-1`, e la ragione è quella scritta qui sopra**: riusare la posizione nominata esistente non è inventarne una seconda. ⚠️ Delle tre uscite ne restava **una**: la *(a)* era già scartata da [D-371] perché accecherebbe il resolver, la *(c)* è esclusa per nome da [#1805](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1805). |
| `BLIND-3` | **Un'entita' mai percepita e' selezionabile — e dove vive la regola che lo dice?** | 🔴 **Oggi la regola non e' scritta da nessuna parte: la decide il RENDERING.** `ARTUnit::RefreshComponentVisibility` chiama `SetActorEnableCollision(bRender)` con `bRender = ShouldBeRendered(IsAlive(), bKnownToObserver)` (~~`Unit/RTUnit.cpp:597` e `:490`~~ — scaduti, vedi in coda; si cercano col nome — dal commit `678cc8fc`), e il raycast non colpisce l'unita' velata perche' la presentazione le ha tolto il collider. E' la stessa fragilita' che [D-249] dichiara per se': *«se domani il velo cambiasse tecnica, la regola cadrebbe in silenzio»*. ⚠️ **E il commento che documenta il caso e' gia' disallineato**: ~~`Player/RTPlayerController.cpp:1498-1500` afferma *«il collider di un'unita' velata resta attivo […] Un nemico invisibile e' quindi CLICCABILE»*~~ — era vero prima di `678cc8fc`. La difesa in profondita' che quel commento protegge resta giusta; la sua motivazione no, ed e' la dimostrazione che una regola ospitata nella collisione non ha un posto dove restare vera. 🔴 **CORRETTO il 2026-09-20 — questa voce citava come prova vivente un disallineamento riparato TRE ORE prima che la voce fosse scritta, e il delta era gia' dichiarato in un commento di [#2792](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2792) del 2026-09-09T22:08:33Z, mai applicato.** Il commento e' stato corretto da `#2755` (`a46b2fac` 19:52, `56b170e3` 20:37; questa voce e' `bf85ecd5`, 22:53) e oggi dichiara **falsa** la propria stesura precedente. ✅ **L'argomento sostitutivo e' piu' forte, non piu' debole**, ed e' quello che il commento vivo porta ora: la guardia resta perche' `bKnownToObserver` **nasce `true`** (`Unit/RTUnit.h`), quindi fra lo spawn di un'unita' e il primo tick del velo la collisione e' accesa su un nemico che nessuno ha ancora visto. Il canary che pinna il regime a regime e' `RefactorTactics.Veil.HiddenEnemyIsNotPickable` (`Tests/RTUnitVisibilityTests.cpp`), che fa un `LineTraceSingleByChannel` vero. ⚠️ **E i riferimenti di riga di questa voce sono scaduti tutti e tre**: `SetActorEnableCollision` non e' a `Unit/RTUnit.cpp:597` ma a `:647`; `ShouldBeRendered` non e' a `:490` ma a `:433` (definizione) e `:520` (chiamata). Si cercano col nome, non col numero. 🔑 **E una misura che questa voce non aveva: il gradino `CellOnly` collassa su `Rejected` in UN punto nominabile**, `ARTHUD::ShouldDrawUnitOverlay` (`UI/RTHUD.cpp`), che risponde `Entry->Visibility == ERTKnowledgeVisibility::Live` — mentre `ViewForTeam` mappa `CellOnly` su `Remembered`. Da li' in giu' — `SetKnownToObserver` → `RefreshComponentVisibility` → `SetActorEnableCollision`, e il `bObserved` di `ResolveOutcome` — un ricordo e un ignoto sono lo stesso caso. ⛔ **Ma «non sorvegliato» sarebbe falso, e va detto perche' e' il genere di affermazione che fa aprire lavoro gia' fatto**: tre test lo pinnano — `Knowledge.HudDrawsOnlyKnownUnits`, `Knowledge.HudHidesRememberedEnemy` e `Knowledge.OverlayAndGhostAreComplementary` (`Tests/RTKnowledgeViewTests.cpp`) — e il gemello `ContactGhostTargetForUnit` **separa** i due casi sulla stessa voce, quindi il collasso e' circoscritto alla catena del picking, non «a tutto cio' che sta a valle». Cio' che davvero manca e' che nessuno di quei tre nomini `ERTTargetKnowledge`: entrano da `FRTKnowledgeEntry::Visibility`, cioe' dall'asse del disegno, e il ponte fra i due assi resta il gradino che questa voce deve decidere. 🔑 **Meta' della distinzione esiste gia', in due posti che non si parlano**: `ERTTargetKnowledge` (`CellOnly` = *«si puo' mirare alla CELLA, mai all'unita'»*, CP 13.2 / #157) e `ERTPointerTargetKind` (`Unit` contro `Cell`, CP 11.8 / #705). Il gradino scoperto e' `Rejected`, cioe' l'entita' **mai percepita**. **Uscite**: *(a)* **resta com'e'** — costo zero; ⛔ ma la regola resta un effetto del velo, e il primo cambio di tecnica la porta via senza un rosso. *(b)* **regola esplicita**, con `ClassifyTarget` consultato dal contratto del puntatore e la collisione degradata a difesa in profondita' — costa un consumatore nuovo; 🔑 e rende **falsificabile** cio' che oggi e' vero per caso. ⛔ **Cio' che nessuna uscita autorizza**: che una cella smetta di essere bersaglio SPAZIALE perche' ci sta sopra un ignoto — quello e' `BLIND-1`, e confonderli e' il modo in cui la capability si perde. **Innesco**: [#705](https://github.com/DegrassiAaron/refactor-tactics-main/issues/705), che deve enunciare la riga, oppure [#2794](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2794) |
| ~~`BLIND-4`~~ | ~~**La geometria MAI OSSERVATA e' informazione pubblica?**~~ | ✅ **LA FORMA SI', IL CONTENUTO NO — chiusa il 2026-09-10 da [`D-373`](decisions/RT_PDR_00_Decision_Log.md).** La domanda si e' ristretta **due volte**: la sonda ha misurato che la geometria era gia' pubblica, poi [`D-372`](decisions/RT_PDR_00_Decision_Log.md) ha chiuso quel canale da sola — sotto mappa ottimistica il Planning non legge piu' `bBlocksMovement`, `TotalMoveCost()` ne' `BlocksTraversal` di una cella ignota. Restava l'unica cosa che l'ottimismo non puo' inventare: `ContainsCell`, cioe' la **topologia**. Dichiarata pubblica — e' cio' che #1836 (`CAM-15`) gia' assumeva, e toglie la contraddizione con [D-225], che nasconde **cio' che c'e' dentro** una cella, non il fatto che esista. *Istruttoria conservata:* ⚠️ **Non e' vergine: un consumatore aperto la assume gia' pubblica**, ed e' il motivo per cui va decisa invece che dedotta. [#1836](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1836) (`CAM-15`) registra che la camera panora sulla forma della mappa mai esplorata — cioe' tratta la topologia come pubblica — mentre [D-225] ha deciso che la geometria non osservata **non si disegna** e [D-249] che non si raggiunge. Le due letture convivono perche' nessuno le ha messe nella stessa frase. **Uscite**: *(a)* **pubblica per design** — va **dichiarato**, e allora #1836 procede e anteprima del percorso, della LoS e della portata sono libere di attraversarla; ⚠️ ma «pubblica» va detto in un documento, non lasciato all'assenza di un divieto. *(b)* **non pubblica** — allora #1836 **eredita il vincolo** invece di deciderlo, e ogni anteprima che attraversi l'ignoto e' un canale; ⛔ e serve un'osservazione che possa diventare **rossa**: senza, la risposta non e' validabile e la prossima issue tornera' ad assumerla pubblica perche' niente la contraddice. 🔴 **CORREZIONE del 2026-09-09 — questa riga diceva il falso, e la sua confutazione e' il merito della voce.** Diceva: *«cio' che manca a questa voce, e che nessuna misura puo' darle, e' l'esempio falsificabile […] chi la chiude deve produrlo insieme alla risposta»*. Era lo stesso errore gia' fatto e gia' corretto su `BLIND-1`: **l'esempio non misura la RISPOSTA, misura il CANALE**, e due mondi con conoscenza autorizzata identica che differiscono solo per la geometria mai osservata si costruiscono **prima** di decidere. La sonda esiste ora — `RefactorTactics.BlindActions.NeverObservedWallBendsTheLitPath` e `…ReachableFanOffersNeverObservedCells` — e misura su `47795187`: **(1) canale INDIRETTO**, un muro in `(2,0)` **mai osservata** contro la stessa cella libera porta il percorso da **costo 4** in linea retta a **costo 5** con deviazione, e la differenza si **spacca**: due celle restano invisibili — `(2,0)`, il muro, e `(2,1)`, che sta sulla deviazione — mentre **una resta illuminata**, `(1,1)`. 🔑 **E' la misura che conta, non la differenza fra i tracciati**: se stesse nel buio sarebbe innocua, perche' quelle celle non si disegnano. Sta invece in **due celle illuminate** — il giocatore guarda la strada girare in piena luce e da quella curva deduce il muro. **(2) canale DIRETTO**: con il ricordo fermo a distanza 2, il ventaglio offre **61** celle di cui **42 mai osservate** — non un caso limite, la maggioranza. ∴ **la geometria mai osservata e' GIA' pubblica per entrambi i canali**, e la domanda si stringe: non *«la rendiamo pubblica?»* ma *«la dichiariamo tale, oppure paghiamo la mappa ottimistica?»*. ⚠️ **E il canale indiretto non ha un rimedio ovvio**: per non piegare, il percorso dovrebbe ignorare il muro — cioe' proprio la mappa ottimistica che [D-249] aveva contato fra i costi da evitare, insieme alla regola d'interruzione nel resolver. **Innesco**: [#1836](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1836), oppure la prima anteprima che debba attraversare celle mai viste |
| ~~`BLIND-5`~~ | ~~**Hazard e blocker IGNOTI seguono la stessa policy del nemico ignoto, o una propria?**~~ | ✅ **NESSUNA POLICY NUOVA: IL CANONE GIA' LI COPRE — chiusa il 2026-09-10 da [`D-374`](decisions/RT_PDR_00_Decision_Log.md).** [`D-372`](decisions/RT_PDR_00_Decision_Log.md) risolve il Planning (ignoto = caso migliore, quindi il costo non li rivela); la Resolution aveva **gia'** le due regole: `TruncatePathToTopology` per il blocker — *«il movimento si FERMA all'ultima cella valida, non si annulla»* — e `TruncatePathToBudget` per l'hazard, che **ricalcola il costo sulla mappa vera** e accorcia il piano da solo. Nessuna delle due ricalcola un percorso: [D-045] regge per costruzione. ⚠️ La copertura e' **dedotta dal codice, non misurata su un Blind Move**: il test appartiene a #2794. *Istruttoria conservata:* ⚠️ **La domanda non era stata posta, e la matrice la prometteva gia'**: il tracker [#2791](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2791) porta le righe `hidden hazard` e `hidden blocker` con la dicitura *«policy esplicita»* in ogni colonna, e nessuna decisione la possedeva. Una riga di gate che nomina una policy che nessuno decide e' un `NOT RUN` travestito da piano. 🔑 **E i due casi non sono il nemico nascosto con un altro nome.** Un nemico ignoto cambia l'**occupazione**; un hazard ignoto cambia il **costo** — e il costo e' il canale piu' stretto, misurato: sulla sonda il percorso passa da 4 a 5 per una sola cella occupata, e una cifra che sale su una direttrice libera dichiara un'ostruzione senza bisogno di un disegno. Un blocker ignoto e' il terzo caso ancora: cambia la **topologia** percorribile, quindi tocca `BLIND-4` e non solo `BLIND-1`. **Uscite**: *(a)* **stessa policy del nemico ignoto** — un'unica regola da provare; ⚠️ ma un hazard non si muove, quindi «ignoto» per un hazard e' una condizione piu' stabile e la scadenza dei contatti non lo governa. *(b)* **il costo mostrato riflette l'hazard reale**, l'occupazione no — ⛔ e' la risposta che viene naturale scrivere ed e' quella che regala il canale piu' stretto: da scartare esplicitamente, o adottare sapendo cosa costa. *(c)* **policy differenziata per famiglia** (hazard, blocker, superficie) — la piu' fedele al gioco; ⛔ ma sono tre regole invece di una, e ognuna vuole il suo canary. **Innesco**: la decisione su `BLIND-1` — questa voce non ha senso prima — oppure la prima issue che porti un hazard non osservabile |

⚠️ **Nessuna di queste cinque blocca la v0.1 di per se'**, ma [#2793](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2793) **si'**: il difetto che misura e' etichettato `v0.1` perche' e' osservabile nella vertical slice, mentre la sua correzione non puo' partire prima che il **dove** sia deciso. Il disallineamento fra le due milestone **e'** la misura dell'urgenza, e non e' un errore di etichettatura.

🔴 **Corretto il 2026-09-10: questa riga diceva `BLIND-1`, che nel frattempo si e' chiusa.** Il blocco di [#2793](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2793) **non e' caduto: si e' spostato.** [`D-371`](decisions/RT_PDR_00_Decision_Log.md) ha dichiarato il **verso** — uscita *(c)*, filtro ovunque, bot compreso — e cio' che resta e' `BLIND-2` (**dove** vive il filtro), che dipende da `OBS-1` (**di chi** e' la vista). ⚠️ **La differenza non e' accademica**: una precondizione che nomina un gate gia' passato mentre quello vero e' un altro e' l'unico modo in cui quella issue puo' essere avviata per errore. Il suo corpo porta ora la stessa correzione.

⛔ **Cio' che questo blocco NON apre.** Nessuna meccanica nuova di detection, propagazione del suono o simulazione dell'incertezza: hanno owner propri e futuri — [#2090](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2090) (`Gadget.Sensor`) e [#1568](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1568) (`CP 27.3 · Stealth`). E nessuna riscrittura della fog of war: [D-225] e [D-227] non sono in discussione qui.
...
| ID | Domanda | Perché non si deduce |
|---|---|---|
| ~~`GOV-4`~~ | ~~**Il contratto `A/B` «Dual Roadmap» diventa un owner del repository, o resta un formato d'ingresso che ogni volta si revisiona?**~~ | ✅ **EMENDAMENTO AD `AGENTS.md` §8 — chiusa il 2026-09-05 da [`D-336`](decisions/RT_PDR_00_Decision_Log.md).** L'uscita è la ***(c)***, che questa voce non elencava: il contratto **non** diventa un owner e **non** resta un formato da revisionare da capo. `AGENTS.md` §8 acquista la sottosezione *«Un work order esterno»* — entra il **contenuto** del kit, il **preambolo di processo** è già scritto e non lo emenda, e se i due divergono vince il contratto. 🔑 **Ciò che ha spostato la decisione è che la misura dichiarata impossibile era possibile**: la voce diceva *«nessuna misura può dire quanti kit arriveranno ancora»* — vero per il futuro, ma il **ritmo** del passato è un dato. Su `origin/main` = `009ef817`: **17** referti di `roadmap/plans/` su 136 consumano una consegna esterna, e quello che ha istruito questa decisione è il **18°** — **9 in sette giorni** (2026-08-26 → 09-01, 1,3 al giorno) contro **9 in due giorni** (09-04 → 09-05, 4,5 al giorno). Il ritmo è **triplicato in undici giorni**. ⚠️ **Due premesse di questa stessa voce sono state corrette.** *«Tre istanze in due giorni»* **sottoconta**: guarda il solo contratto `A/B`, che vive in **tre** file, mentre **cinque** portano `dual-roadmap` nel **nome** — l'etichetta si è propagata più in fretta della regola. E il *«quarto work order della stessa forma»* dell'innesco è arrivato come quarto **genere**, non quarta **forma**: il mandato del 2026-09-05 ha una struttura propria (§1…§14) e non usa le fasi `A/B`. È il **genere** che questa decisione governa. 🔑 **La misura che decide non è il ritmo ma la ripartizione del valore**: delle quattordici sezioni di quel mandato, quelle procedurali erano già canone — ricognizione = `CLAUDE.md` §1, anti-duplicazione = `CLAUDE.md` §7, formato del report = `CLAUDE.md` §9 (**migliore**, perché impone `NOT RUN`) — e il valore stava **interamente** nelle candidate tecniche. ∴ un kit non si accetta né si rifiuta in blocco. ⛔ **Perché non l'uscita *(b)***: sarebbe il terzo contratto di processo, cioè il rilievo `R1` di due referti e il difetto che [`D-181`](decisions/RT_PDR_00_Decision_Log.md) ha pagato per rimuovere. ⛔ **Perché non la *(a)***: al ritmo misurato il costo della revisione si ripete ~4,5 volte al giorno per riscoprire ogni volta che il preambolo era già scritto. ✅ **E la forma di *(c)* non è nuova**: [`D-330`](decisions/RT_PDR_00_Decision_Log.md) aveva emendato §9 con *«Authoring e acceptance»* il giorno prima, invece di creare un documento. *Istruttoria conservata:* Non si deduce perché **la misura dice solo che il template ricorre, non cosa farne**. Misurato: tre istanze in due giorni, con fasi `A0…A6`/`B0…B7` che [`D-330`](decisions/RT_PDR_00_Decision_Log.md) ha già stabilito essere *«`AGENTS.md` §8–§10 con altri nomi»*. ⚠️ **Le due uscite hanno costi opposti e nessuna è dominante.** *(a)* **Resta formato d'ingresso**: ogni kit paga una revisione — quella del 2026-09-04 ha salvato il ~15% del testo, quella del 2026-09-05 ha prodotto tre gap e nessuna roadmap — e il costo si ripete a ogni consegna, ma **nessuna regola si duplica**. *(b)* **Diventa owner**: si scrive una volta cosa il repository accetta come work order, e i kit successivi ci si conformano; ⛔ ma sarebbe il **terzo** contratto di processo accanto ad `AGENTS.md` e `CLAUDE.md`, che è precisamente il rilievo `R1` di entrambi i referti e il difetto che `D-181` ha pagato per rimuovere sull'asse delle viste. 🔑 **Ciò che nessuna misura può dire è quanti kit arriveranno ancora**: con pochi vince *(a)*, con molti vince *(b)*, e il numero è una scelta d'autore sul modo di lavorare, non un dato del repository. **Innesco**: il quarto work order della stessa forma, oppure una decisione d'autore sul canale con cui i kit entrano |
...
| ID | Domanda | Perché non si deduce |
|---|---|---|
| ~~`REL-3`~~ | ~~**La caduta da un bordo aperto entra nella v0.1, o resta dietro la release che oggi non esiste?**~~ | ✅ **ENTRA NELLA v0.1 — chiusa il 2026-09-05 da [`D-332`](decisions/RT_PDR_00_Decision_Log.md).** L'uscita *(a)* delle tre: **ampliamento di perimetro dichiarato**, non dedotto. 🔑 **Ciò che ha spostato la decisione è la misura del costo**, non un'argomentazione: il `LastStableCell` del fallback è già l'esito che `StepUntilBlocked` produce oggi, quindi non c'è una posizione da inventare — mancano gli **effetti** e la **traccia**, e il ramo da scrivere sta dietro una condizione sola (`Data == nullptr`). ⛔ **Le regole di risoluzione non sono decise qui**: arrivavano consolidate dal work order e il loro owner semantico è [`spec-caduta-e-bordi.md`](gameplay/spec-caduta-e-bordi.md), creato con `D-332`. ⚠️ **L'omonimo resta da non fondere**: la caduta gravitazionale non applica `Prone` per sé, ma un'unità `Unbalanced` spinta oltre un bordo attraversa anche [`D-319`](decisions/RT_PDR_00_Decision_Log.md). *Istruttoria conservata:* Non si deduce perché **due sedi dicono cose diverse e nessuna delle due è sbagliata**. [`roadmap-post-v0.1.md`](roadmap/roadmap-post-v0.1.md) colloca il cluster *«3D map / verticalità»* su release canonica **`future`**, owner *«nessuno»*, azione **`DEFER`**, e lo registra fra i *«due cluster che non hanno una release che li possieda»*. Ma la v0.1 possiede già il **substrato**: `FRTCellId{X, Y, Layer}`, A\* multilivello, LOS che attraversa i layer, ponti `CP 9.4` e `ERTHexSurface::Void`. ∴ ciò che manca non è la verticalità — è **una regola per il bordo**. 🔑 **E il costo misurato è più basso di quanto la collocazione `future` suggerisca**: `StepUntilBlocked` (`RTHexCombatLibrary.cpp:540-554`) ferma già la spinta *«sulla cella libera precedente»* e lavora a `Target.Layer` costante, quindi il `LastStableCell` del mandato **è l'esito di oggi** e ciò che manca sono gli effetti e la traccia, non la posizione. ⚠️ **Il costo che non è basso sta a valle**: `ERTMoveOutcome` e `ERTDisplacementBlockReason` viaggiano nel TurnLog come **indice**, e il formato è oggi `ERTTurnLogFormatVersion::WithMicroStep` = **12** — aggiungere valori in coda non è una migrazione, riordinarli o cambiare esiti già prodotti sì, con rigenerazione del corpus golden ([`D-245`](decisions/RT_PDR_00_Decision_Log.md)). ⛔ **Non si decide misurando**: la v0.1 è un perimetro d'autore, e `roadmap-v0.1.md` non nomina la caduta né per includerla né per escluderla — il silenzio non è un permesso. ⚠️ **Dipendenza da dichiarare insieme**: [`D-319`](decisions/RT_PDR_00_Decision_Log.md) ha introdotto il 2026-09-04 una regola omonima — chi subisce uno spostamento forzato mentre è `Unbalanced` finisce `Prone` — e le due «cadute» vanno conciliate in qualunque uscita. **Uscite**: *(a)* v0.1, con l'ampliamento di perimetro dichiarato · *(b)* una release post-v0.1 nominata, che toglie la verticalità dai cluster senza casa · *(c)* resta `future`, e `#2388` resta un contratto di capability senza lavoro figlio. **Innesco**: una decisione d'autore sul perimetro della v0.1, oppure la prima mappa che autori un bordo aperto |
...
RiseToFire»* (2026-08-31), istruito contro `origin/main` `3b3aafc4` dal referto
[`movimento-cover-visibilita-consolidamento-spec-panel-2026-08-31.md`](roadmap/plans/movimento-cover-visibilita-consolidamento-spec-panel-2026-08-31.md).
Registrate da [`D-305`](decisions/RT_PDR_00_Decision_Log.md).

🔑 **Delle ventuno clausole del mandato queste sei sono ciò che resta dopo la misura.** Undici erano già
canone — quattro *verbatim*, col tipo e il test in `Source/` — e la reticola a dodici anchor che il mandato
introduce è `ERTAnchorKind`, chiuso da [`D-288`](decisions/RT_PDR_00_Decision_Log.md) lo stesso giorno.
Nessuna di queste sei si chiude misurando ancora: chiedono di scegliere.

> 🔁 **Aggiornato il 2026-09-01 — la tabella ha otto righe, due non sono di questo mandato, e una delle due
> è già chiusa.** `COV-11` e `COV-12` vengono dal kit d'autore *Cover · Melee · AoE · Facing v0.1*
> ([referto](roadmap/plans/cover-melee-aoe-facing-consolidamento-spec-panel-2026-09-01.md)), consumato il
> giorno dopo `D-305`. ⛔ **Nessuna delle due è fra le ventuno clausole misurate sopra**, e i conteggi
> «queste sei» di questa sezione restano veri per il mandato che nominano.
>
> - ~~`COV-12`~~ — **chiusa lo stesso giorno, per misura**: la domanda era mal posta, e il residuo è
>   implementazione ([`#2009`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2009),
>   `enhancement`/`P2`). ⚠️ **Ironia registrata**: la frase qui sopra dice *«nessuna di queste si chiude
>   misurando ancora»*, e questa si è chiusa esattamente così — resta vera per le sei che nomina, non per le
>   aggiunte.
> - ~~`COV-11`~~ — **chiusa lo stesso giorno, anch'essa per misura**: era già decisa per tre quarti da
>   [`D-269`](decisions/RT_PDR_00_Decision_Log.md) (`GEO-4`) e da `CP 9.2`, e cercata nella **serie
>   sbagliata** — parla di un segmento, non di una scelta d'unità. Il confine fra `COV-*`, `GEO-*` e `GBX-*`
>   è ora dichiarato nel
>   [thread di `#1833`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1833#issuecomment-5492831350).
>
> 🔴 **Questa nota è stata scritta due volte, e la prima diceva l'opposto della riga che introduce**:
> dichiarava `#1833` owner di `COV-11` mentre la riga, corretta poche ore prima, diceva il contrario. La
> correzione di perimetro era finita in un posto solo dei due — il difetto che
> [`D-282`](decisions/RT_PDR_00_Decision_Log.md) chiama *«due sedi che dicono l'opposto sullo stesso
> oggetto»*, prodotto da una correzione parziale invece che da una svista.

| ID | Domanda | Perché non si deduce |
|---|---|---|
| `MOV-3` | I profili di movimento restano a **cadenza unica** — un arco di grafo per micro-step per tutti — o alcuni diventano eleggibili a un **FAST micro-step** alternato? | Il mandato §7 lo marca esplicitamente `NON LOCKED — PLAYTEST OPTION`, e non si deduce perché **la domanda è di sensazione, non di codice**: oggi `Sprint` si distingue per budget (`8 MP` contro `5`), rumore (`5`), `Status.Exposed` e rinuncia alla reazione, e nessuna misura dice se basti. ✅ **La dipendenza che bloccava la domanda si è sciolta il 2026-09-12.** Diceva: *«lo `Sprint` ha una migrazione aperta di macro-fase — oggi risolve in `20` (`FastMovement`, con Dash) mentre il catalogo lo dichiara profilo `Move` post-Blast»*, e che decidere la cadenza prima di quella migrazione l'avrebbe decisa per inerzia. La migrazione è stata eseguita ([D-116](decisions/RT_PDR_00_Decision_Log.md) voce 1, [#641](https://github.com/DegrassiAaron/refactor-tactics-main/issues/641)) e il catalogo si è allineato ([#3186](https://github.com/DegrassiAaron/refactor-tactics-main/issues/3186)): ∴ **la domanda è ponibile adesso**, e ciò che manca è solo il playtest dell'innesco. ⚠️ Lo `Sprint` distingue oggi per budget **×2** ([D-412](decisions/RT_PDR_00_Decision_Log.md), non più l'assoluto `8 MP`), rumore `5`, `Status.Exposed` **2 turni** e rinuncia alla reazione. ⛔ **Anche in un FAST micro-step resta `1` arco per unità**: questo il mandato lo blocca, e non è in discussione. **Innesco**: un playtest che misuri lo Sprint come «abbastanza lungo ma non abbastanza rapido» |
| ~~`MOV-4`~~ | ~~La contesa sulla stessa cella nello stesso micro-step blocca **sempre tutti**, o resta la precedenza dichiarata dall'azione?~~ | ✅ **LA CLAUSOLA SI RIFORMULA — «a parità di precedenza dichiarata, tutte le entrate in conflitto sono bloccate» — E `FRTActionDef::Priority` RESTA — chiusa il 2026-09-04 da [`D-325`](decisions/RT_PDR_00_Decision_Log.md).** L'uscita *(a)* delle due: il divieto del mandato è già rispettato — nessuna delle tre forme vietate esiste, e la precedenza è un **dato di catalogo dichiarato dall'azione**, non un bias legato a chi muove — mentre l'uscita *(b)* avrebbe pagato una **migrazione di formato v7** con rigenerazione del corpus golden per rimuovere uno strumento che non viola nulla. *Istruttoria conservata:* Il mandato §3 chiede *«all conflicting entries blocked»* e vieta *«initiative score, speed priority, UnitId priority»*. 🔑 **Le due frasi non chiedono la stessa cosa.** Il divieto è **già rispettato e pinnato** — `Actions.Collisions.NoPlayerIdBias`, `HexSim.ResolveOrderIndependent`, `Movement.StepperIsDeterministicUnderPermutation` — perché ciò che esiste non è nessuna delle tre: è `FRTActionDef::Priority`, un **dato di catalogo dichiarato dall'azione** (numero più basso vince, `RTHexSimLibrary.cpp:679-701`). ✅ **A parità di precedenza il mandato è già vero**, e ha il suo test: `HexSim.ResolvePriorityTieStillContested`; con gli array vuoti *«l'esito è identico alla variante senza priorità»*. 🔴 **Il costo della rimozione non è una riga**: `ERTMoveOutcome::BlockedByPriority` è **serializzato nel TurnLog, formato v7** (`RTTurnLog.h:368`, `Entry.Priority` a `RTHexSimLibrary.cpp:966`), quindi togliere la precedenza è una migrazione di formato con rigenerazione del corpus golden — la conseguenza già pagata da [`D-245`](decisions/RT_PDR_00_Decision_Log.md). **Uscite**: *(a)* riformulare la clausola come «a parità di precedenza dichiarata», che la rende vera senza toccare nulla · *(b)* rimuovere la precedenza, con la sua migrazione |
| ~~`COV-9`~~ | ~~L'anchor **scelto da un'unità** che tipo è: `FRTAnchorRef`, un secondo tipo, o un aggancio a `FRTCoverSourceId`?~~ | ✅ **AGGANCIO A `FRTCoverSourceId` — chiusa il 2026-09-04 da [`D-327`](decisions/RT_PDR_00_Decision_Log.md).** L'uscita *(c)* delle tre, scelta perché è l'**unica che non contraddice nessuno dei due contratti in conflitto**: `FRTAnchorRef` resta il derivato di calcolo che [`D-288`](decisions/RT_PDR_00_Decision_Log.md) dichiara, e la scelta di copertura entra nel digest come [`D-302`](decisions/RT_PDR_00_Decision_Log.md) vuole, su un identificatore già intero, stabile e destinato all'hash. ✅ **Sblocca `COV-10`**, che senza un tipo non aveva da dove leggere gli edge attivi. *Istruttoria conservata:* Non si deduce perché **due contratti accettati lo stesso giorno dicono l'opposto sullo stesso oggetto**. `FRTAnchorRef` (`RTGeometryGrammar.h:249`, [`D-288`](decisions/RT_PDR_00_Decision_Log.md)/`GEO-5`) dichiara *«non è serializzato e non entra in `ComputeHash`: è un derivato di calcolo»* — corretto per un punto di **geometria d'authoring**. Ma `COV-4`, chiusa da [`D-302`](decisions/RT_PDR_00_Decision_Log.md), dichiara che la **scelta di copertura** entra in `FRTUnitStateDigest` e nell'hash, *«perché due stati che differiscono solo per la copertura scelta possono risolvere in modo diverso»*. Se l'anchor dell'unità è la sua scelta di copertura, le due frasi non possono valere insieme. 🔑 **Non riapre `COV-2`**: quella chiedeva *chi produce* un'ancora e `D-302` ha risposto «ibrido»; questa chiede *cosa fa* l'ancora scelta — la terza domanda della serie, che né `GEO-5` né `COV-2` toccano e che entrambe dichiarano di non toccare. **Uscite**: *(a)* secondo tipo per lo stato d'unità · *(b)* estensione del contratto di `FRTAnchorRef` · *(c)* aggancio a `FRTCoverSourceId`, già intero, stabile e destinato all'hash. **Owner**: [`#1833`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1833) |
| ~~`COV-10`~~ | ~~Quale **mitigazione** riceve chi ha scelto un'opzione, dato che la geometria non scelta continua ad agire?~~ | ✅ **IL BORDO ATTRAVERSATO PROTEGGE SOLO SE APPARTIENE ALL'ANCHOR SCELTO — chiusa il 2026-09-04 da [`D-328`](decisions/RT_PDR_00_Decision_Log.md)**, dopo che [`D-327`](decisions/RT_PDR_00_Decision_Log.md) l'aveva sbloccata. 🔴 **E la premessa della domanda non reggeva**: `URTHexCombatLibrary::HexCoverDamageReduction` (`RTHexCombatLibrary.cpp:180-219`) **non legge la `CoverMask` intera** — prende il penultimo passo di `HexLine(Attaccante, Bersaglio)`, lo converte in direzione e interroga `CoverOn(D)`: **un bordo solo**. Non c'era una maschera da restringere, c'era un bordo da filtrare. ⚠️ **È un cambiamento di bilanciamento e non un chiarimento**: `LowCoverDamageReduction` resta `10`, ma cambia **quante volte** si applica. ✅ **Non contraddice** `CoverPlacement.SelectingOneSourceDoesNotSuppressTheOthers`, che pinna LOS e occupancy: la geometria non scelta continua a **ostruire** e smette di **proteggere**. *Istruttoria conservata:* È il lato mancante di una regola di cui il repository ha scritto solo l'altra faccia. [`spec-cover-placement-intra-hex.md`](technical/systems/spec-cover-placement-intra-hex.md) §8 dice che scegliere una sorgente **non spegne** le altre per LOS e proiettili, e `CoverPlacement.SelectingOneSourceDoesNotSuppressTheOthers` lo pinna. Il mandato §11 dice la faccia complementare — l'unità **non** sfrutta tutta la `CoverMask` della cella, ma solo gli edge del proprio anchor — e nessun documento la scrive. ⚠️ **Le percentuali restano fuori**: sono materia `BAL-*`, e [`D-271`](decisions/RT_PDR_00_Decision_Log.md) tiene chiuso il vocabolario `None`/`Low`/`High`. La domanda è **quali bordi** entrano nel calcolo, non di quanto riducono. ⚠️ Dipende da `COV-9`: senza un tipo che porti l'anchor non c'è niente da cui leggere gli edge attivi. **Owner**: [`#1833`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1833) |
| ~~`COV-11`~~ | ~~Il **livello** di copertura continua a determinare vista, passo e proiettili, o le domande si separano in flag indipendenti sul segmento?~~ | **✅ Chiusa il 2026-09-01 per MISURA — era già decisa per tre quarti, e cercata nella serie sbagliata.** 🔴 **Prima di tutto la sede**: parla di un **segmento**, non di una scelta d'unità, e la firma coinvolta — `BlocksTraversal(Map, From, To)` — **non riceve un'unità**. È materia `GEO-*`, non `COV-*` ([confine dichiarato](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1833#issuecomment-5492831350)). ⛔ **L'ID non si rinumera**: è citato da un referto su `main`, e rinominarlo lascerebbe riferimenti stale che nessun gate vede. **Delle quattro domande che voleva rendere indipendenti**: *(1)* `BlocksLOS` ∥ `BlocksProjectiles` sono **decise insieme e dichiarate non separabili** da [`D-269`](decisions/RT_PDR_00_Decision_Log.md) (che chiude `GEO-4`) — *«le due validazioni consumano UNA SOLA primitiva deterministica […] risposte diverse renderebbero visibile un bersaglio che non si può colpire»*, che è **testualmente** l'obiezione alla separazione proposta dal kit; *(2)* `BlocksTraversal` si aggiunge alle prime due con l'argomento di [`spec-copertura-alta-cp92.md`](gameplay/spec-copertura-alta-cp92.md) — *«una copertura che togliesse la vista ma non il passo sarebbe un difetto invisibile finché qualcuno non ci cammina attraverso»*; *(3)* `BlocksMeleeContact` è **greenfield**: zero occorrenze in `Source/` e nessuna categoria `Melee` in `Combat/`, quindi non è una domanda aperta ma una che **non ha ancora un consumatore**. ➡️ **Se e quando la melee esisterà**, la sede sarà `GEO-*` e il precedente da leggere è `D-269`: la domanda non sarà *«separiamo?»* ma *«questo blocker si unisce alla primitiva condivisa o no, e perché»*. 🔎 **Istruttoria conservata**: aperta il 2026-09-01 dal kit *Cover · Melee · AoE · Facing v0.1* §1, presentata come `Core Principle` e con owner `#1833` — sbagliato due volte, nella serie e nell'owner. Referto: [§3](roadmap/plans/cover-melee-aoe-facing-consolidamento-spec-panel-2026-09-01.md). ➡️ **Il punto *(2)* ha prodotto un fix lo stesso giorno**: [#2035](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2035) ha misurato che `URTOffensiveActionLibrary::LineCells` **non consultava** `BlocksTraversal` — una copertura alta di bordo fermava la vista e lasciava passare il colpo, per 26 giorni. La non-separabilità che questa voce registra come *già decisa* era, nel codice, una regola applicata a metà |
| ~~`COV-12`~~ | ~~La riga di [`D-302`](decisions/RT_PDR_00_Decision_Log.md) *«area = centro d'impatto→bersaglio»* è **inerte**, oppure supera [`spec-copertura-cp91.md`](gameplay/spec-copertura-cp91.md) §4?~~ | **✅ Chiusa il 2026-09-01 per MISURA, senza decisione nuova — la domanda era mal posta.** Le due sedi non parlano dello stesso oggetto: `D-302` punto (3) dichiara di chiudere *«tre quarti di `FAC-13`»*, cioè la policy `FromSource`/`FromTrajectory`/`FromImpactCenter`, quindi risponde a *«da dove arriva il colpo per i test **direzionali**»* — non a *«l'area è mitigata»*. `CP 9.1` §4 possiede la **mitigazione** (nessuna, per le aree) e **resta vera**; `D-302` possiede la **direzione d'impatto** ed è accettata e **non implementata**. ⛔ **Nessuna delle tre uscite** che questa voce elencava: non serviva scegliere. 🔑 **Il residuo non è una decisione ma un difetto di implementazione**, con un consumatore solo: il pool `Guard` di [`D-292`](decisions/RT_PDR_00_Decision_Log.md) (`RTTurnManager.cpp:4677`) passa la cella dell'**attaccante** anche sotto un'area — l'altro chiamante di `IsInFrontalArc` è inerte perché per le aree `Reduction` è già `0`. ⚠️ **Nessun test copre il caso**: nessun file combina `TAG_Status_Guarded` con `ERTAbilityShape::Area`. ➡️ **Il lavoro vive in [`#2009`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2009)** (`enhancement`/`P2`), non più qui. 🔎 **Istruttoria conservata**: due stesure sbagliate prima di questa — la prima chiamava «legacy» un ramo che `CP 9.1` §3(1) dichiara normativo, la seconda cercava l'owner ma non **il contesto in cui la decisione era stata scritta**. Il referto lo registra in [§4.4](roadmap/plans/cover-melee-aoe-facing-consolidamento-spec-panel-2026-09-01.md) ✅ **Aggiornamento 2026-09-03 — il residuo è consegnato, e tre affermazioni di questa cella non descrivono più il codice.** ⚠️ **Non sono state riscritte, ed è deliberato**: erano vere il 2026-09-01 e sono il record dell'istruttoria. Ciò che è cambiato, misurato su `origin/main = 5283bb54`: *(a)* `D-302` punto (3) **è implementata** — [#2048](https://github.com/DegrassiAaron/refactor-tactics-main/pull/2048), commit `0c6b59c7`, mergiata il 2026-09-01; *(b)* il pool `Guard` **non passa più la cella dell'attaccante** sotto un'area: legge `ResolveImpactOrigin`, che per `Shape == Area` restituisce `AimCell` dal footprint, e la riga non è più `RTTurnManager.cpp:4677` ma `:4961`; *(c)* **il caso ora è coperto** — due test C++ (`Combat.AreaGuardUsesImpactCenter`, `...IsBypassedWhenImpactCenterIsBehind`) che cadono in direzioni opposte, più due scenari `Spec.Combat.AreaGuardFromImpactCenter*` da [#2062](https://github.com/DegrassiAaron/refactor-tactics-main/pull/2062). 🔑 **La previsione di rischio della issue è stata smentita dalla misura**: *«cambia esiti serializzati → rigenerazione»* — il corpus golden **non aveva nulla da rigenerare**. ⏳ **Resta NOT RUN una sola cosa**, e non è una decisione: `PIE-VIS-AREAGUARD`, la seduta che guarda se la regola si **capisce** a schermo ([`test-manuali-pie.md`](technical/test-manuali-pie.md)) |
| `PER-5` | L'esposizione **geometrica** osservatore-relativa entra come grado discreto, e con quali nomi? | Oggi `URTHexVisionLibrary` risponde *vede / non vede* **cella-a-cella**, e non esiste un grado intermedio derivato dalla geometria intra-cella. ✅ **La geometria del mandato non va ri-derivata, ed è stato verificato**: le baseline §13/§14 sono coerenti con l'anello canonico `E → NE → NW → W → SW → SE` di `ERTHexDirection` — per `Edge_NE` gli adiacenti sono `E` e `NW`, per `Corner_NE_E` gli immediatamente esterni sono `SE` e `NW`, ed è esattamente ciò che le due tabelle dicono. 🔴 **Ciò che non si può adottare è il terzo nome.** `Exposed` è occupato due volte: `TAG_Status_Exposed` (`RTGameplayTags.h:9`) è *«+5 al PRIMO danno diretto»*, il prezzo che paga `Action.Sprint`, letto dal resolver di combattimento (`RTCombatResolver.h:78`); `FRTExposedEdge` (`RTVisibilityBorder.h:21`) è il **bordo** della regione visibile. Un terzo significato sullo stesso token è il difetto che [`D-291`](decisions/RT_PDR_00_Decision_Log.md) ha respinto per `ResolutionLayer`. ⚠️ **`Hidden` e `Partial` sono liberi**, e il vocabolario di contatto esistente — `Nascosto`/`ContattoIncerto`/`Rilevato` ([`brief-conoscenza-parziale.md`](gameplay/brief-conoscenza-parziale.md) §3) — vive su un **altro asse**: è percezione, cioè l'esito a valle. ⚠️ **Dipende da [`#1830`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1830)**, l'implementazione di [`D-269`](decisions/RT_PDR_00_Decision_Log.md)/[`D-270`](decisions/RT_PDR_00_Decision_Log.md): senza LOS che legga la geometria intra-cella l'esposizione non ha da dove leggere. 🔄 **La dipendenza è caduta il 2026-09-01**: [#1830](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1830) ha implementato `D-269`/`D-270`, e `URTHexOcclusionLibrary::BlocksSight` è la primitiva da cui un grado di esposizione potrebbe leggere. ⛔ **Questo NON decide `PER-5`**, che resta aperta con la sua domanda intatta: la LOS risponde ancora *vede / non vede*, e trasformare quel verdetto in un grado discreto — con quali nomi, e osservatore per osservatore — è la decisione che nessuno ha ancora preso. **Innesco**: il primo consumatore che chieda un grado invece di un booleano |
| `OW-6` | `RiseToFire` esiste come **reaction distinta** con trigger dichiarati (`EnemyBeginExposure`, `EnemyAttack`)? | `RiseToFire`, `BeginExposure` e `Take Cover` hanno **zero** occorrenze fuori da `docs/research/`, che [`CLAUDE.md`](../CLAUDE.md) §1 esclude dall'autorità. Non si deduce perché è una meccanica, non una conseguenza. ✅ **Il §19 del mandato è già la disciplina del canone** e non va deciso: l'Overwatch standard non si modifica implicitamente, e una reaction futura dichiara i propri trigger — è la forma di [`ADR-0004`](decisions/adr-0004-finestre-di-reazione.md) e di E14 ([`#152`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/152)). ✅ **E il punto architetturale del §18 è già rispettato**: *«ritornare Hidden dopo Recover non cancella ciò che il nemico ha appena osservato»* — `FRTLastKnownContact` persiste un turno e `FRTKnowledgeVerdict` congela il diritto di lettura **quando il fatto accade** ([`D-223`](decisions/RT_PDR_00_Decision_Log.md), default *fail-closed*). ∴ **Ciò che manca non è il modello di conoscenza: è la meccanica che lo userebbe.** ⚠️ Dipende da `PER-5` per il *«Geometry Exposure must be recomputed»* della finestra. **Innesco**: la prima abilità che richieda esposizione per colpire |

> ⛔ **Ciò che questa sezione NON riapre.** `COV-1`…`COV-6` restano chiuse da [`D-302`](decisions/RT_PDR_00_Decision_Log.md)/[`D-303`](decisions/RT_PDR_00_Decision_Log.md);
> `GEO-5`…`GEO-9` da [`D-288`](decisions/RT_PDR_00_Decision_Log.md); `DQA-030` da [`D-294`](decisions/RT_PDR_00_Decision_Log.md).
> Il divieto di [`D-304`](decisions/RT_PDR_00_Decision_Log.md) — *«né otto direzioni né un terzo concetto di
> settore»* — **non è stato violato**: i dodici anchor del mandato sono i dodici confini di settore che
> `SectorBoundaryPoints` già restituisce, e `ERTAnchorKind` dichiara di dare loro *«un NOME, senza aggiungere
> punti»*.
>
> ⏭️ **Il lavoro che queste sei NON bloccano** è [`#2000`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2000):
> i due test che pinnano le regole già applicate — `OneTransitionMax_PerMicroStep` e
> `BlockedPath_DoesNotAutoReroute` — sono le uniche due delle quattordici chieste dal mandato che siano
> insieme **assenti e scrivibili oggi**, e non cambiano nessun esito serializzato. Anche se `MOV-3` si
> chiudesse a favore dei FAST micro-step, il tetto di **un arco per unità per micro-step** resterebbe:
> il primo test non anticipa quella decisione.
>
> ✅ **Undici clausole non sono qui perché erano già canone**, quattro di esse *verbatim*: il vocabolario di
> targeting `Allowed`/`CellOnly`/`Rejected` è `ERTTargetKnowledge` parola per parola, il divieto di
> auto-reroute è una riga della matrice di [`spec-tassonomia-movimento.md`](gameplay/spec-tassonomia-movimento.md) §2,
> i profili `Sneak`/`Move`/`Sprint` sono [`D-015`](decisions/RT_PDR_00_Decision_Log.md), e il `LastKnown` che
> non insegue è pinnato da `Vision.PlaybackTroncaAlTrattoOsservato`.
...
| ID | Domanda | Perché non si deduceva, e come si è chiusa |
|---|---|---|
| ~~`GEO-5`~~ | ~~Il riferimento a un anchor entra nel formato dell'asset, o resta derivato a resolve/bake? E con quale forma?~~ | ✅ **USCITA (b) — DERIVATO, NESSUN CAMPO SERIALIZZATO — chiusa il 2026-08-31 da [`D-288`](decisions/RT_PDR_00_Decision_Log.md).** *Istruttoria conservata:* non si deduceva perché il repository applica **due** forme opposte allo stesso problema, nello stesso file. `URTHexMapAsset::ValidateMap` governa l'identità condivisa di una struttura su più bordi così: le **porte** usano un campo (`FRTHexDoor::DoorId`) — *«più bordi con lo stesso nome sono legittimi solo se sono lo STESSO gruppo»* — mentre gli **archi** usano una relazione — *«qui il gruppo non è un campo, è una RELAZIONE. Due archi condividono legittimamente il nome solo se sono reciproci»*. Il criterio che separa i due casi è discernibile: **serve un campo quando l'appartenenza al gruppo non è deducibile dalla geometria**, basta una relazione quando lo è. Per un anchor la coincidenza è deducibile dall'adiacenza che `URTHexLibrary` già enumera — *«la direzione opposta: il bordo condiviso, visto dall'altra cella»* — quindi è il caso degli archi. ⚠️ **Il vincolo che ne discende**: non essendo persistita, la chiave dev'essere **totale e stabile**, non solo corretta; è la proprietà che sostituisce la persistenza e va fissata da un test. **Consumatore**: [`#1893`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1893) |
| ~~`GEO-6`~~ | ~~Le junction sono un concetto della grammatica? Una T che si innesta a metà di un segmento obbliga a spezzarlo sull'anchor?~~ | ✅ **USCITA (a) — NESSUNA JUNCTION E NESSUNO SPLIT IN v0.1 — chiusa il 2026-08-31 da [`D-288`](decisions/RT_PDR_00_Decision_Log.md), che conferma la decisione del 2026-08-12 registrata in [`#712`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/712).** *Istruttoria conservata:* due decisioni datate in direzioni opposte — [`#712`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/712) il 2026-08-12 (*«lo snap non aggancia le junction: non sono un concetto di questa grammatica»*) e il documento Drive il 2026-08-31 (T-junction con split esplicito). La più recente **non vince per data**: vince quella con un consumatore, e non ne esiste nessuno. Misurato: nessuna regola distingue oggi un segmento spezzato da uno intero — il bake consuma `EdgesTouchedBy`, che guarda la geometria e non gli estremi; `ValidateMap` guarda l'identità; vista e passo non consultano affatto i muri interni. L'unico consumatore plausibile di *«una porzione di muro»* è una porta, e le porte vivono sui **bordi** con `DoorId`, non a metà di un segmento interno. 🔑 **Questo non indebolisce le regole d'incidenza**: *«due segmenti si incontrano solo su un anchor»* si formula senza junction — una T fuori-anchor è un'intersezione fuori-anchor e resta invalida, una T sull'anchor è legale e non richiede split. **Innesco per riaprire**: la prima feature che debba riferirsi a una *porzione* di segmento interno — un'apertura a metà muro (`E23`, la candidata più probabile), un tratto distruttibile con integrità propria (`CP 22.x`), o un cambio di tipo a metà. **Consumatore**: [`#1894`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1894) |
| ~~`GEO-7`~~ | ~~Il segmento su un bordo condiviso è un record solo con `StableId` condiviso, o due facce risolte simmetricamente come oggi?~~ | ✅ **USCITA (b) — DUE FACCE, IDENTITÀ PER RECIPROCITÀ — chiusa il 2026-08-31 da [`D-288`](decisions/RT_PDR_00_Decision_Log.md), che registra una scelta già fatta.** *Istruttoria conservata:* la forma chiesta dal documento era **già stata considerata e scartata**, nell'intestazione del test `RebakeTouchesOnlyTheInvestedRegion` ([`#883`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/883)): *«la tentazione ovvia — "scrivo la copertura su tutte e due le facce, così è coerente" — sarebbe un difetto: `CoverBetween` legge già entrambe le facce, quindi la seconda scrittura non aggiunge nulla al gioco e aggiunge un elemento all'array che entra in `ComputeHash`. Due mappe che si giocano identiche avrebbero hash diversi.»* La misura conferma la posta: le coperture **entrano** in `ComputeHash`, ordinate per bordo, e il criterio contro cui questo pesa è lo stesso che ha tenuto `FRTHexInteriorWall` **fuori** dall'hash. 🔴 **Il residuo che l'istruttoria ha trovato**: il bake non scrive mai la seconda faccia, ma un autore sì — ridisegnando dalla cella opposta, o dal pannello Details — e `ValidateMap` non se ne accorge, perché la sua regola *«coperture sovrapposte sul bordo»* guarda **dentro** una cella e non fra due. Manca una segnalazione, non un formato: **Warning**, con il precedente di forma già presente (*«Warning: transizione ridondante tra celle gia' adiacenti»*). **Consumatore**: [`#1893`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1893) |
| ~~`GEO-8`~~ | ~~Le ventiquattro coppie di anchor che nessun asse tattico porta si rifiutano, o la grammatica si estende oltre i sei assi?~~ | ✅ **USCITA (a) — SI RIFIUTANO; LA PALETTE v0.1 RESTA DI TREDICI ANCHOR SUI SEI ASSI — chiusa il 2026-08-31 da [`D-288`](decisions/RT_PDR_00_Decision_Log.md).** *Istruttoria conservata:* il test `RefactorTactics.Geometry.NotablePairsOnTacticalAxes` misura 78 coppie, **54** esprimibili e **24** no, e l'aritmetica dice quali: fra i tredici anchor le coppie sono `C`–`V` (6), `C`–`E` (6), `V`–`V` (15), `E`–`E` (15) e `V`–`E` (36, di cui 12 adiacenti) — le 24 sono tutte e sole le **vertice ↔ punto-medio non adiacente**. Estendere la grammatica per portarle toccherebbe `ERTTacticalAxis`, la semantica di `Offset`, `AxisPoint`/`AxisPerpendicularPoint`, il bake e ogni test che conta gli assi, per diagonali interne che nessuno ha chiesto — e che il documento stesso ammette solo *«quando l'asse risultante è valido sul reticolo a 30°»*. ⚠️ **Il difetto da correggere non è l'inesprimibilità, è il silenzio**: `SnapToGrammar` *«tiene l'asse che sbaglia meno»* e restituisce `false` solo per lunghezza zero o fuori-bordi, quindi su una di quelle 24 non rifiuta — **produce un altro muro**. **Consumatore**: [`#1895`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1895) |
| ~~`GEO-9`~~ | ~~Due segmenti geometricamente identici ma di `WallType` diverso sono due muri, o un errore?~~ | ✅ **USCITA (b) — UN ERRORE: UN SEGMENTO PER GIACITURA E INTERVALLO — chiusa il 2026-08-31 da [`D-288`](decisions/RT_PDR_00_Decision_Log.md).** *Istruttoria conservata:* non era una scelta fra due opzioni pari, ma una **contraddizione interna misurabile**. `URTGeometryBakeLibrary` **li crea entrambi**, confrontando `Segment == Segment` **e** `WallType` a parte — *«due muri sulla stessa giacitura ma di tipo diverso sono due muri»* (`RTGeometryBake.cpp:272-281`); `URTHexMapAsset::ValidateMap` **li segnala**, perché confronta con `operator==`, che `WallType` non lo include (`RTHexMapAsset.cpp:717`); `URTGeometryGrammarLibrary::Validate` **li segnala** allo stesso modo, via `DuplicateSegment`. ∴ il bake produce un asset che i due validator dichiarano invalido. Due dei tre avevano già la stessa opinione, e il documento del 31/08 concorda con loro — *«segmenti geometricamente sovrapposti sono vietati, anche quando avrebbero preset o semantiche differenti»*. **Uscita operativa**: il bake smette di confrontare `WallType` a parte, e quando due segmenti identici arrivano con tipo diverso vince `High` su `Low`, la stessa regola deterministica già applicata sui bordi invece di *«vince l'ultimo arrivato»*. ⚠️ **La regola è l'identità geometrica, non la giacitura**: due muri sullo stesso asse e offset ma su **tratti diversi** restano due muri legittimi, ed è già ciò che `operator==` significa — nessuna nuova nozione di uguaglianza va inventata. ➕ **Perché non si perde espressività**: il caso d'uso di due tipi sovrapposti — *«qui blocca il passo ma non la vista»* — è ciò che i quattro flag indipendenti di [`#1867`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1867) esprimono su **un** segmento. Impilare due record era il modo di dirlo prima che esistesse il modo giusto. **Consumatore**: [`#1894`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1894) |

> 🔎 **Cosa queste cinque voci NON decidono.** Il vocabolario `None`/`Low`/`High` resta chiuso da
> [`D-271`](decisions/RT_PDR_00_Decision_Log.md), e le etichette *«Copertura leggera/media»* del documento
...
| ID | Domanda | Perché non si deduce |
|---|---|---|
| ~~`PLC-3`~~ | ~~**Quali geometrie producono un `CoverAnchor`** — solo i bordi murati, anche gli oggetti interni, o le celle adiacenti?~~ | ✅ **USCITA (B) — ANCHE GLI OGGETTI INTERNI PRODUCONO `CoverAnchor` — chiusa il 2026-08-30 da [`D-270`](decisions/RT_PDR_00_Decision_Log.md), che sincronizza la decisione d'autore `AUTHOR-GEO-002`.** *Istruttoria conservata:* Oggi la copertura è `FRTHexCover` sui **bordi**, e `D-129` ha stabilito che il bake cuoce solo quelli. Estenderla agli interni richiede un produttore che non esiste: la scelta decide se il sistema è una **rilettura** della geometria attuale o un **secondo strato** di dati |
| ~~`PLC-4`~~ | ~~**L'ingombro interno blocca LOS e movimento, o solo la copertura?**~~ | ✅ **ENTRAMBI — L'INGOMBRO INTERNO PUO BLOCCARE PARTE DEL MOVIMENTO E OCCLUDERE LA LoS, NON SOLO DARE COPERTURA — chiusa il 2026-08-30 da [`D-270`](decisions/RT_PDR_00_Decision_Log.md), che sincronizza la decisione d'autore `AUTHOR-GEO-002`.** *Istruttoria conservata:* Stessa forma di `MSE-2`/`MSE-4`, con posta più alta: il blocco sarebbe **intra-cella**, e il grafo tattico non lo rappresenta. La regola conservativa che lì rende `Blocked` una cella attraversabile, qui non ha nemmeno un posto dove essere scritta |
...
> 🔎 **Cosa queste sei voci NON decidono.** 🔁 I **valori** dei tre footprint sono stati fissati da
> [`D-307`](decisions/RT_PDR_00_Decision_Log.md) lo stesso giorno — `2`, `3`, `4` — e non erano taratura: i vincoli lasciano una
> finestra con esattamente tre interi. Il **corridoio** della
...
| `MAP-5` | **La soglia di adiacenza dei layer vale per tutti i `Kind`, o una rampa e un ascensore possono saltare un piano?** | [#1869](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1869) vincola `Stair` in `v0.1` e **dichiara la regola non permanente**, ma la v0.1 non risponde per i tipi rimasti: `Ramp`, `Bridge`, `Tunnel`, `Elevator` e `Jump` passano a qualunque span, deliberatamente. ⚠️ **Non si deduce dal codice, e il motivo è preciso**: l'uscita anticipata `Kind != Stair → true` in `URTHexArcLibrary::IsTransitionLayerSpanLegal` non distingue *«deciso di non vincolare»* da *«non ancora guardato»* — e i due casi vogliono azioni opposte il giorno in cui qualcuno autora un ascensore. 🔑 Il caso che la forza è nominato dalla issue stessa: **un ascensore che serve il piano terra e il terzo** non è un caso strano, ed è inesprimibile con una soglia unica a un piano. ⛔ E non si deduce nemmeno dall'intento di #1869: la issue scrive la regola come `\|ΔLayer\| == 1`, che vieterebbe anche lo span **zero** — soglia che il repository contraddice, perché `FRTHexEdge::Kind` vale `Stair` per **default** e `RefactorTactics.Map.Dependency.CellTakesTransitionsCitingIt` costruisce tre archi sullo stesso piano asserendo zero errori. L'implementazione ha quindi scelto `>= 2` (il *salto*), che è ciò che ogni frase in prosa della issue descrive; se la decisione qui confermasse la lettera, quei tre allestimenti vanno rivisti. ✅ **Zero costo oggi**: nessuna transizione in `Source/` né nei tre asset versionati salta un piano — misurato da `RefactorTactics.HexMap.SerializedAssetMigratesWithoutGainingData` e `RefactorTactics.HexMapValidation.VersionedMapsProduceNoNewIssues`, verdi con la regola attiva | La **prima issue che autora un `Ramp` o un `Elevator` su più di un piano**. ⚠️ E un innesco **meccanico**, che non invecchia in silenzio: `RefactorTactics.HexMap.StairLayerAdjacencyRule` pinna la grammatica di `ERTHexTransitionKind` per nome e **diventa rosso** al settimo valore, rimandando qui invece di lasciar estendere per abitudine |
| ~~`MAP-6`~~ | ✅ **CHIUSA il 2026-09-25 da [`D-439`](decisions/RT_PDR_00_Decision_Log.md).** La derivazione **consulta** le regioni invece di scriverci sopra — `DeriveStandability` ha già la mappa, quindi un ribake estraneo richiude la cella invece di perderla e la provenienza resta a due stati — e le sovrapposizioni sono **legali**, perché una AC di #1868 ne aveva bisogno mentre un'altra le vietava. ⛔ *«Sovrapposizione illegale»* esce dalle validazioni di `v0.1`. **Istruttoria conservata**, perché la domanda barrata col suo perché vale quanto la risposta: **Quali sono le regole di validazione di una regione No-Walk, e in che ordine sta rispetto al placement per footprint?** | [#1868](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1868) ne elenca **sei** — non chiuso · auto-intersecante · degenere · layer non valido · sovrapposizione illegale · traversata contraddittoria — e ne dichiara la fonte nel *«Decision Record del 2026-08-30»*. ⛔ **Quel documento non è nel repository**, e il contratto non ci può stare su Drive (`CLAUDE.md` §3 elenca chi lo possiede, e Drive non è fra le fonti): `grep -rniE 'no-walk\|nowalk' docs/` risponde **zero** — né `OPEN_DECISIONS.md`, né il Decision Log, né `spec-hex-geometry-authoring.md`, che la issue stessa indica come sede della documentazione. 🔴 **E due delle sei sono smentite dalla misura, non solo prive di fonte.** *(a)* **«Traversata contraddittoria»** è glossata come *«la regione vieta il passo, un arco autorato lo consente»*: ma `URTHexPathLibrary::GraphNeighbors` rifiuta già un arco la cui destinazione è `bBlocksMovement` — `if (!D->bBlocksMovement)` nel ciclo sulle transizioni — quindi il grafo **ha già risolto a favore della regione** e il dato è *inerte*, che è la categoria in cui `ValidateMapDetailed` mette `UnreachableCover` con `bIsError = false`. ∴ l'argomento che ha reso `Error` la regola di [#1869](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1869) — *«il grafo lo offre, il contenuto lo nega»* — **non si trasferisce**: chi la vuole `Error` deve costruirne la ragione altrove. *(b)* **«Sovrapposizione illegale»** non è definita da nessuna parte, ha almeno quattro letture (due No-Walk fra loro · sopra un `bBlocksMovement` dipinto a mano · sopra un Box Volume di #1866 · sopra un No-Cross di #1867), e **tre riguardano fratelli della stessa Epic che non esistono ancora**. ⚠️ La lettura più ovvia probabilmente **non è illegale affatto**: il bersaglio della cottura è un `bool` e la cottura è idempotente per `D-131`, quindi un secondo poligono non aggiunge niente — e la AC di cancellazione (*«restituisce la calpestabilità alle celle che non hanno **altri motivi** per essere chiuse»*) resta **senza soggetto** se le sovrapposizioni sono vietate. ⚠️ Due regole hanno inoltre una definizione doppia: *«layer non valido»* è `Layer < 0` per la grammatica (`ERTGeometryViolation::InvalidLayer`) e *«inesistente»* per la AC — e «inesistente» litiga con la griglia di lavoro di [#622](https://github.com/DegrassiAaron/refactor-tactics-main/issues/622), che permette di disegnare dove le celle non ci sono ancora; *«poligono non chiuso»* è provabile **solo se** la chiusura è un campo del dato, e non se il poligono è un anello a chiusura implicita. ✅ **Zero costo oggi**: nessun poligono No-Walk esiste — `grep -rlnE 'NoWalk\|No-Walk' Source/` è vuoto | La **prima issue che scrive un reason code** per una regione No-Walk. ⚠️ Prima di allora va deciso anche il **secondo** quesito del titolo, che #1868 dichiara aperto senza chiuderlo (*«l'ordine fra i due va scritto»*): No-Walk è un veto d'autore **sopra** `HasLegalPlacement` di [#1827](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1827), e la cottura deve poterlo distinguere da un blocco derivato dalla geometria — oggi `FRTHexCellData::bMovementBlockGenerated` è **un bit solo** per due produttori derivati, e il ramo che libera la cella cancellerebbe il veto al primo ribake estraneo |
...
| ID | Domanda | Esito, e l'istruttoria che ci è arrivata sotto |
|---|---|---|
| ~~`GOV-1`~~ | ~~**Le quattro formulazioni di prevalenza sono una gerarchia espressa male, o quattro con oggetti diversi?**~~ | ✅ **QUATTRO CON OGGETTI DIVERSI — LA PRECEDENZA E TIPIZZATA, NON UNA SCALA UNICA — chiusa il 2026-08-30 da [`D-282`](decisions/RT_PDR_00_Decision_Log.md), che sincronizza la decisione d'autore `AUTHOR-GOV-001`.** *Istruttoria conservata:* ⏳ **Aperta.** Una ordina **documenti** (`README.md` §Gerarchia), una **tipi di affermazione** (header del Decision Log), una **fonti di natura diversa** (prosa di `DOC_CONFLICT_MATRIX.md`, ora normativa per [D-210]), una un **taglio del canone** (`piano-canonico-mvp.md` §1). ⚠️ **Se ordinano oggetti diversi non sono in conflitto**, e la premessa di `#1396` — «quattro formulazioni di prevalenza» — è la cosa da correggere, non la gerarchia |
| ~~`GOV-2`~~ | ~~**Il canone contiene una gerarchia che batte quella che lo classifica: paradosso o delega?**~~ | ✅ **DELEGA, NON PARADOSSO — LE ECCEZIONI ESPLICITE RESTANO ESPLICITE — chiusa il 2026-08-30 da [`D-282`](decisions/RT_PDR_00_Decision_Log.md), che sincronizza la decisione d'autore `AUTHOR-GOV-001`.** *Istruttoria conservata:* ⏳ **Aperta.** `piano-canonico-mvp.md` §1 sta al **livello 1** della tabella del README, che lo annota «prevale su tutto». Delle due: o è un paradosso di governance, o è una **delega** — il README dice «per i documenti chiedi al canone». La seconda lettura non richiede nessuna correzione, solo una riga che la dichiari |
| ~~`GOV-3`~~ | ~~**Dove stanno i cataloghi di `balance/` nella prosa della matrice, che non li nomina?**~~ | ✅ **OWNER NUMERICO DENTRO LE REGOLE DEFINITE DALLE SPEC — chiusa il 2026-08-30 da [`D-282`](decisions/RT_PDR_00_Decision_Log.md), che sincronizza la decisione d'autore `AUTHOR-GOV-001`.** *Istruttoria conservata:* ⏳ **Aperta, e già mezza risposta.** [D-210] li ha collocati nella tabella del README — sotto le specifiche, «numeri non regole» — ma la scala normativa in cima a `DOC_CONFLICT_MATRIX.md` continua a non nominarli. Coerente, incompleta |
...
| ID | Domanda | Perché non si deduce |
|---|---|---|
| ~~`COOK-1`~~ | ~~**Quali asset di `Content/FabAsset/` entrano nel cook, e con quale meccanismo?**~~ | ✅ **UN SET MINIMO ESPLICITO DI DIPENDENZE, NON L'ALBERO PARAGON INTERO — chiusa il 2026-08-30 da [`D-262`](decisions/RT_PDR_00_Decision_Log.md), che sincronizza la decisione d'autore `AUTHOR-COOK-001`.** *Istruttoria conservata:* Le due vie hanno costi non confrontabili e nessuna è dominante. Elencarli per nome (`DirectoriesToAlwaysCook`, o una lista di asset) li lega a pack di terze parti che il repository **non versiona**: chi clona senza i pack passerebbe da un degrado silenzioso a un **cook che fallisce**. Cuocere l'albero intero è fuori discussione — `Content/FabAsset/` è gitignorato e pesa ~44 GB. ⚠️ **E il perimetro non è otto**: [`#288`](https://github.com/DegrassiAaron/refactor-tactics-main/issues/288) ha aperti i dodici montaggi `AM_<Pack>_{Attack,Hit,Death}`, quindi il meccanismo scelto deve reggere **venti** asset, non otto — una lista scritta a mano oggi va rifatta domani. 🔴 **Aggiornamento del 2026-09-03 (#1663): due delle vie qui confrontate NON esistono, verificato sulla documentazione del motore e non dedotto.** `DirectoriesToAlwaysCook` accetta **directory, mai singoli asset** — *«the documentation doesn't indicate support for specifying individual asset paths»* — quindi «elencarli per nome» non è esprimibile lì; e l'Asset Manager governa i **Primary Asset**, mentre una `UAnimSequence` è secondaria e *«entra nel cook solo se referenziata»*. ∴ il **set minimo esplicito** che `D-262` ordina ha una sola forma: il **riferimento duro da un asset versionato** sotto `/Game/RT`, che `+DirectoriesToAlwaysCook=(Path="/Game/RT")` cuoce e che trascina con sé ciò che nomina. ✅ **E il costo che questa istruttoria temeva è già pagato, misurato lo stesso giorno**: i quattro `BP_Unit_*` versionati referenziano **duro** una mesh Paragon ciascuno (`.../Meshes/Gadget`, `Phase_GDC`, `Riktor`, `Wraith`) e **zero** animazioni. Chi clona senza i pack ha già quattro asset con riferimenti non risolti, e per la famiglia **sorella** degli stessi file: aggiungere le clip accanto alla mesh non introduce una classe di rischio nuova. **Decisione d'autore del 2026-09-03**: il meccanismo è il riferimento duro dai `BP_Unit_*`. Il gate che lo presidia è `RefactorTactics.Packaging.RequiredAnimationClipsAreCooked`, che deriva il set dal CDO di `URTUnitAnimInstance` e quindi cresce da sé a venti. Referto: [`../roadmap/plans/1663-1665-cook-e-premessa-spec-panel-2026-09-03.md`](roadmap/plans/1663-1665-cook-e-premessa-spec-panel-2026-09-03.md) |
| ~~`COOK-2`~~ | ~~**Se le clip NON entrano, il DoD dichiara che il vertical slice consegna unità immobili?**~~ | ✅ **NO — UNA BUILD CHE RIPIEGA SULLA POSA DI RIFERIMENTO NON E DONE — chiusa il 2026-08-30 da [`D-262`](decisions/RT_PDR_00_Decision_Log.md), che sincronizza la decisione d'autore `AUTHOR-COOK-001`.** *Istruttoria conservata:* È la seconda metà della forcella, e tocca `G13`: una build che avvia e mostra quattro eroi in posa di riferimento soddisfa «partita giocabile senza editor» **alla lettera, non nella cosa** — la stessa distinzione che il DoD fa già per `MapSource=GeneratedTestArena`. Se la scelta è «non si cuociono», va scritta come **riserva dichiarata** del gate, non lasciata come difetto aperto |
...
stesso innesco, la seduta **U25**.

> 🔴 **`GBX-1` e `GBX-5` restano APERTE, e il 2026-08-30 è stato deciso soltanto il loro METODO**
> ([`D-283`](decisions/RT_PDR_00_Decision_Log.md), che sincronizza `AUTHOR-GRAYBOX-001`). La decisione
> d'autore risponde alla domanda *«quando e come si decidono»* — si osservano **insieme**, in vista dall'alto
> e isometrica, a scala di board canonica con unità, cella, copertura e porta, nella seduta
> **`U25` / `PIE-GBX-FIT`**, e i numeri si registrano **dopo** aver guardato. ⛔ **E vieta la scorciatoia**:
> non si canonizzano i due valori a partire da clearance, geometria di gioco o altre costanti tecniche — un
> numero preso in prestito da un altro sistema sembra derivato e non lo è. Il Safe Placement Volume resta
> guida di **authoring/presentazione** e non diventa clearance di gioco per implicazione. **Le due tarature
> numeriche non sono decise, e questa riga esiste perché non vengano lette come tali.** Le altre tre — la lacuna di grammatica su `Locked` (`GBX-2`), le soglie
...
| `GBX-5` | Quanto deve essere grande l'**unità** rispetto alla cella — e i `1,20 m` di oggi sono uno **stato** o un **target**? | 🆕 **Aperta** il 2026-08-17 da [D-158](decisions/RT_PDR_00_Decision_Log.md): tre documenti dello stesso bundle danno tre valori per la stessa misura, e la domanda è se i `1,20 m` di oggi siano uno **stato** o un **target**. ⏳ **Innesco: `U25`**, insieme a `GBX-1` — il metodo è deciso ([D-283](decisions/RT_PDR_00_Decision_Log.md)), i numeri no. ⛔ **E non si chiude cambiando `BaseMeshScale` e basta**: quel valore ha consumatori in `RTUnit.{h,cpp}`, e **nessun test lo protegge** — portarlo a `(0.6, 0.6, 1.8)` lascia tutta la suite verde, che il corpo chiama *«il vero rischio»*. 📄 **Istruttoria**: [`decisions/open/gbx-5.md`](decisions/open/gbx-5.md) |
...
| ~~`AE-3`~~ | ~~I **fatti del percorso** (celle percorse, dislivello, superfici attraversate) modificano l'azione, oltre al profilo?~~ | ✅ **SOLO SE L'AZIONE DICHIARA LA DIPENDENZA — NESSUN MODIFICATORE IMPLICITO DI PATH HISTORY — chiusa il 2026-08-30 da [`D-266`](decisions/RT_PDR_00_Decision_Log.md), che sincronizza la decisione d'autore `AUTHOR-ACTION-001`.** *Istruttoria conservata:* Va decisa **separatamente** da `AE-2`, e la ragione è di determinismo: il profilo è noto in Planning e si previsualizza esatto, i fatti del percorso sono noti solo dopo la risoluzione — e un Move può essere troncato, contestato o annullato ([D-045](decisions/RT_PDR_00_Decision_Log.md)). Una preview che promette «+1 spinta perché avrai percorso 4 celle» promette ciò che il turno può smentire. Fuori dallo scope di E38 |
| ~~`AE-4`~~ | ~~Qual è il **contratto della risorsa firma**: nome player-facing, costo per azione, e quale dei tre valori vive?~~ | ✅ **NESSUNA RISORSA FIRMA UNIVERSALE — L'ECONOMIA E SLOT, COOLDOWN E DRAWBACK — chiusa il 2026-08-30 da [`D-265`](decisions/RT_PDR_00_Decision_Log.md), che sincronizza la decisione d'autore `AUTHOR-ECON-001`.** *Istruttoria conservata:* Metà è **già decisa** e il kit non lo sapeva: la risorsa è **per personaggio** (Flux `Carica Conduttiva` · Riva `Riserva Idrica` · Bastion `Integrità Strutturale` · Vektor `Slancio`), cap **4**, ricarica **1** sul trigger d'affinità. ⚠️ Ciò che non è deciso è più concreto: `ARTUnit` dichiara `MaxEnergy = 100`, `EnergyPerTurn = 25`, `EnergyOnHit = 15` — parametri dell'MVP quadrato mai rivisti — e il **costo** in risorsa non è un campo del catalogo azioni (`EnergyCost` sta su `URTActionData`, il data asset legacy, non su `FRTActionDef`). Quindi un'azione del catalogo v0.1 **non sa dichiarare quanto costa** | <!-- rename-exempt: la riga dichiara la rinomina: sostituirla la renderebbe muta -->
| ~~`AE-5`~~ | ~~Con quali numeri esiste il profilo **`Sneak`**?~~ | ✅ **BUDGET ×0,5 · CADENZA 1 PASSO OGNI 2 TICK · SEMPRE SILENZIOSO — chiusa il 2026-09-13 da [`D-412`](decisions/RT_PDR_00_Decision_Log.md)**, che sincronizza `AUTHOR-MOVEMENT-001`. La domanda chiedeva **tre** cose — costo, portata e rumore — e la sorgente risponde a tutte e tre. 🔑 **Il rumore è risposto senza un numero, ed è una risposta completa**: *«sempre silenzioso, indipendentemente dal terreno»*. Un raggio serve a chi il rumore lo produce; `Sneak` non ne produce. ∴ `FRTMovementProfile::bPlannable` può diventare `true` (`Source/RefactorTactics/Ability/RTMovementProfileLibrary.cpp:65-69`), che era l'unica ragione per cui il profilo stava nel catalogo senza essere scegliibile. ⚠️ **Con una dipendenza dichiarata**: il budget è un **moltiplicatore**, e il moltiplicatore ha bisogno di una base — la scala PM che `D-412` punto (3) adotta come **taratura di prototipo**, non come calibrazione d'autore. *Istruttoria conservata:* Costo, portata e rumore non erano definiti **da nessuna fonte corrente**: il catalogo lo dichiarava apertamente e non si inventavano. Era l'unico dei quattro profili senza budget, quindi non pianificabile. Gemella di `AE-8`, che poneva la stessa domanda sul rumore delle azioni generiche e si è chiusa prima, con la risposta opposta — là *«nessun valore fisso»*, qui *«nessun rumore»* |
| ~~`AE-6`~~ | ~~`Wait` restituisce risorsa firma?~~ | ✅ **CHIUSA PER ASSORBIMENTO il 2026-09-04 da [`D-329`](decisions/RT_PDR_00_Decision_Log.md): la domanda non ha più soggetto.** [`D-265`](decisions/RT_PDR_00_Decision_Log.md) ha tolto la risorsa firma universale e [`D-324`](decisions/RT_PDR_00_Decision_Log.md) toglie `Energy` dal gameplay: in v0.1 non resta nessuna risorsa che `Wait` possa restituire. ✅ **Ciò che la voce conteneva di vero resta vero**: `Wait` non concede nulla di gratuito, e `Actions.Wait.AllowsFacingAndReaction` lo pinna verificando che **conservi** ciò che aveva. ⚠️ **Condizione di rinascita**: il primo kit che adotti una risorsa propria deve rispondere «questa risorsa si ricarica con `Wait`?» nel proprio contratto, invece di ereditare un default. *Istruttoria conservata:* Il kit chiede di **non** concederlo di default, e il canone concorda: `Wait` non dà armatura, precisione, furtività né reazione gratis (`Actions.Wait.AllowsFacingAndReaction` verifica che conservi ciò che aveva, non che guadagni). Ma la ricarica «sul trigger d'affinità» non dice cosa succede a chi non innesca nulla per tre turni, e con cap 4 la differenza è grande |
...
|---|---|---|
| ~~`FAC-1`~~ | **Accettata**, e **a runtime dal 2026-09-03** ([#1605](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1605)): la rotazione è una **capacità del personaggio** in step (0–3). Otto numeri nuovi (2 × 4 eroi), valori iniziali da §23.1 dell'handoff, tuttora dichiarati **non** bilanciati — portarli a runtime non li ha tarati | [ADR-0008](decisions/adr-0008-rotazione-e-policy-di-facing.md) §1 — supera ADR-0005 §1 |
| ~~`FAC-2`~~ | **Accettata**: policy dichiarative per azione ed effetto, **con default** che riproducono D-020 e ADR-0005 §3 — un'azione che non dichiara nulla si comporta come oggi. ⛔ **E dal 2026-09-03 accettata e NON costruita**, per [`D-318`](decisions/RT_PDR_00_Decision_Log.md): la §Revisione dell'ADR fissava la rilettura alla chiusura di `CP 14.3` — chiusa dal 2026-08-12 — e le tre misure che la condizione chiedeva danno tutte lo stesso esito, compresa la risposta d'autore su `FAC-16` (*«al momento no»*, 2026-09-01). La decisione resta, l'implementazione si sospende, e la via di rientro è quella già scritta in `FAC-16` | [ADR-0008](decisions/adr-0008-rotazione-e-policy-di-facing.md) §3 — supera ADR-0005 §3 |
| ~~`FAC-4`~~ | **Decisa**, e **a runtime dal 2026-09-03** ([#2131](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2131)): il facing al boundary `k` è la direzione dell'**ultimo passo compiuto**, cioè `FacingFromPath` sul prefisso del percorso — `URTFacingLibrary::FacingAtMicroStep`. Il pivot finale si applica dopo e **non** retroattivamente. I tre consumatori del boundary che ora lo leggono: gli osservatori di `TeamAwareness`, la copertura del colpo di Overwatch e la voce direzionale `HitCameFromSide` | [ADR-0008](decisions/adr-0008-rotazione-e-policy-di-facing.md) §2 |
...
|---|---|---|
| ~~`FAC-3`~~ | ~~`Brace` deve diventare **direzionale**?~~ | **✅ Chiusa il 2026-09-10 da [D-365](decisions/RT_PDR_00_Decision_Log.md): `Brace` NON diventa direzionale.** `Brace`, `Guard` e `Shield` proteggono la **persona**, non un lato. 🔑 **È una conferma, non un cambio**: [ADR-0005](decisions/adr-0005-orientamento.md) §4a resta in vigore parola per parola, `Combat.ShieldWorksFromAnyDirection` continua a proteggerla dalla deriva, e **nessun test cambia esito**. ⚠️ La sede che `FAC-2` avrebbe offerto — una policy di facing dichiarata su `Brace` — resta disponibile e **non viene usata**: abbassava il costo, non cambiava il merito, e il merito è quello che ha deciso. 🔎 **Istruttoria conservata**: ADR-0005 §4a dice il contrario in modo esplicito: `Deflect`, `Brace`, `Shield` proteggono la **persona**, non un lato. Cambiarlo è una modifica di §4a, e il test `Combat.ShieldWorksFromAnyDirection` (CP 16.2) esiste per impedire che accada per deriva. ⚠️ **Dal 2026-08-10**: con `FAC-2` accettata, `FAC-3` avrebbe una sede naturale in cui esprimersi — una policy di facing dichiarata su `Brace` — il che ne abbassa il **costo**, non ne cambia il **merito** |
...
| ID | Domanda | Perché serve una risposta |
|---|---|---|
| ~~`FAC-5`~~ | ~~Una **reazione** può ruotare l'unità che reagisce?~~ | **✅ Chiusa il 2026-09-10 da [D-365](decisions/RT_PDR_00_Decision_Log.md): una reazione NON ruota chi reagisce.** Il default è `KeepFacing`; una reazione futura potrà ruotare **solo** dichiarando una policy esplicita. 🔑 **Conferma lo stato che la domanda descriveva**: `FacingUsedByOverwatch` resta un valore **letto**, mai scritto, quindi non nasce la regola nuova che la voce temeva e i consumatori successivi non ereditano nulla a metà round. ⚠️ **Il Reaction Clash (#314) non si sblocca da qui**: le sue maneuver `Pivot Step` e `Sidestep` presupponevano un sì, e con un no restano da riprogettare o da dichiarare come rotazione **esplicita** dell'abilità — non implicita della reazione. 🔎 **Istruttoria conservata**: D-020 nomina `FacingUsedByOverwatch` come valore **letto**, mai scritto. Se una Return Fire ruota verso l'attaccante, il facing cambia a metà round e i consumatori successivi lo ereditano: è una regola nuova, non una precisazione. ⚠️ **Dal 2026-08-10**: ADR-0008 §2 stabilisce che il pivot finale **non è retroattivo**, quindi una rotazione da reazione non riscriverebbe i boundary già passati — il che circoscrive il danno, ma non risponde alla domanda |
| ~~`FAC-6`~~ | ~~`Interact` **richiede** un facing verso l'oggetto, oppure lo **impone**?~~ | **✅ Chiusa il 2026-09-10 da [D-365](decisions/RT_PDR_00_Decision_Log.md): `Interact` IMPONE l'orientamento.** Orienta l'unità verso l'oggetto o il bordo immediatamente **prima** della risoluzione: non chiede un secondo input, **non consuma** il budget del pivot finale, e **registra** la rotazione. Se non esiste una direzione determinabile, il facing resta. 🔴 **È l'unica delle nove che prescrive lavoro nuovo**: le altre otto confermano il canone, questa aggiunge una rotazione automatica e la sua voce nel log. Il consumatore concreto è già quello che la voce nominava — [`gameplay/spec-interazioni-mappa-cp101.md`](gameplay/spec-interazioni-mappa-cp101.md) §12, dove *«girarsi verso la porta»* smette di essere ipotetico. 🔎 **Istruttoria conservata**: `Interact` è universale ([D-025](decisions/RT_PDR_00_Decision_Log.md)) e assorbe `Activate`: la risposta tocca porte, console e valvole di E9, non un solo dispositivo. ⏳ **Dal 2026-08-09 ha un consumatore concreto**: [`gameplay/spec-interazioni-mappa-cp101.md`](gameplay/spec-interazioni-mappa-cp101.md) §12, dove «girarsi verso la porta» smette di essere ipotetico — la domanda resta qui, l'owner resta [ADR-0005](decisions/adr-0005-orientamento.md) |
| ~~`FAC-7`~~ | ~~Quali **status** limitano la rotazione, separatamente dal movimento?~~ | **✅ Chiusa il 2026-09-10 da [D-365](decisions/RT_PDR_00_Decision_Log.md): nessuno status della v0.1 limita il facing.** `Status.Root` impedisce il **movimento** e **consente** la rotazione; un futuro status potrà bloccarla **solo** dichiarandolo. 🔑 **La distinzione che la voce chiedeva viene fatta, e cade dalla parte del permesso**: «non può muoversi» e «non può girarsi» sono due cose diverse, e nella v0.1 nessuno status dice la seconda. 🔎 **Istruttoria conservata**: Oggi nessuno: `Status.Root` interagisce con `Guard`, non col facing. Distinguere «non può muoversi» da «non può girarsi» è una scelta di design, non un dettaglio implementativo |
| ~~`FAC-8`~~ | ~~Il **terreno** può limitare la rotazione (ghiaccio, condotti, scale)?~~ | **✅ Chiusa il 2026-09-10 da [D-365](decisions/RT_PDR_00_Decision_Log.md) PER LA v0.1: nessun terreno limita il pivot.** ⚠️ **Chiusa per la release, non per sempre**: la domanda può tornare in una successiva senza che questa voce vada riaperta. La ragione per cui era registrata resta valida — il ghiaccio esiste già in E8 e in `Visual/Environment/IceSlide`, e la risposta è ora scritta **qui** invece che localmente in una spec di terreno. 🔎 **Istruttoria conservata**: Fuori v0.1 — ma il ghiaccio esiste già in E8 e in `Visual/Environment/IceSlide`, quindi la domanda va registrata prima che qualcuno la risolva localmente in una spec di terreno |
| ~~`FAC-9`~~ | ~~Il pathfinding deve diventare **orientation-aware** — stato `(CellId, Facing)` invece di `CellId`?~~ | **✅ Chiusa il 2026-09-10 da [D-365](decisions/RT_PDR_00_Decision_Log.md) PER LA v0.1: il pathfinding resta su `CellId`.** Non diventa `(CellId, Facing)`; il facing ottenibile lo mostra la **preview**. 🔑 **La pressione che la voce registrava riceve la risposta che chiedeva**: con `FAC-1` accettata la cella d'arrivo vale diversamente a seconda del lato, e il modo di dirlo al giocatore è **mostrarglielo** — il selettore a sei triangoli di [D-367](decisions/RT_PDR_00_Decision_Log.md) è esattamente quella preview, e la costruisce [#291](https://github.com/DegrassiAaron/refactor-tactics-main/issues/291). ⚠️ **Chiusa per la release**: moltiplicare per sei lo spazio degli stati di A\* resta fuori finché non c'è una misura contro i budget di [`technical/spec-pathfinding.md`](technical/architecture/spec-pathfinding.md). 🔎 **Istruttoria conservata**: Fuori v0.1, e va tenuto fuori finché non c'è una misura: moltiplica per sei lo spazio degli stati di A\*, contro i budget già dichiarati in [`technical/spec-pathfinding.md`](technical/architecture/spec-pathfinding.md). Il ripiego dichiarato dall'handoff — path geometrico, facing derivato, pivot validato alla fine — **è** già il modello di ADR-0005. ⚠️ **Dal 2026-08-10 la pressione aumenta**: con `FAC-1` accettata la cella d'arrivo vale diversamente a seconda del lato da cui la si raggiunge, quindi la **preview** deve mostrare il facing ottenibile. Resta fuori v0.1, ma non più «senza motivo» |

> 🔄 **Aggiornato il 2026-09-10 — le cinque lacune di questa tabella sono chiuse insieme da [D-365](decisions/RT_PDR_00_Decision_Log.md)**, decisione d'autore registrata da [#339](https://github.com/DegrassiAaron/refactor-tactics-main/issues/339). Quattro su cinque — `FAC-5`, `FAC-7`, `FAC-8`, `FAC-9` — **confermano** ciò che il canone già faceva, quindi nessun test cambia esito e nessun corpus va rigenerato. La quinta, **`FAC-6`**, prescrive lavoro nuovo: `Interact` orienta **prima** di risolvere e lo registra.

> ⚠️ **`FAC-8` e `FAC-9` sono chiuse PER LA v0.1**, non per sempre. La distinzione è quella che queste due voci portavano già addosso — *«fuori v0.1»* — e ciò che cambia è che adesso qualcuno l'ha **decisa** invece di rinviarla: la domanda può tornare in una release successiva senza riaprire questa voce.
...
> 🔁 **Aggiornato il 2026-09-01 — ne restano tre: `FAC-16` è stata aperta e chiusa in giornata.** Veniva dal
> kit d'autore *Cover · Melee · AoE · Facing v0.1*
> ([referto](roadmap/plans/cover-melee-aoe-facing-consolidamento-spec-panel-2026-09-01.md) §5.1) e stava in
> questa sezione **per collocazione, non per natura**: le altre tre sono buchi del canone, quella era un
> **default già deciso** che il kit proponeva di invertire senza citarlo.
>
> ✅ **Chiusa dalla risposta dell'autore — «al momento no»**, cioè nessun caso di gioco in cui girarsi verso
> la sorgente sbagli. Il che **conferma** ciò che [`ADR-0008`](decisions/adr-0008-rotazione-e-policy-di-facing.md)
> §3 aveva già registrato — *«nessuno è stato prodotto»* — invece di cambiarlo. 🔑 **E non preclude niente**:
> se un caso emerge si dichiara `Keep` su quell'effetto, dentro `ERTDisplacementFacingPolicy`, senza toccare
> il default né i tre test e senza una decisione nuova. È esattamente ciò per cui quella policy è stata
> adottata: *«per avere dove scriverlo quando esisterà»*.
...
| ~~`FAC-12`~~ | ~~Il pivot **si paga** in punti movimento, o resta solo un **tetto**?~~ | **✅ Chiusa il 2026-09-10 da [D-365](decisions/RT_PDR_00_Decision_Log.md): il pivot finale è GRATUITO e il budget resta un TETTO.** Non costa MP, non occupa slot. ⛔ **La proposta della fonte §10 è respinta** — *«Move 2 celle + Pivot 60° = 3 MP»* — e con essa l'argomento del secondo kit: la scelta *«viaggio più lontano o arrivo orientato bene?»* **non** si vuole, perché farebbe pagare 3 MP anche a chi ruota da fermo, che oggi è libero e universale. Conferma [ADR-0008](decisions/adr-0008-rotazione-e-policy-di-facing.md) §1. 🔴 **La revisione dei numeri resta dovuta e non è questa**: il trigger dell'ADR era la chiusura di `CP 16.2` ([#177](https://github.com/DegrassiAaron/refactor-tactics-main/issues/177)), che è **chiusa dal 2026-08-09 senza che il playtest sia avvenuto**. I valori per eroe restano canonici **come punto di partenza** e dichiaratamente **non bilanciati**; la misura ha ora un owner. 🔎 **Istruttoria conservata**: ADR-0008 §1 misura la rotazione in step e la tratta come un tetto (`MoveEndPivotMaxSteps`): ruotare fin dove è consentito è **gratis**. La fonte §10 propone un prezzo — `Move 2 celle + Pivot 60° = 3 MP` — che mette *quanto mi muovo* contro *quanto ruoto*, e farebbe pagare 3 MP anche a chi ruota da fermo (oggi libero e universale). Sono due assi di scelta diversi, non due formulazioni. Da guardare alla **prima revisione dei numeri di ADR-0008**, cioè alla chiusura di CP 16.2. 🔄 **Riproposta il 2026-08-12** dal kit dell'action economy (§15), che la presenta come «*latest explicit direction*» senza sapere di ADR-0008. Non cambia la risposta e **non cambia la data della revisione**: cambia il peso della domanda, perché due sorgenti indipendenti hanno chiesto la stessa cosa a due giorni di distanza. Il secondo aggiunge un argomento che il primo non aveva — *«viaggio più lontano o arrivo orientato bene?»* è la scelta che il **tetto** non produce, perché un tetto non si spende |
| ~~`FAC-13`~~ | ~~Da dove «arriva» un colpo che **non ha una sorgente puntuale**?~~ | **✅ Chiusa il 2026-09-10 da [D-365](decisions/RT_PDR_00_Decision_Log.md): la policy ha quattro valori e il quarto è `NonDirectional`.** Attacco diretto → cella dell'attaccante; traiettoria o proiettile → **ultimo segmento**; area o esplosione → **centro d'impatto**; effetto ambientale diffuso → **non direzionale**. 🔑 **Un effetto non direzionale non attiva né aggira una regola basata sul lato**: è la metà che mancava, e senza di essa «nessuna direzione» avrebbe potuto leggersi come «direzione qualunque» — cioè come un bypass gratuito della copertura. Completa i tre quarti già chiusi da [D-302](decisions/RT_PDR_00_Decision_Log.md) e implementati con [#2048](https://github.com/DegrassiAaron/refactor-tactics-main/pull/2048). ⚠️ **Il diagramma F3 disegnava tre di questi quattro valori prima che fossero canone**: da oggi lo sono, ma il diagramma resta un artefatto di design e **non** diventa normativo per averli indovinati. 🔎 **Istruttoria conservata**: Oggi la direzione d'impatto è implicitamente la cella dell'attaccante (`IsInFrontalArc(…, OriginCell)`), e non c'è risposta per proiettile con traiettoria, esplosione con centro d'area o terreno che brucia — `grep` di `ImpactDirection`/`FromTrajectory` in `Source/` dà **zero**. La fonte propone una policy esplicita (`FromSource`, `FromTrajectory`, `FromImpactCenter`, `NonDirectional`). **Non è un difetto attivo**: il danno ambientale non passa da `Plan.Hits` e un'area azzera già la copertura per costruzione. Diventa un caso da correggere quando **E8/E9** daranno una direzione agli effetti d'area |
| ~~`FAC-14`~~ | ~~La **rotazione forzata** è un effetto di controllo a catalogo?~~ | **✅ Chiusa il 2026-09-10 da [D-365](decisions/RT_PDR_00_Decision_Log.md) PER LA v0.1: nessuna primitiva di rotazione forzata senza un'abilità concreta che la chieda.** Se il caso emergerà si userà un effetto **esplicito** `Rotate`/`SetFacing`; non si apre oggi una voce di `ERTActionEffect` che nessuno consuma. 🔑 **Il legame con `FAC-3` si scioglie invece di stringersi**: l'argomento era *«se una difesa diventasse direzionale, girare un avversario sarebbe l'unico modo di aggirarla senza spostarlo»* — e `FAC-3` chiude **no**, quindi la premessa cade e il modello non resta sbilanciato in nessuno dei due versi. 🔎 **Istruttoria conservata**: `ERTActionEffect` ha `Damage · Heal · Shield · Push · Pull · Status · DamageReduction · DamageStructure`: **nessuna rotazione**. Girare un avversario è geometricamente equivalente a spostarlo — apre un lato — e `Push`/`Pull` esistono già. ⚠️ Si tiene con `FAC-3` e `FAC-11`: se una difesa diventasse direzionale, la rotazione forzata sarebbe **l'unico modo di aggirarla senza spostare nessuno**, quindi decidere l'una senza l'altra lascia il modello sbilanciato in un verso o nell'altro |
| ~~`FAC-16`~~ | ~~Il **forced movement** ruota il bersaglio verso la sorgente, o mantiene il facing?~~ | **✅ Chiusa il 2026-09-01: il default RESTA `FaceSource` per `Forced` e `Keep` per `Environmental`.** La domanda non era «quale default» — quello è deciso da [`ADR-0008`](decisions/adr-0008-rotazione-e-policy-di-facing.md) §3 — ma *«esiste un caso di gioco in cui girarsi verso la sorgente produce un esito sbagliato?»*. **Risposta dell'autore, 2026-09-01: al momento no.** ⚠️ **«Al momento» non è «mai», ed è la ragione per cui questa chiusura non costa nulla**: `ADR-0008` §3 aveva già registrato che *«il costo si paga se esiste un caso reale che la regola universale sbaglia: nessuno è stato prodotto»*, e adottava la policy dichiarativa *«per avere dove scriverlo quando esisterà»*. La risposta **conferma quello stato** invece di cambiarlo. 🔑 **Come si riapre, senza riaprire questa voce**: se un caso emerge, si dichiara `Keep` **su quell'effetto** — non si tocca il default, non si toccano i tre test (`Facing.ForcedMovementFacesSource`, `…EnvironmentalDisplacementKeepsFacing`, `…VoluntaryMoveWinsOverForced`), non serve una decisione nuova. La sede è `ERTDisplacementFacingPolicy`, **accettata e non implementata** ([#1605](https://github.com/DegrassiAaron/refactor-tactics-main/issues/1605)); implementarla non cambia nessun esito, per costruzione. ⛔ **Il kit §10/§26 resta respinto**: proponeva di invertire il default **e** di collassare `Forced` ed `Environmental` in un caso solo, senza nominare `ADR-0008` né `ERTDisplacementCause` e senza portare il caso che avrebbe giustificato il cambio. 🔎 **Istruttoria**: [commento su #339](https://github.com/DegrassiAaron/refactor-tactics-main/issues/339#issuecomment-5490795607) |
| ~~`FAC-15`~~ | ~~La relazione a **sei direzioni relative** dev'essere **equipartita** o **speculare**?~~ | **✅ Chiusa il 2026-08-16 da [D-147](decisions/RT_PDR_00_Decision_Log.md), il giorno stesso in cui era stata aperta**: la simmetria destra/sinistra **non è un requisito**, quindi il dilemma non esisteva. ⚠️ **L'impossibilità che la voce dimostrava resta vera** — equivarianza per rotazione, simmetria speculare e partizione in sei classi non coesistono su un anello di raggio **pari**, e ai raggi dispari invece sì: l'ostruzione è di parità. Ma la voce *presupponeva* che la simmetria fosse voluta senza mai stabilirlo, e `IsInFrontalArc` ce l'ha perché è un **predicato booleano**, non perché qualcuno l'abbia scelta. ∴ l'equipartizione resta e la regola a settore semiaperto di [#726](https://github.com/DegrassiAaron/refactor-tactics-main/issues/726) **si sblocca**. 🔴 **Lo skew resta e va dichiarato**: `Front` è il raggio dritto davanti più **uno solo** dei due spicchi adiacenti, e **168 celle su 216** non ricevono la direzione speculare della propria immagine speculare — un `Shield = {Front}` proteggerebbe un fianco e non l'altro. Chi dichiara il primo insieme di lati lo sa **prima** di sceglierlo. 📐 **L'istruttoria misurata, tenuta qui perché non sopravviva solo in una nota di batch**: la regola è equipartita — **36** celle per lato a raggio `1..8`, esattamente `r` per anello, verificato `r = 1..8`; e la via d'uscita ovvia non esiste, perché **0** sottoinsiemi propri su **62** producono una regione speculare (vale per **entrambe** le regole, quindi non discrimina fra loro). 🔴 **Una regola migliore è misurata e non adottata**: lo spicchio **centrato** è altrettanto equipartito (`r` per anello) e confina l'asimmetria a **24** celle su 216 — i soli punti medi, `6` per anello pari, `0` ai dispari, cioè il **minimo possibile**. Non serve a una proprietà non richiesta; servirà se peserà la **fedeltà dei nomi** (un `TurnLog` che dice `Front` per una cella di lato è explainability di **E16**). Le due regole classificano diversamente **96 celle su 216**. ⚠️ Il verso dello skew **non è deciso**: `ERTRelativeDirection` non esiste in `Source/`, e gli indici e i nomi di `D-126` si contraddicono sulla mano. Si fissa quando la relazione entra in codice, in #726. ✅ **Fissata il 2026-09-02**: la relazione è entrata in codice e si è scelta la **fedeltà geometrica** — `rel 1 = FrontLeft`, `rel 5 = FrontRight`, cioè i nomi di `D-126` percorsi in senso inverso, perché `AxialToWorld` manda l'indice `f+1` a `−Y` e la convenzione UE lo legge a sinistra. Owner: [ADR-0005](decisions/adr-0005-orientamento.md) §4-ter |

> 🔄 **Aggiornato il 2026-09-10 — `FAC-12`, `FAC-13` e `FAC-14` sono chiuse da [D-365](decisions/RT_PDR_00_Decision_Log.md)**, e con esse **nessuna `FAC-*` resta aperta** in questo file: le nove che restavano — `FAC-3`, `FAC-5`…`FAC-9`, `FAC-12`…`FAC-14` — sono barrate qui sopra e nelle due tabelle precedenti.

> 🔑 **Nessuna delle tre è stata decisa dal proprio trigger, e due lo dichiarano.** `FAC-12` aspettava *«la prima revisione dei numeri di ADR-0008»*, cioè la chiusura di `CP 16.2`: quella chiusura è **avvenuta il 2026-08-09 senza playtest**, quindi il trigger è scaduto a vuoto e la decisione arriva per altra via — il **modello** si chiude (tetto, non prezzo), i **numeri** no. `FAC-13` aspettava che E8/E9 dessero una direzione agli effetti d'area: la policy si chiude **prima**, ed è deliberato, perché il valore che mancava (`NonDirectional`) è quello che impedisce a un effetto senza sorgente di leggersi come bypass. `FAC-14` aspettava un caso reale: **non è arrivato**, e la chiusura dice esattamente questo invece di inventarlo.

> ⚠️ **Le note di stato datate qui sopra restano com'erano scritte.** *«Ne restano tre»* del 2026-08-13, del 2026-08-16 e del 2026-09-01 erano vere il giorno in cui sono state scritte e sono il record dell'istruttoria: si leggono con la loro data, non come stato corrente.
...
| `INT-9` | Il comando **esplicito** `SetDoorState(..., Destroyed)` resta di **gruppo** o diventa **per voce**? | Aperta il 2026-09-10 da [`D-375`](decisions/RT_PDR_00_Decision_Log.md), che rende la distruzione da **danno** per segmento e non tocca il comando. Oggi `CommutateEdge` (interna a `RTHexDoorLibrary.cpp`) non ha eccezioni per `Destroyed`, quindi esisterebbero **due vie** allo stesso stato terminale con esiti diversi — e chi implementa sceglierebbe per primo. ⚠️ **Le due opzioni NON sono simmetriche, e chi decide deve saperlo**: la spec dice *«se un bordo del gruppo viene distrutto, gli altri restano»*, che il ramo **di gruppo falsifica** — propagando sul `DoorId` distruggerebbe anche gli altri. L'evidenza pende quindi verso il **per voce**; resta aperta perché il comando esplicito ha oggi il comportamento opposto e cambiarlo è una scelta, non una correzione. |
| `INT-10` | Cosa **riporta** un `Interact` che incontra un segmento già `Destroyed` dentro un portone? | Aperta il 2026-09-10 da [`D-375`](decisions/RT_PDR_00_Decision_Log.md). `RTHexDoorLibrary` risolve *«nessun cambiamento»* confrontando lo stato corrente col richiesto, e `Destroyed` soddisfa `Open` ma **non** `Closed`: un `Interact` che chiude un portone col segmento sfondato lo riporterebbe **rifiutato**. È il falso rifiuto che quel blocco esiste per evitare, e la scelta — ignorare il segmento, o riportarlo come esito distinto — è di prodotto. |
...
| `BAL-1` | `Guard` e `Brace` devono separarsi in **danno contro spinta**? | 🔄 **Riaperta** il 2026-08-27 da [D-205](decisions/RT_PDR_00_Decision_Log.md), che scambia i mestieri delle due difese: la mitigazione sostenuta passa alla `Guard`, il `Brace` smette di radicare. 🔴 **E riformulata alla radice lo stesso giorno** da [D-208](decisions/RT_PDR_00_Decision_Log.md): con `BAL-2`, `BAL-4` e `BAL-5` ormai chiuse — rispettivamente da [D-206](decisions/RT_PDR_00_Decision_Log.md), [D-207](decisions/RT_PDR_00_Decision_Log.md) e D-208 — le due difese hanno **lo stesso prezzo**, quindi la domanda non è più con quali magnitudini separarle ma *«la differenza di GENERE è leggibile senza un costo che la annunci?»* — una domanda per la seduta, non per un documento. ⚠️ **Ciò che chi la prende rischia di non sapere**: va tenuta separata da `ECO-1` (*quanto costano*), perché se costo ed effetto cambiassero insieme il playtest non saprebbe quale dei due sta misurando. ⏳ **Innesco**: la seduta editor `U20` (voce `PIE-BAL1`), che non cade ma si ripunta — decisione su [#403](https://github.com/DegrassiAaron/refactor-tactics-main/issues/403). 🔴 **L'evidenza citata si è rovesciata il 2026-09-20** da [D-408](decisions/RT_PDR_00_Decision_Log.md): `Guard` e `Brace` sono ora **entrambe** riduzioni per colpo (15 contro 10), quindi sull'arco frontale la `Guard` domina sempre e `Spec.Brace.BraceWinsOnSecondHit` — verde — asserisce l'opposto del proprio nome. A separarle resta la **direzione**: `Guard` frontale ([D-206](decisions/RT_PDR_00_Decision_Log.md)), `Brace` omnidirezionale. ⚠️ Nessuno scenario esercita oggi quel caso. 📄 **Istruttoria**: [`decisions/open/bal-1.md`](decisions/open/bal-1.md) |
...
| ~~`BAL-6`~~ | ~~**La caduta gravitazionale infligge danno?** E se sì: scala col dislivello, e chi sta sotto subisce un impatto?~~ | ✅ **5 DANNI PIATTI PIU' `Status.Exposed` A CHI CADE, 5 SENZA `Exposed` ALL'OCCUPANTE, NESSUNA SCALA — chiusa il 2026-09-09 da [`D-357`](decisions/RT_PDR_00_Decision_Log.md).** Il danno e' minimo perche' il prezzo e' gia' pagato dalla posizione e dalla rarita' della condizione: `Action.Push` ha range 1, spinta 1 e nessun danno proprio, quindi il bersaglio deve essere **gia'** sul ciglio. La minaccia viene da `Exposed` — *«chi ti butta giu' ti prepara per il colpo dopo»* — su un asse diverso da quello gia' punito: `Slow` e' stato scartato perche' rincarava la risalita, che era gia' sufficiente. L'asimmetria sull'occupante e' semantica: `Exposed` e' *«hai perso l'equilibrio»*, e chi stava fermo non l'ha perso. *Istruttoria conservata:* 🔴 **Blocca [#2430](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2430), che a sua volta blocca [#2406](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2406)** — la mutazione `2-effetti-saturo` del gate della caduta esce `NON APPLICABILE` perche' non c'e' niente da sopprimere, e il gate resta `BLOCKED` con cinque mutazioni su sei verdi. **Non si deduce**: [`spec-caduta-e-bordi.md`](gameplay/spec-caduta-e-bordi.md) §5 dichiara **che** gli effetti si applicano e **quando** — *«anche quando la cella finale non e' occupabile»* — e rimanda esplicitamente il **quanto** a `BAL-*`. `#2430` lo ribadisce: *«non si inventa un numero qui»*. 🔎 **Misurato il 2026-09-08**: `FallEffects`, `ImpactEffects` e `FallDamage` non hanno ne definizione ne uso in `Source/` — le sole occorrenze sono le note che lo dichiarano. ⚠️ **Il dislivello non e' `Layer - 1`**: `URTHexLedgeLibrary::FindLandingCell` scandisce la colonna e tiene il massimo, perche' *«la colonna puo' saltare dei piani»*. Una scala col dislivello va definita sui **piani attraversati**, non sulla differenza di indice. 🔑 **Due precedenti orientano senza decidere.** *(1)* [`RT_TerrainCatalog_v0.1.md`](balance/RT_TerrainCatalog_v0.1.md) § elevazione: *«nessun `+Damage` per il solo fatto di stare in alto»* — l'altezza non da' bonus **offensivo**; qui la domanda e' sul danno **subito**, che e' un altro asse, ma lo stesso principio chiede di non regalare numeri alla verticalita'. *(2)* `OccupantDamageBonus` esiste come parametro generico e *«ogni call site runtime passa 0»*: il repository sa gia' tenere un meccanismo **dormiente** invece di inventargli un valore — ed e' il precedente che `#2430` cita come `PushResistance`. **Uscite**: *(a)* **nessun danno in v0.1** — la caduta e' riposizionamento, gli effetti restano un meccanismo dormiente e `#2430` si chiude nominando il punto d'innesto senza numeri; *(b)* **danno piatto**, un valore unico indipendente dal dislivello, la forma piu' economica da tarare; *(c)* **danno scalato** sui piani attraversati, piu' l'impatto sull'occupante — la forma piena della spec, e la piu' costosa da bilanciare. ⚠️ **Le tre uscite non costano uguale a valle**: solo *(a)* lascia `Fall.SaturatedLandingAppliesFallEffects` non scrivibile — e allora va detto, perche' il gate di `#2406` continuera' a riportare quella mutazione come non applicabile **per scelta**, non per lacuna. **Innesco**: qualunque lavoro su `#2430`. Oggi e' l'unica cosa che separa il gate della caduta dal verde |
...
> ➕ **`STA-5` aggiunta il 2026-09-04** e **chiusa lo stesso giorno** da
> [D-319](decisions/RT_PDR_00_Decision_Log.md). Il numero in prosa qui sopra si è mosso **due volte nello
> stesso giorno** — due con `STA-3`/`STA-4`, tre con l'aggiunta, due di nuovo con la chiusura — e ogni volta
> nel commit che lo rendeva falso: questa sezione porta già la cicatrice di una volta in cui non lo si è
> fatto, dodici righe più in basso.
...
| ~~`STA-5`~~ | ~~`Unbalanced` e `Prone` si **anticipano** fuori dall'epic G.2, o restano dietro al motore del ghiaccio?~~ | ✅ **Chiusa il 2026-09-04 da [D-319](decisions/RT_PDR_00_Decision_Log.md)**: **si anticipano**. Lo scivolamento applica `Unbalanced` durata `2`; una spinta subita mentre si è sbilanciati applica `Prone` durata `2`, che `1 MP` rimuove in anticipo con `ARTUnit::RemoveStatus` — il pagamento compra il turno, non l'uscita. ⛔ **Il blocco resta, e vale in ogni uscita**: non si implementa prima di un valore proprio in `ERTMoveOutcome` per lo scivolamento, perché oggi chi scivola produce `Moved`, cioè *«raggiunta la destinazione pianificata»*, che è falso. La **Fase 1** — owner [#2253](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2253) — porta anche un termine mirato in `ScorePlan`; la **Fase 2**, il canale generico, resta dietro `STA-4`. Il perimetro residuo di G.2 è Traction e Stability per eroe, e `G.3 non parte senza il fuzzing` **resta vero** — CP 12.6 lega il fuzzing allo slide a catena. *Istruttoria conservata:* ~~Aggiunta il **2026-09-04**, e sta qui e non fra le `MOV-*` perché è la stessa domanda di `STA-3` su due stati diversi — *entrano ora, o restano nel framework?* — mentre `MOV-1`…`MOV-4` sono decisioni del **movement resolver**. ⚠️ **Tre sedi vive la collocano fuori, non due**: [`brief-ghiaccio.md`](gameplay/brief-ghiaccio.md) §5 (epic G.2), [`roadmap-v0.1.md`](roadmap/roadmap-v0.1.md) §*«Fuori dalla v0.1»*, che elenca `Unbalanced/Prone` **dentro** «il motore del ghiaccio», e il documento sorgente. Contro di esse [`brief-stati-unbalanced-prone.md`](gameplay/brief-stati-unbalanced-prone.md) propone di anticiparli **senza** motore, separandoli per **causa** dello spostamento invece che per soglia di Momentum. 🔑 La proposta è verificabile e regge — la distinzione ha già un tipo, `ERTDisplacementCause`, e non c'è nessuna scala da tarare. ⛔ Ma non fa cadere la dipendenza dal fuzzing: CP 12.6 lo scarta *«solo perché il motore del ghiaccio (slide a catena) resta fuori dalla v0.1»*, e i due stati non sono lo slide a catena. ⚠️ E il tipo non è ancora un canale: `ERTDisplacementCause::Environmental` compare **solo nei test**, l'unico produttore vivo scrive `Forced` costante. 🔑 La conseguenza di scope che nessuna sede aveva tratto — la *misura* è del brief: `Unbalanced` è uno status a durata come gli altri, mentre `Prone` finisce *quando paghi 1 MP*, e `ApplyStatus` conosce solo `N` turni o il legame alla cella. I due stati **non costano lo stesso**, quindi la domanda si può risolvere **a metà**. Uscite: *(a)* anticiparli entrambi · *(b)* non anticipare nulla · *(c)* anticipare il solo `Unbalanced`. ⚠️ `Unbalanced` non è però gratis: restano aperti l'amplificazione del `Pull` (asse nuovo, [D-038](decisions/RT_PDR_00_Decision_Log.md)), il prezzo di «`Guard`/`Brace` inerti», il punto in cui si nega lo `Sprint` e il livello del tag. **Innesco**: la pianificazione di G.2, o una decisione d'autore. **Dipendenza**: `STA-4`, la tassonomia delle capability — esattamente ciò che `Prone` toglie.~~ ⚠️ **L'uscita *(c)* è stata scartata**: il `+1` cella alla spinta esiste per portare a `Prone`, e da solo è un debuff senza culmine. ➕ **Delle quattro code aperte che l'istruttoria elencava, tre sono chiuse da [D-323](decisions/RT_PDR_00_Decision_Log.md)** (2026-09-04): l'amplificazione del `Pull` è **implementata** — asse nuovo, come [D-038](decisions/RT_PDR_00_Decision_Log.md) impone di dire —, lo `Sprint` si nega **in validazione**, e il tag resta a **due livelli**. Resta aperto il solo prezzo dello strato di **danno** di `Guard`/`Brace`: l'inerzia implementata si ferma allo spostamento |
...
| Identità originale (nomi, lore) | necessaria per una pubblicazione. 📌 **Dal 2026-08-30 il materiale su cui si deciderà ha un owner**: [`product/lore-e-worldbuilding.md`](product/lore-e-worldbuilding.md) ([D-246](decisions/RT_PDR_00_Decision_Log.md)) — la sorgente d'autore del worldbuilding, `PROPOSED` e non normativa, che tiene anche il livello con spoiler che la Wiki non pubblica. ⚠️ **Averla non avvicina la decisione**: `Harmonic Coupling`, `Refactor` e `ARC` restano fuori dal canone, e i quattro `FactionId` hanno zero occorrenze in `Source/`. Cambia solo che ora la domanda ha un documento da leggere invece di un file di radice che nessun gate guardava. ✅ **La metà «nomi del roster» è chiusa il 2026-09-04** da [D-322](decisions/RT_PDR_00_Decision_Log.md): **Aevik · Muiren · Branth · Ivrin** per la v0.1 — nomi ridecisi il 2026-09-05 da [D-335](decisions/RT_PDR_00_Decision_Log.md), che supersede `D-322` limitatamente ad essi — e **Ward · Vigil · Rime · Tethra** per la v0.2. Nessuno slot del roster ha più `RT Character ID` = `TBD`; owner della tabella: [`characters/paragon.md`](characters/paragon.md). ⏳ Per la v0.1 l'identità è decisa ma il runtime porta ancora gli ID legacy: la migrazione è differita post-v0.1 da [D-321](decisions/RT_PDR_00_Decision_Log.md), owner [#2297](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2297). ⚠️ **La riga resta aperta sulla metà «lore»**, e le due misure che la giustificano reggono: rimisurate il 2026-09-04, i quattro `FactionId` hanno **zero** occorrenze in `Source/` e `Harmonic` non compare nel codice. Il worldbuilding ha un owner `PROPOSED`, non un canone |
...
## ~~Aperte~~ Chiuse — la camera, dal consolidamento del 2026-08-30

> ✅ **Entrambe risposte dall'autore il 2026-08-30, poche ore dopo essere state aperte.** Restano qui
> barrate con l'esito, perche' una domanda risposta col suo perche' vale piu' di una domanda cancellata:
> il prossimo kit camera riproporra' le stesse due, e trovarle gia' chiuse costa meno che ridiscuterle.
>
> - **`CAM-A` → uscita (b)**: si passa ad `ActiveLayer`. Diventa
>   [`D-255`](decisions/RT_PDR_00_Decision_Log.md), perche' **tocca il gameplay** — cambia quale cella un
>   click seleziona. Implementata in `ARTPlayerController::ResolveCellUnderCursor`.
> - **`CAM-B` → «entrambi»**: `MMB` resta l'orbita e `Alt`+`LMB` diventa un secondo modo. ⛔ **Non**
>   diventa una `D-0xx`: e' un'aggiunta di binding, non una decisione di canone. Il pan resta su `WASD`.
>   ✅ **Il prezzo che la domanda temeva non si paga**: `PIE-CAM-ORBIT` descrive `MMB`, `MMB` non cambia,
>   e la voce resta valida senza essere riscritta — che era l'unica ragione per cui `CAM-B` era una
>   domanda e non un compito.
>
> 🔵 **La scelta su `CAM-B` ha un effetto collaterale che vale registrare**: `Alt`+`MMB` non poteva piu'
> essere il *precision pan* «puro» previsto dal consolidamento, perche' `MMB` resta armato come orbita.
> E' stato risolto dando la precedenza al modificatore — con `Alt` premuto, `MMB` **pana** invece di
> orbitare — cioe' l'unico modo di avere entrambi senza un terzo tasto.

## ~~Aperte~~ — le due domande come furono poste
...
| ID | Domanda | Perché non si deduce |
|---|---|---|
| ~~`VERT-2`~~ | ~~Due unità che cadono nello stesso Blast e si contendono lo stesso atterraggio: **restano dove sono**, o la caduta è avvenuta per entrambe e finiscono su `LastStableCell`?~~ | ✅ **LA DISCESA NON AVVIENE, GLI EFFETTI SI' — chiusa il 2026-09-09 da [`D-358`](decisions/RT_PDR_00_Decision_Log.md).** La domanda era posta su due sole uscite e la risposta ne ha trovata una terza, più generale: *«se non ci sono celle disponibili, la caduta non avviene ma gli effetti sì»* — che è `spec` §5 (*«gli effetti non sono la posizione»*) applicata fino in fondo. Chi cade resta sul **ciglio** se è libero, altrimenti dov'è, e in ogni caso subisce i 5 danni e `Exposed` di [`D-357`](decisions/RT_PDR_00_Decision_Log.md). ⚠️ **Vale per tutti e tre i casi senza atterraggio** — saturo, colonna senza fondo, due cadute contese — che finora erano trattati da tre regole diverse. *Istruttoria conservata:* Nessuna fonte lo dice. [`spec-caduta-e-bordi.md`](gameplay/spec-caduta-e-bordi.md) §4.3 governa il primario occupato da un'unità **ferma**, non due che scendono insieme, e il comportamento vigente viene da [#420](https://github.com/DegrassiAaron/refactor-tactics-main/issues/420) — *«due bersagli spinti verso la stessa cella restano entrambi fermi»* — scritto per le **spinte**, non per la gravità. ⚠️ **La differenza è misurabile e non piccola**: §4.3 dice che nel caso saturo la caduta **è avvenuta** e chi cade termina su `LastStableCell`, cioè sul **ciglio**; oggi le due unità non lasciano la cella di partenza, restano un piano più su e non ricevono nulla. **(a)** vigente — la contesa annulla lo spostamento prima che la caduta si consideri avvenuta; **(b)** simmetrico a §4.3 — la caduta è avvenuta per entrambe, entrambe sul proprio ciglio, gli effetti si applicano. 🔑 **Pinnato nel frattempo** da `Fall.TwoFallersSameLandingIsDeterministic`, che registra il comportamento vigente senza approvarlo: se si sceglie **(b)**, quel test cambia **con la regola**. Innesco: prima che [#2430](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2430) dia un contenuto agli effetti di caduta — con `FallEffects` a zero la scelta non produce ancora nessuna differenza per il giocatore |
...
[D-231](decisions/RT_PDR_00_Decision_Log.md), e `Target` è **metà e metà** — `Ally`/`Enemy` → `Identity`,
...
✅ **Sei righe su sette sono state chiuse il 2026-09-22 da [D-434](decisions/RT_PDR_00_Decision_Log.md).** Resta `ICON-TAX-7` (`Result`), e non per indecisione: è l'unica le cui chiavi il manifest marca **`CORE`**, e la sua uscita alternativa — (a) → `Objective` — punta all'unica famiglia con **zero** glifi nel manifest generato. Nessuna delle due uscite è pronta, e la condizione che la scioglie è scritta nella sua riga. 🔄 **Rimisurata il 2026-09-23: nessuna delle due si è avverata** — `UI.Icon.Objective` ha ancora zero glifi e `WBP_RT_ResultScreen` referenzia ancora zero icone. Nello stesso giro la **domanda** è stata riposta sull'asse giusto, che è `Outcome` e ha quattro valori, non due.
...
| ID | Domanda | Perché non si deduce |
|---|---|---|
| ~~`ICON-TAX-1`~~ | ~~🔴 **RATIFICA, non scelta** — **`Module`** (7 chiavi): i quattro moduli del roster hanno già SVG tracciati sotto `Reaction.` e chiavi nel manifest generato. La domanda è se confermare `Reaction` o revocare.~~ | ✅ **`Module` → `Reaction` — RATIFICATO il 2026-09-22 da [D-434](decisions/RT_PDR_00_Decision_Log.md).** Non era una scelta: i quattro moduli del roster avevano già gli SVG tracciati sotto quel prefisso e le chiavi nel manifest generato. 🔑 Prezzo pagato nella stessa decisione: il commento di `ERTIconCategory::Reaction` è stato **allargato** alle due popolazioni — il ciclo di vita **e** i moduli — perché diceva solo il primo ed era più stretto del proprio contenuto. *Istruttoria conservata:* 🔴 **Due osservazioni vere si escludono a vicenda, e nessuna delle due dice dove vanno.** `10-catalogo-sette-categorie.md` (ricerca, **non vincolante**) assegna loro chiavi proprie in `Reaction`, perché risolverle dal `GrantedActionId` farebbe collassare `ReactiveShield` e `CounterShot` — stesso `Action.Counter`, effetti opposti. L'istruttoria di #637 obietta che `Reaction` nell'enum è il **ciclo di vita** di una reazione (*«armata, opportunità, consumata, invalidata»*), non l'oggetto |
| ~~`ICON-TAX-2`~~ | ~~**`Gadget`** (8 chiavi) — esistono con lo **stesso** nome in `Source/`: propria categoria in coda, o si indirizzano dall'azione che concedono?~~ | ✅ **`Gadget` → `Action` — chiusa il 2026-09-22 da [D-434](decisions/RT_PDR_00_Decision_Log.md).** È ciò che il motore già calcola: `MakeEquipmentAction` riscrive `Def.ActionId` con l'`EquipmentId` e `MakeActionIconId` porta `Gadget.Sprinkler` → `UI.Icon.Action.Sprinkler`. ⚠️ `Gadget.Anchor` resta il nome che il codice non ha, e la trappola contro `Reaction.Anchor` resta da evitare in CP 25.1. *Istruttoria conservata:* Il gadget **concede** un'azione che ha già la sua chiave `Action.*`, quindi una categoria propria serve solo se esiste una superficie che mostra il **pezzo** e non il suo gesto — e in v0.1 nessuna schermata di loadout esiste. Deciderlo ora significa deciderne l'esistenza |
| ~~`ICON-TAX-3`~~ | ~~**`Weapon`** (6 chiavi) — corrispondenza **esatta** fra manifest e codice (`Weapon.Environmental · Impact · Overcharge · Precision · Split · Suppressive`)~~ | ✅ **`Weapon` → `Action` — chiusa il 2026-09-22 da [D-434](decisions/RT_PDR_00_Decision_Log.md).** Stesso esito del resto del terzetto: `ERTEquipmentSlot` è un dato solo, e dargli tre uscite diverse avrebbe richiesto un discriminante che non esiste. 🔑 L'unica asimmetria è `Module`, e la regge una misura: i suoi id portano già il prefisso `Reaction.`, quindi `MakeActionIconId` li lascia passare mentre traduce gli altri due. *Istruttoria conservata:* 🔴 È l'unico dei sette dove coincide l'**insieme intero dei nomi** — ⚠️ non il solo prefisso, che `Gadget` ha uguale, e `Module` coincide sui nomi ma il codice li chiama `Reaction.*` — il che rende la mappatura banale **e** la scelta (a)/(b) arbitraria: nessuna descrizione delle dodici copre «profilo d'arma», e nessuna macchina deriva oggi quelle chiavi |
| ~~`ICON-TAX-4`~~ | ~~**`Stat`** (11 chiavi) — `Charge · Cooldown · Cost · Detection · Duration · Health · Noise · Range · Resource · Shield · Vision`~~ | ✅ **Chiusa il 2026-09-22 da [D-434](decisions/RT_PDR_00_Decision_Log.md), in due metà.** `Cooldown` → **`Warning`**: ratifica, la chiave era già nel manifest generato col suo glifo, e il commento dell'enum nomina «ricarica» alla lettera. Le altre dieci **escono dal linguaggio**, come `UI.*`: stanno nella stessa tabella del manifest, sotto «HUD micro-icons and static symbols», e quella sezione scrive da sé «Numbers remain dynamic text». *Istruttoria conservata:* Misurato: **zero id**. Sono letture **numeriche** — `Cooldown`/`Range` su `FRTActionDef`, `Health`/`Shield` su `ARTUnit`. 🔴 **E gli undici nomi non sono tutti uguali**: `Vision` e `Noise` **esistono** come concetti di gioco fuori da quei due header (`VisionRange`, `NoiseAtCell`, `NoiseIdentificationLevel`, `NoiseType`), quindi «non è una chiave» non significa «non è una cosa», e questa riga non si decide in blocco. ⚠️ Ma [D-231](decisions/RT_PDR_00_Decision_Log.md) colloca costo/cooldown/cariche fra i **satelliti della card**, e `10-catalogo-sette-categorie.md` arbitra `Cooldown` sotto **`Warning`**: tre sedi, tre collocazioni, nessuna normativa sull'enum |
| ~~`ICON-TAX-5`~~ | ~~**`Decision`** (2 chiavi: `FastAction`, `FastReaction`)~~ | ✅ **Il segmento esce — chiusa il 2026-09-22 da [D-434](decisions/RT_PDR_00_Decision_Log.md).** L'enum resta a dodici. ⛔ **Dove confluisca `FastReaction` non lo decide questa riga**: lo specifica CP 25.1 ([#266](https://github.com/DegrassiAaron/refactor-tactics-main/issues/266)) — #637 decide, #266 specifica. *Istruttoria conservata:* Misurato: **non esistono**. L'enum che porta quel nome è `ERTReactionDecisionOutcome` e ha **sei** valori (`Chosen`, `CollapsedByCondition`, `Immediate`, `NoDecider`, `Rejected`, `Timeout`). 🔴 Mapparci sopra due chiavi **perderebbe** quattro esiti: la domanda non è dove metterle, è se il manifest stia nominando un sistema diverso |
| ~~`ICON-TAX-6`~~ | ~~**`Timing`** (3 chiavi: `DelayedAction`, `PredictiveAction`, `Trap`)~~ | ✅ **Esce — chiusa il 2026-09-22 da [D-434](decisions/RT_PDR_00_Decision_Log.md).** Zero produttori per tutte e tre. ⚠️ E il segmento è **assente dal CSV**: se un giorno il manifest di record diventasse quello, questa riga non avrebbe nemmeno una popolazione. *Istruttoria conservata:* 🔴 **Corretto il 2026-09-22: sono zero tutte e tre.** *La stesura precedente diceva «`Predictive` esiste davvero» citando `ERTPredictiveOutcome`/`ERTPredictiveTargeting`/`FRTPredictiveShot` — sono **tipi che contengono quella parola**, non id, e il criterio chiede l'id.* ⚠️ E il segmento è **assente dal CSV**: la sua popolazione dipende da quale manifest sia di record |
| 🔴 `ICON-TAX-7` — **L'UNICA CHE RESTA** | **Le due chiavi `Result` del manifest (`Success`, `Failure`) contro l'esito di partita canonico, che si chiama `Outcome` e ha QUATTRO valori.** Non «dove va `Result`», ma: su quale asse lo si mappa, visto che l'asse vero ha un'arità diversa e il suo quarto valore non ha glifo sotto nessun nome | 🔴 **La domanda era posta sull'asse sbagliato.** *Lo zero era stato ribaltato sul suffisso `Result`; le chiavi però dicono «Mission Success/Failure», e l'esito di partita **esiste ed è canonico sotto il nome `Outcome`**.* Restano veri: gli `ERT*Result` sono per dominio, e `UI.Icon.Objective` ha **zero** glifi nel manifest generato. ⚠️ Ed è l'unica riga marcata **`CORE`**. 🔑 **Tenuta aperta per DECISIONE il 2026-09-22 ([D-434](decisions/RT_PDR_00_Decision_Log.md)), non per indecisione: nessuna delle due uscite è pronta.** (c) manderebbe fuori le uniche due chiavi marcate `CORE`; (a) → `Objective` punta all'unica famiglia con **zero** glifi nel manifest generato (`grep -c UI.Icon.Objective Content/Icons/manifest.json` → 0), e il commento di quell'enum («neutro, in cattura, conteso, posseduto, bloccato») non copre un verdetto di partita. **Si riapre quando si avvera UNA delle due**: (i) esiste una superficie che mostra l'esito di partita con icone — `WBP_RT_ResultScreen` oggi non ne referenzia nessuna; (ii) `Objective` riceve la propria famiglia di glifi. ✅ **Riposta sull'asse giusto il 2026-09-23, e questa è la misura.** *La stesura precedente chiudeva con* ⛔ «va riposta sull'asse giusto: l'esito di partita è canonico sotto `Outcome`, e il pareggio che la v0.1 mostra più spesso non esiste nel manifest sotto nessun nome» — *vero, e lasciato in prosa: un difetto misurato che nessuno avrebbe ripreso, perché la riga sopra continuava a porre la domanda vecchia.* **(1) L'asse vero.** `ERTMatchOutcome` (`Turn/RTTurnRules.h`) ha **quattro** valori: `InProgress`, `Team0Wins`, `Team1Wins`, `Draw`. Il manifest ne offre **due**, e le chiama «Mission Success/Failure» — che è il linguaggio di una *missione*, non di una partita fra due squadre: `Team1Wins` è un `Failure` solo dal punto di vista di chi guarda. **(2) Il quarto valore non ha glifo, e non è un buco fra tanti: è l'esito che la v0.1 produce di più.** Misurato — nel manifest `draw` compare **9** volte e sono **tutte** `"DrawAs": "Box (9-slice)"`; `tie` una sola, dentro «tiene»; `lose` due, dentro «Closed». ⚠️ Il grep pieno era del termine sbagliato: il pareggio **non c'è**, sotto nessun nome. **(3) E la superficie che lo mostrerebbe non mostra icone.** `WBP_RT_ResultScreen.uasset` nomina `Outcome` **12** volte e contiene **zero** occorrenze di `Icon` — quindi oggi l'esito si legge in testo. 🔑 **Perché la domanda così posta non si decide lo stesso**: mappare due chiavi su quattro valori obbliga a dire cosa succede al terzo e al quarto, e quella è una scelta di **presentazione dell'esito**, non di tassonomia — appartiene a chi possiederà lo schermo di fine partita. Le due condizioni di riapertura restano quelle scritte sopra, e la seconda ne guadagna una forma verificabile: `Objective` riceve glifi **oppure** nasce una famiglia per l'esito che copra anche il pareggio |
...
`Reaction.Anchor` con lo stesso nome. *(La prima stesura dichiarava la divergenza in **due** versi,
contando un `Gadget.Mine` che vive solo in una fixture di test.)*

⚠️ **Nessuna voce di Decision Log è stata scritta per queste sette.** Il registro non ha uno stato
«proposta» — le sue voci sono `Accettata` o `Consolidata` — e aggiungercene una non decisa farebbe smettere
«sta nel Decision Log» di significare «è stato deciso». Una voce nasce il giorno in cui l'arbitrato arriva.
