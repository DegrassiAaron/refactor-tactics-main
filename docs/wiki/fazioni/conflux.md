...
![Conflux](../images/factions/conflux.png)

> **FactionId:** `Faction.Conflux`  
> **Prima apparizione:** `v0.1`  
> **Membri iniziali:** [Flux](../../characters/v0.1/flux.md) · [Riva](../../characters/v0.1/riva.md)
...
**Wet → Electric / ambiente → conduzione**

Questa è un'affinità fra sistemi, non una abilità della fazione. Ogni abilità resta nel kit del proprio personaggio.

## Colore

Primary / Faction Mark: `#16C7B7`. Il colore di fazione è distinto dal colore runtime della squadra.

## Esempio di sinergia

I membri possono cooperare sfruttando **Wet → Electric / ambiente → conduzione**. È un esempio derivato dalle regole normali, non un bonus di composizione.
