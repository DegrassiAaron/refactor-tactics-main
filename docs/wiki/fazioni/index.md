...
| --- | --- | --- | --- |
| [Conflux](conflux.md) | v0.1 | Flux, Riva | Wet → Electric / ambiente → conduzione |
| [Constrine](constrine.md) | v0.1 | Bastion, Vektor | Route Control → Prediction |
| [Sentinel Directorate](sentinel-directorate.md) | v0.2 | Steel, Murdock | Protection → Fire Sector |
| [Resonance](resonance.md) | v0.2 | Aurora, Kwang | Terrain Shaping → Anchor Geometry |

Vedi [Sinergie e combinazioni](../game/sinergie-e-combinazioni.md).
