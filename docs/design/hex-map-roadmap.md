...
| **H2** Editor MVP | Selezione (raycast→axial), multi-selezione, paint superficie/costo/blocco/altezza/layer, Undo/Redo, validazione | Mappa graybox creabile senza codice; operazioni annullabili; package dirty corretto | 🟡 H2a generatore editor (af373b3, dirty ok); selezione raycast/painting/Undo-Redo (H2b, richiede dep Editor) da fare |
