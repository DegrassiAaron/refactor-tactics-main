...
**Suite automatica**: **403 test unici** in **61 file** (rimisurati 2026-08-07 alla chiusura di CP 9.2). La
cifra dichiarata qui prima era **366 in 55**: fra le due misure sono atterrati **CP 10.3** (fine partita a tre
vie) e i sette test di **CP 9.1** — la deriva è di nuovo quella di sempre, e la regola pure: **si misura col
comando**, alla chiusura di ogni checkpoint.
