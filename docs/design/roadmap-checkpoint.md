...
**Suite automatica**: `Source/RefactorTactics/Tests/` — ultima esecuzione completa **213/213 verdi**
(2026-08-06, CP 6.5, headless con unity forzata). Erano 172 alla chiusura di CP 6.0: i 41 test aggiunti da
M6 sono tutti esagonali (movimento end-to-end, input, combat).
