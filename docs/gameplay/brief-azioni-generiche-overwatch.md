...
| [`spec-economia-del-turno.md`](spec-economia-del-turno.md) | Dove le sette generiche di questo elenco si collocano dentro i **quattro** limiti del turno — slot, Movement Point, budget di pivot, cooldown e risorsa — e come quei limiti si tengono insieme. Il **costo** dell'economia `Attack \| Ability \| Overwatch` resta di §6 e di [D-012](../decisions/RT_PDR_00_Decision_Log.md) |
