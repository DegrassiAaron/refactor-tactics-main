...
il moltiplicatore di `Hero.Aevik.LinearDischarge` (+8), verificato da `Heroes.Hero.Aevik.WetBonus`.
...
- **`Hero.Aevik.ConductiveNode`**: «rende conduttiva una cella per 2 turni» richiede **terreno dinamico** (una cella
