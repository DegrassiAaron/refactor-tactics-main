...
> **Fonte**: `docs/src/prd/catalogo-e-bilanciamento-v0.1.pdf` §6 · `docs/archive/pdr-v0.1/RT_PDR_12_Catalog_v0.1.pdf`
...
| `Weapon.Environmental` | Ambientale | ~~migliora gli hazard~~ — **non selezionabile in v0.1** *(D-091)* | −5 danni diretti |
