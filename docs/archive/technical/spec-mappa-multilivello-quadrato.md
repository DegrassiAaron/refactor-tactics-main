> ## 🗄️ `HISTORICAL` — corpo originale su griglia QUADRATA
>
> Specifica del mappa multilivello scritta per il substrato **quadrato** (`FRTGridCoord`, 4 vicini, distanza Manhattan),
...
> ([`spec-pathfinding-pf3-pf4.md`](spec-pathfinding-pf3-pf4-quadrato.md)), al terreno ([`spec-terreni.md`](../gameplay/spec-terreni.md)),
