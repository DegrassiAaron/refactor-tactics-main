...
>
> I **59** documenti in questa cartella sono i **sorgenti** da cui è nata parte della documentazione normativa.
> *(rimisurato il 2026-08-13 col comando completo — `find docs/archive/src -name '*.md' ! -name README.md | wc -l` → **59** = 15 `design/` + 40 `handoff/` + 2 `audit/` + **2 in radice**, dopo l'archiviazione dei due sorgenti Level Designer, entrambi con la loro riga d'indice qui sotto. Prima era 57, rimisurato il 2026-08-12 **dopo il merge** — non incrementato a mano: due rami
