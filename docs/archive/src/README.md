...
>
> I **63** documenti Markdown in questa cartella sono i **sorgenti** da cui è nata parte della documentazione
...
> *(rimisurato il 2026-08-13 col comando completo — `find docs/archive/src -name '*.md' ! -name README.md | wc -l` → **63** = 15 `design/` + 44 `handoff/` + 2 `audit/` + **2 in radice**, dopo l'archiviazione dei due sorgenti Level Designer e dei quattro del consolidamento HexGeometry/`grid`, ciascuno con la sua riga d'indice qui sotto. Prima era 57, rimisurato il 2026-08-12 **dopo il merge** — non incrementato a mano: due rami
