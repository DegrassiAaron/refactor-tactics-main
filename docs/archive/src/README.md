...
>
> I **60** documenti in questa cartella sono i **sorgenti** da cui è nata parte della documentazione normativa.
> *(rimisurato il 2026-08-13 col comando completo — `find docs/archive/src -name '*.md' ! -name README.md | wc -l` → **60** = 15 `design/` + 41 `handoff/` + 2 `audit/` + **2 in radice**, dopo l'archiviazione del pacchetto *v0.1 Focus Decisions* del 2026-08-13, con la sua riga d'indice qui sotto. Prima era 59, dopo i due sorgenti Level Designer. Prima era 57, rimisurato il 2026-08-12 **dopo il merge** — non incrementato a mano: due rami
