...
>
> I **57** documenti in questa cartella sono i **sorgenti** da cui è nata parte della documentazione normativa.
> *(rimisurato il 2026-08-12 **dopo il merge** — 15 `design/` + 38 `handoff/` + 2 `audit/` + **2 in radice** — non incrementato a mano: due rami
