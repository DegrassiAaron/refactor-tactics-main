...
> feature `IDEA` su release `future`, **due** fuori scope v0.1 dichiarato, **due** proxy senza produttore. Il kit «completo» non è raggiungibile in v0.1, e non è un ritardo:
