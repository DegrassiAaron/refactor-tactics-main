...
Il documento è stato **archiviato con il testo originale intatto** (convenzione 4 dei sorgenti, riaffermata da
[`../README.md`](../README.md)): le correzioni non riscrivono i paragrafi, sono note `⚠️` inserite accanto
