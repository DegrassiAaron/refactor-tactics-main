...
| ~~Se il pathfinding debba diventare orientation-aware~~ | ✅ **Chiuso 2026-09-10 per la v0.1**: `FAC-9` è deciso da [D-365](RT_PDR_00_Decision_Log.md) — **no**, resta `CellId → CellId` con facing derivato e validato alla fine, cioè l'assunzione che questo ADR faceva già. Il facing ottenibile lo mostra la **preview**, che [D-364](RT_PDR_00_Decision_Log.md) costruisce come selettore sulla cella d'arrivo |
