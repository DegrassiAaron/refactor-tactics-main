...
> **Contesto sorgente**: `docs/archive/pdr-v0.1/RT_PDR_12_Catalog_v0.1.pdf` + `docs/src/prd/catalogo-e-bilanciamento-v0.1.pdf`,
> su richiesta di realizzare la roadmap v0.1 (`docs/src/handoff/roadmap-v0.1-prompt-originale.md`)
>
