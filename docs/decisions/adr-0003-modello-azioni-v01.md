...
| **20** Movimento *rapido* | Dash, Charge, Leap, Reposition, Sprint | **Dash** | la mobilità rapida precede il Blast. ⚠️ **Per `Sprint` questa riga è SUPERATA dal blocco emendamenti in testa**, che lo dichiara **profilo del `Move`**, fase `Move` **dopo il Blast** ([D-015](RT_PDR_00_Decision_Log.md), poi [D-116](RT_PDR_00_Decision_Log.md)). 🔑 La riga resta com'era perché registra ciò che fu deciso il 2026-08-05. ⏱️ *Fino al 2026-09-12 aggiungeva «**e il codice la segue ancora**: arretrato dichiarato, migrazione in E38»: la migrazione è stata eseguita da [#641](https://github.com/DegrassiAaron/refactor-tactics-main/issues/641) e il codice dichiara `ERTResolutionPhase::NormalMovement`. Corretta il 2026-09-18, quando il gate di [#2578](https://github.com/DegrassiAaron/refactor-tactics-main/issues/2578) ha trovato il ritardo del catalogo ([#3186](https://github.com/DegrassiAaron/refactor-tactics-main/issues/3186)).* Rimando aggiunto il 2026-09-06 — voce **41** di [`DOC_CONFLICT_MATRIX.md`](../DOC_CONFLICT_MATRIX.md), che resta aperta per la propagazione ([#3199](https://github.com/DegrassiAaron/refactor-tactics-main/issues/3199)) |
