...
>
> 🔴 **`HISTORICAL` dal 2026-08-13 — non è più la regola.** [D-134](../decisions/RT_PDR_00_Decision_Log.md) ha
...
> solo `Action.Move`. Chi cerca la regola corrente sugli Stable ID va a D-134; questo documento resta perché
