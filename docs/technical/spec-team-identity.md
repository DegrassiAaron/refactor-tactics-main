...
> Ancorata al codice (`RTUnit.cpp/.h`), al canone ([`piano-canonico-mvp.md`](piano-canonico-mvp.md) invariante #1 «le
...
- Canone: [`piano-canonico-mvp.md`](piano-canonico-mvp.md) — invariante #1, §6 (leggibilità/team).
