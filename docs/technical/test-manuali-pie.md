...
**133 voci**: ✅ **30 verdi** · 🟡 **23 parziali** (regola coperta da test, resta il visivo) · ⏳ **80 aperte**.

*(Rimisurate col comando qui sotto il **2026-08-12**, dopo la voce `PIE-HEX-VIZ-TRANSIZIONI`
([#554](https://github.com/DegrassiAaron/refactor-tactics-main/issues/554)). La base era `132 (30/23/79)` e
coincideva con quanto dichiarato. ⚠️ **La voce nasce dopo la chiusura della sua issue, non prima**: #554 è
stata mergiata (PR #707) lasciando la propria acceptance **visiva** — «le transizioni si vedono sempre», «una
zona isolata si riconosce» — senza nulla che la registrasse, mentre #552 e #553 ne avevano aperte cinque nello
stesso passaggio. È il difetto che questo registro esiste per prevenire, e stavolta l'ha subito: `senza-marcatore`
misurato **0**, ma per un giorno una acceptance visiva è vissuta solo nel testo di una PR. Il totale va
