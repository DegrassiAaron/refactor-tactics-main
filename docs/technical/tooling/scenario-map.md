...
| Classe | Quanti | Dove |
|---|---:|---|
| **A** — automatico | **47** scenari | `Scenarios/Combat/` · `Scenarios/Movement/` · `Scenarios/Spec/Facing/` · `Spec.Cover.TemporaryCoverExpires` · `Spec.Predictive.WhiffOnEmptyCell` · i tre `EnvironmentalActionOwner` · `RT_Showcase_Relay_v01` |
...
> il corpus passa a **82** scenari — `A 49 + B 21 + D-bloccati 12`. I quattro nuovi sono gli `AutoBattle.*`:
