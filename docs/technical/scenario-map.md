...
| **D** — dichiarato | **12** scenari `Spec.*` ancora `BLOCKED` · **54** pianificati · **4** mai scritti *(i pianificati rimisurati il 2026-08-12 su `scenariomap.shortlist.md`, che e' generato; questa riga diceva **38** e §6.2 diceva **47** — due numeri vecchi in modi diversi nello stesso documento)* | `Scenarios/Spec/` · `feature-registry.yaml` · fascia D di `scenari-validazione-visiva.md` |
...
### 6.2 Pianificati nel Feature Registry — non ancora scritti · **54**
