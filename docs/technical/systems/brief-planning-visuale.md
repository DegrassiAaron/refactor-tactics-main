...
| A7 | **Displacement reattivo ≠ Move Phase**: il movimento prodotto da una reaction è speciale e **non consuma né sostituisce** la Move | Vincolo per `Hero.Muiren.FlowReaction` (E14) e per il troncamento del movimento in CP 14.5 |
