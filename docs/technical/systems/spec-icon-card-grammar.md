...
### 5.1 La vista di lettura: sei gruppi — [D-234](../../decisions/RT_PDR_00_Decision_Log.md)
...
4. posizione esatta dei piccoli esagoni quando ne compaiono 1, 2 o 3 — **riformulato** da
   [D-234](../../decisions/RT_PDR_00_Decision_Log.md): la domanda non è più «dove va il terzo esagono»
...
| Vista di lettura a sei gruppi (§5.1) | **D-234** |
