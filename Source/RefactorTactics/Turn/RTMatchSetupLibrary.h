...
public:
	...
	/** Posizioni di partenza canoniche della showcase: Aevik + Phase (team 0) contro Branth + Ivrin (team 1). */
	...
	/** Spawn canonici del Relay Basin: Aevik `(-4,0)` + Phase `(-4,1)` contro Branth `(4,0)` + Ivrin `(4,1)`. */
	 ...
	 * (**5**, Phase e Branth; Ivrin 6, Aevik 7): una squadra vede quasi tutto al primo turno. E poiche'
