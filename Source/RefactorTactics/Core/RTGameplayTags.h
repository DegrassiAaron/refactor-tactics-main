...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Status_Guarded); // guardia: riduzione per colpo sull'arco frontale ([D-408] + [D-206]), valore dell'eroe, resiste a una spinta di 1
