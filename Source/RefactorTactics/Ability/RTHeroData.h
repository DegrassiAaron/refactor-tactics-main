 ...
 * ne hanno sei **Phase** (`Hero.Phase.TideGuard`) e **Wraith** (`Hero.Wraith.PhaseGuard`), entrambe derivate
...
public:
	 ...
	 *
	 * 🔵 **`None` non e' un valore mancante**: e' Branth, e per lui e' la scelta giusta — `Hold Ground` fa
