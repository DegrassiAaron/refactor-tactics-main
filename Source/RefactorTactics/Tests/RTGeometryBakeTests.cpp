...
namespace
{
	...
	// `BakeOrigin` e non `Origin`: nella unity build questo file finisce in un'unita' di traduzione con
	// altri, e un `Origin` a scope di namespace rende ogni variabile LOCALE omonima un `C4459` («nasconde
	// la dichiarazione globale») — anche dentro gli header del motore, dove `GameModeBase.h` ne ha una.
	// Con i warning trattati come errori, un nome generico qui rompe la compilazione altrove.
