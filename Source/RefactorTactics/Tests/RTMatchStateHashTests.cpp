...
namespace
{
	...
	/** Un turno, due unità ferme. Con `bErectCover` Branth erige un pannello sul proprio bordo E. */
	FRTTestScenario MakeCoverWiringScenario(bool bErectCover)
	{
		...
		if (bErectCover)
		{
			...
			Erect.Ability = FName(TEXT("Hero.Branth.KineticPanel"));
