...
function main() {
  ...
  // e un glob li avrebbe segnalati come rotti: quattro falsi positivi al primo giro, che e' il modo
  ...
  // il gate rosso proprio durante quel lavoro — cioe' nella condizione in cui serve di piu' che sia
  // verde per il resto. 🔴 **Il punto cieco che questo si sceglie**: un Markdown nuovo lasciato in
  // radice non lo controlla nessuno, e ci puo' restare settimane. E' successo: **sei** documenti,
